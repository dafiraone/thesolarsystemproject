...
#endif`,Pm="gl_FragColor = linearToOutputTexel( gl_FragColor );",Rm=`vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
void main() {
	...
	`}function zg(n){let t=new WeakMap,e=null;function i(a){if(a&&a.isTexture){const l=a.mapping,c=l===ba||l===xa,h=l===lr||l===cr;if(c||h){let u=t.get(a);const p=u!==void 0?u.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==p)return e===null&&(e=new ih(n)),u=c?e.fromEquirectangular(a,u):e.fromCubemap(a,u),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),u.texture;if(u!==void 0)return u.texture;{const f=a.image;return c&&f&&f.height>0||h&&f&&r(f)?(e===null&&(e=new ih(n)),u=c?e.fromEquirectangular(a):e.fromCubemap(a),u.texture.pmremVersion=a.pmremVersion,t.set(a,u),a.addEventListener("dispose",s),u.texture):null}}}return a}function r(a){let l=0;const c=6;for(let h=0;h<c;h++)a[h]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function o(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:i,dispose:o}}function Hg(n){const t={};function e(i){if(t[i]!==void 0)return t[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return t[i]=r,r}return{has:function(i){return e(i)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(i){const r=e(i);return r===null&&$i("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function Gg(n,t,e,i){const r={},s=new WeakMap;function o(u){const p=u.target;p.index!==null&&t.remove(p.index);for(const _ in p.attributes)t.remove(p.attributes[_]);p.removeEventListener("dispose",o),delete r[p.id];const f=s.get(p);f&&(t.remove(f),s.delete(p)),i.releaseStatesOfGeometry(p),p.isInstancedBufferGeometry===!0&&delete p._maxInstanceCount,e.memory.geometries--}function a(u,p){return r[p.id]===!0||(p.addEventListener("dispose",o),r[p.id]=!0,e.memory.geometries++),p}function l(u){const p=u.attributes;for(const f in p)t.update(p[f],n.ARRAY_BUFFER)}function c(u){const p=[],f=u.index,_=u.attributes.position;let v=0;if(f!==null){const S=f.array;v=f.version;for(let M=0,E=S.length;M<E;M+=3){const U=S[M+0],T=S[M+1],C=S[M+2];p.push(U,T,T,C,C,U)}}else if(_!==void 0){const S=_.array;v=_.version;for(let M=0,E=S.length/3-1;M<E;M+=3){const U=M+0,T=M+1,C=M+2;p.push(U,T,T,C,C,U)}}else return;const m=new(gu(p)?Eu:wu)(p,1);m.version=v;const d=s.get(u);d&&t.remove(d),s.set(u,m)}function h(u){const p=s.get(u);if(p){const f=u.index;f!==null&&p.version<f.version&&c(u)}else c(u);return s.get(u)}return{get:a,update:l,getWireframeAttribute:h}}function Wg(n,t,e){let i;function r(p){i=p}let s,o;function a(p){s=p.type,o=p.bytesPerElement}function l(p,f){n.drawElements(i,f,s,p*o),e.update(f,i,1)}function c(p,f,_){_!==0&&(n.drawElementsInstanced(i,f,s,p*o,_),e.update(f,i,_))}function h(p,f,_){if(_===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,f,0,s,p,0,_);let m=0;for(let d=0;d<_;d++)m+=f[d];e.update(m,i,1)}function u(p,f,_,v){if(_===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<p.length;d++)c(p[d]/o,f[d],v[d]);else{m.multiDrawElementsInstancedWEBGL(i,f,0,s,p,0,v,0,_);let d=0;for(let S=0;S<_;S++)d+=f[S]*v[S];e.update(d,i,1)}}this.setMode=r,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function Xg(n){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(e.calls++,o){case n.TRIANGLES:e.triangles+=a*(s/3);break;case n.LINES:e.lines+=a*(s/2);break;case n.LINE_STRIP:e.lines+=a*(s-1);break;case n.LINE_LOOP:e.lines+=a*s;break;case n.POINTS:e.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:r,update:i}}function jg(n,t,e){const i=new WeakMap,r=new te;function s(o,a,l){const c=o.morphTargetInfluences,h=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,u=h!==void 0?h.length:0;let p=i.get(a);if(p===void 0||p.count!==u){let x=function(){N.dispose(),i.delete(a),a.removeEventListener("dispose",x)};var f=x;p!==void 0&&p.texture.dispose();const _=a.morphAttributes.position!==void 0,v=a.morphAttributes.normal!==void 0,m=a.morphAttributes.color!==void 0,d=a.morphAttributes.position||[],S=a.morphAttributes.normal||[],M=a.morphAttributes.color||[];let E=0;_===!0&&(E=1),v===!0&&(E=2),m===!0&&(E=3);let U=a.attributes.position.count*E,T=1;U>t.maxTextureSize&&(T=Math.ceil(U/t.maxTextureSize),U=t.maxTextureSize);const C=new Float32Array(U*T*4*u),N=new bu(C,U,T,u);N.type=Pn,N.needsUpdate=!0;const y=E*4;for(let R=0;R<u;R++){const G=d[R],B=S[R],Y=M[R],K=U*T*4*R;for(let X=0;X<G.count;X++){const Z=X*y;_===!0&&(r.fromBufferAttribute(G,X),C[K+Z+0]=r.x,C[K+Z+1]=r.y,C[K+Z+2]=r.z,C[K+Z+3]=0),v===!0&&(r.fromBufferAttribute(B,X),C[K+Z+4]=r.x,C[K+Z+5]=r.y,C[K+Z+6]=r.z,C[K+Z+7]=0),m===!0&&(r.fromBufferAttribute(Y,X),C[K+Z+8]=r.x,C[K+Z+9]=r.y,C[K+Z+10]=r.z,C[K+Z+11]=Y.itemSize===4?r.w:1)}}p={count:u,texture:N,size:new Tt(U,T)},i.set(a,p),a.addEventListener("dispose",x)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",o.morphTexture,e);else{let _=0;for(let m=0;m<c.length;m++)_+=c[m];const v=a.morphTargetsRelative?1:1-_;l.getUniforms().setValue(n,"morphTargetBaseInfluence",v),l.getUniforms().setValue(n,"morphTargetInfluences",c)}l.getUniforms().setValue(n,"morphTargetsTexture",p.texture,e),l.getUniforms().setValue(n,"morphTargetsTextureSize",p.size)}return{update:s}}function qg(n,t,e,i){let r=new WeakMap;function s(l){const c=i.render.frame,h=l.geometry,u=t.get(l,h);if(r.get(u)!==c&&(t.update(u),r.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==c&&(e.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,n.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const p=l.skeleton;r.get(p)!==c&&(p.update(),r.set(p,c))}return u}function o(){r=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:o}}const Iu=new De,ah=new Cu(1,1),Uu=new bu,Nu=new uf,Fu=new Tu,lh=[],ch=[],hh=new Float32Array(16),uh=new Float32Array(9),dh=new Float32Array(4);function _r(n,t,e){const i=n[0];if(i<=0||i>0)return n;const r=t*e;let s=lh[r];if(s===void 0&&(s=new Float32Array(r),lh[r]=s),t!==0){i.toArray(s,0);for(let o=1,a=0;o!==t;++o)a+=e,n[o].toArray(s,a)}return s}function be(n,t){if(n.length!==t.length)return!1;for(let e=0,i=n.length;e<i;e++)if(n[e]!==t[e])return!1;return!0}function xe(n,t){for(let e=0,i=t.length;e<i;e++)n[e]=t[e]}function fo(n,t){let e=ch[t];e===void 0&&(e=new Int32Array(t),ch[t]=e);for(let i=0;i!==t;++i)e[i]=n.allocateTextureUnit();return e}function Yg(n,t){const e=this.cache;e[0]!==t&&(n.uniform1f(this.addr,t),e[0]=t)}function Kg(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(be(e,t))return;n.uniform2fv(this.addr,t),xe(e,t)}}function $g(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(n.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(be(e,t))return;n.uniform3fv(this.addr,t),xe(e,t)}}function Zg(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(be(e,t))return;n.uniform4fv(this.addr,t),xe(e,t)}}function Jg(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(be(e,t))return;n.uniformMatrix2fv(this.addr,!1,t),xe(e,t)}else{if(be(e,i))return;dh.set(i),n.uniformMatrix2fv(this.addr,!1,dh),xe(e,i)}}function Qg(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(be(e,t))return;n.uniformMatrix3fv(this.addr,!1,t),xe(e,t)}else{if(be(e,i))return;uh.set(i),n.uniformMatrix3fv(this.addr,!1,uh),xe(e,i)}}function tv(n,t){const e=this.cache,i=t.elements;if(i===void 0){if(be(e,t))return;n.uniformMatrix4fv(this.addr,!1,t),xe(e,t)}else{if(be(e,i))return;hh.set(i),n.uniformMatrix4fv(this.addr,!1,hh),xe(e,i)}}function ev(n,t){const e=this.cache;e[0]!==t&&(n.uniform1i(this.addr,t),e[0]=t)}function nv(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(be(e,t))return;n.uniform2iv(this.addr,t),xe(e,t)}}function iv(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(be(e,t))return;n.uniform3iv(this.addr,t),xe(e,t)}}function rv(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(be(e,t))return;n.uniform4iv(this.addr,t),xe(e,t)}}function sv(n,t){const e=this.cache;e[0]!==t&&(n.uniform1ui(this.addr,t),e[0]=t)}function ov(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(n.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(be(e,t))return;n.uniform2uiv(this.addr,t),xe(e,t)}}function av(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(n.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(be(e,t))return;n.uniform3uiv(this.addr,t),xe(e,t)}}function lv(n,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(n.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(be(e,t))return;n.uniform4uiv(this.addr,t),xe(e,t)}}function cv(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let s;this.type===n.SAMPLER_2D_SHADOW?(ah.compareFunction=_u,s=ah):s=Iu,e.setTexture2D(t||s,r)}function hv(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTexture3D(t||Nu,r)}function uv(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTextureCube(t||Fu,r)}function dv(n,t,e){const i=this.cache,r=e.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),e.setTexture2DArray(t||Uu,r)}function pv(n){switch(n){case 5126:return Yg;case 35664:return Kg;case 35665:return $g;case 35666:return Zg;case 35674:return Jg;case 35675:return Qg;case 35676:return tv;case 5124:case 35670:return ev;case 35667:case 35671:return nv;case 35668:case 35672:return iv;case 35669:case 35673:return rv;case 5125:return sv;case 36294:return ov;case 36295:return av;case 36296:return lv;case 35678:case 36198:case 36298:case 36306:case 35682:return cv;case 35679:case 36299:case 36307:return hv;case 35680:case 36300:case 36308:case 36293:return uv;case 36289:case 36303:case 36311:case 36292:return dv}}function fv(n,t){n.uniform1fv(this.addr,t)}function mv(n,t){const e=_r(t,this.size,2);n.uniform2fv(this.addr,e)}function _v(n,t){const e=_r(t,this.size,3);n.uniform3fv(this.addr,e)}function gv(n,t){const e=_r(t,this.size,4);n.uniform4fv(this.addr,e)}function vv(n,t){const e=_r(t,this.size,4);n.uniformMatrix2fv(this.addr,!1,e)}function bv(n,t){const e=_r(t,this.size,9);n.uniformMatrix3fv(this.addr,!1,e)}function xv(n,t){const e=_r(t,this.size,16);n.uniformMatrix4fv(this.addr,!1,e)}function yv(n,t){n.uniform1iv(this.addr,t)}function wv(n,t){n.uniform2iv(this.addr,t)}function Ev(n,t){n.uniform3iv(this.addr,t)}function Mv(n,t){n.uniform4iv(this.addr,t)}function Sv(n,t){n.uniform1uiv(this.addr,t)}function Tv(n,t){n.uniform2uiv(this.addr,t)}function Cv(n,t){n.uniform3uiv(this.addr,t)}function Av(n,t){n.uniform4uiv(this.addr,t)}function Pv(n,t,e){const i=this.cache,r=t.length,s=fo(e,r);be(i,s)||(n.uniform1iv(this.addr,s),xe(i,s));for(let o=0;o!==r;++o)e.setTexture2D(t[o]||Iu,s[o])}function Rv(n,t,e){const i=this.cache,r=t.length,s=fo(e,r);be(i,s)||(n.uniform1iv(this.addr,s),xe(i,s));for(let o=0;o!==r;++o)e.setTexture3D(t[o]||Nu,s[o])}function Lv(n,t,e){const i=this.cache,r=t.length,s=fo(e,r);be(i,s)||(n.uniform1iv(this.addr,s),xe(i,s));for(let o=0;o!==r;++o)e.setTextureCube(t[o]||Fu,s[o])}function Dv(n,t,e){const i=this.cache,r=t.length,s=fo(e,r);be(i,s)||(n.uniform1iv(this.addr,s),xe(i,s));for(let o=0;o!==r;++o)e.setTexture2DArray(t[o]||Uu,s[o])}function Iv(n){switch(n){case 5126:return fv;case 35664:return mv;case 35665:return _v;case 35666:return gv;case 35674:return vv;case 35675:return bv;case 35676:return xv;case 5124:case 35670:return yv;case 35667:case 35671:return wv;case 35668:case 35672:return Ev;case 35669:case 35673:return Mv;case 5125:return Sv;case 36294:return Tv;case 36295:return Cv;case 36296:return Av;case 35678:case 36198:case 36298:case 36306:case 35682:return Pv;case 35679:case 36299:case 36307:return Rv;case 35680:case 36300:case 36308:case 36293:return Lv;case 36289:case 36303:case 36311:case 36292:return Dv}}class Uv{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.setValue=pv(e.type)}}class Nv{constructor(t,e,i){this.id=t,this.addr=i,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=Iv(e.type)}}class Fv{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(t,e[a.id],i)}}}const Zo=/(\w+)(\])?(\[|\.)?/g;function ph(n,t){n.seq.push(t),n.map[t.id]=t}function Ov(n,t,e){const i=n.name,r=i.length;for(Zo.lastIndex=0;;){const s=Zo.exec(i),o=Zo.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){ph(e,c===void 0?new Uv(a,n,t):new Nv(a,n,t));break}else{let u=e.map[a];u===void 0&&(u=new Fv(a),ph(e,u)),e=u}}}class qs{constructor(t,e){this.seq=[],this.map={};const i=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=t.getActiveUniform(e,r),o=t.getUniformLocation(e,s.name);Ov(s,o,this)}}setValue(t,e,i,r){const s=this.map[e];s!==void 0&&s.setValue(t,i,r)}setOptional(t,e,i){const r=e[i];r!==void 0&&this.setValue(t,i,r)}static upload(t,e,i,r){for(let s=0,o=e.length;s!==o;++s){const a=e[s],l=i[a.id];l.needsUpdate!==!1&&a.setValue(t,l.value,r)}}static seqWithValue(t,e){const i=[];for(let r=0,s=t.length;r!==s;++r){const o=t[r];o.id in e&&i.push(o)}return i}}function fh(n,t,e){const i=n.createShader(t);return n.shaderSource(i,e),n.compileShader(i),i}const kv=37297;let Bv=0;function Vv(n,t){const e=n.split(`
`),i=[],r=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===t?">":" "} ${a}: ${e[o]}`)}return i.join(`
`)}const mh=new Rt;function zv(n){kt._getMatrix(mh,kt.workingColorSpace,n);const t=`mat3( ${mh.elements.map(e=>e.toFixed(4))} )`;switch(kt.getTransfer(n)){case Qs:return[t,"LinearTransferOETF"];case Jt:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",n),[t,"LinearTransferOETF"]}}function _h(n,t,e){const i=n.getShaderParameter(t,n.COMPILE_STATUS),r=n.getShaderInfoLog(t).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return e.toUpperCase()+`

`+r+`

`+Vv(n.getShaderSource(t),o)}else return r}function Hv(n,t){const e=zv(t);return[`vec4 ${n}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}function Gv(n,t){let e;switch(t){case xp:e="Linear";break;case yp:e="Reinhard";break;case wp:e="Cineon";break;case Ep:e="ACESFilmic";break;case Sp:e="AgX";break;case Tp:e="Neutral";break;case Mp:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const Os=new P;function Wv(){kt.getLuminanceCoefficients(Os);const n=Os.x.toFixed(4),t=Os.y.toFixed(4),e=Os.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
#define LOW_PRECISION`),t}function Qv(n){let t="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===iu?t="SHADOWMAP_TYPE_PCF":n.shadowMapType===Qd?t="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Cn&&(t="SHADOWMAP_TYPE_VSM"),t}function tb(n){let t="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case lr:case cr:t="ENVMAP_TYPE_CUBE";break;case uo:t="ENVMAP_TYPE_CUBE_UV";break}return t}function eb(n){let t="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case cr:t="ENVMAP_MODE_REFRACTION";break}return t}function nb(n){let t="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case al:t="ENVMAP_BLENDING_MULTIPLY";break;case vp:t="ENVMAP_BLENDING_MIX";break;case bp:t="ENVMAP_BLENDING_ADD";break}return t}function ib(n){const t=n.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,i=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:i,maxMip:e}}function rb(n,t,e,i){const r=n.getContext(),s=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=Qv(e),c=tb(e),h=eb(e),u=nb(e),p=ib(e),f=Xv(e),_=jv(s),v=r.createProgram();let m,d,S=e.glslVersion?"#version "+e.glslVersion+`
...
}`;class Ab{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,i){if(this.texture===null){const r=new De,s=t.properties.get(r);s.__webglTexture=e.texture,(e.depthNear!=i.depthNear||e.depthFar!=i.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=r}}getMesh(t){if(this.texture!==null&&this.mesh===null){const e=t.cameras[0].viewport,i=new ni({vertexShader:Tb,fragmentShader:Cb,uniforms:{depthColor:{value:this.texture},depthWidth:{value:e.z},depthHeight:{value:e.w}}});this.mesh=new tn(new po(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Pb extends Ai{constructor(t,e){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,c=null,h=null,u=null,p=null,f=null,_=null;const v=new Ab,m=e.getContextAttributes();let d=null,S=null;const M=[],E=[],U=new Tt;let T=null;const C=new Ge;C.viewport=new te;const N=new Ge;N.viewport=new te;const y=[C,N],x=new Xf;let R=null,G=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(W){let tt=M[W];return tt===void 0&&(tt=new Jo,M[W]=tt),tt.getTargetRaySpace()},this.getControllerGrip=function(W){let tt=M[W];return tt===void 0&&(tt=new Jo,M[W]=tt),tt.getGripSpace()},this.getHand=function(W){let tt=M[W];return tt===void 0&&(tt=new Jo,M[W]=tt),tt.getHandSpace()};function B(W){const tt=E.indexOf(W.inputSource);if(tt===-1)return;const mt=M[tt];mt!==void 0&&(mt.update(W.inputSource,W.frame,c||o),mt.dispatchEvent({type:W.type,data:W.inputSource}))}function Y(){r.removeEventListener("select",B),r.removeEventListener("selectstart",B),r.removeEventListener("selectend",B),r.removeEventListener("squeeze",B),r.removeEventListener("squeezestart",B),r.removeEventListener("squeezeend",B),r.removeEventListener("end",Y),r.removeEventListener("inputsourceschange",K);for(let W=0;W<M.length;W++){const tt=E[W];tt!==null&&(E[W]=null,M[W].disconnect(tt))}R=null,G=null,v.reset(),t.setRenderTarget(d),f=null,p=null,u=null,r=null,S=null,ee.stop(),i.isPresenting=!1,t.setPixelRatio(T),t.setSize(U.width,U.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(W){s=W,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(W){a=W,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(W){c=W},this.getBaseLayer=function(){return p!==null?p:f},this.getBinding=function(){return u},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(W){if(r=W,r!==null){if(d=t.getRenderTarget(),r.addEventListener("select",B),r.addEventListener("selectstart",B),r.addEventListener("selectend",B),r.addEventListener("squeeze",B),r.addEventListener("squeezestart",B),r.addEventListener("squeezeend",B),r.addEventListener("end",Y),r.addEventListener("inputsourceschange",K),m.xrCompatible!==!0&&await e.makeXRCompatible(),T=t.getPixelRatio(),t.getSize(U),r.renderState.layers===void 0){const tt={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};f=new XRWebGLLayer(r,e,tt),r.updateRenderState({baseLayer:f}),t.setPixelRatio(1),t.setSize(f.framebufferWidth,f.framebufferHeight,!1),S=new wi(f.framebufferWidth,f.framebufferHeight,{format:cn,type:Nn,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil})}else{let tt=null,mt=null,st=null;m.depth&&(st=m.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,tt=m.stencil?ur:nr,mt=m.stencil?hr:yi);const Et={colorFormat:e.RGBA8,depthFormat:st,scaleFactor:s};u=new XRWebGLBinding(r,e),p=u.createProjectionLayer(Et),r.updateRenderState({layers:[p]}),t.setPixelRatio(1),t.setSize(p.textureWidth,p.textureHeight,!1),S=new wi(p.textureWidth,p.textureHeight,{format:cn,type:Nn,depthTexture:new Cu(p.textureWidth,p.textureHeight,mt,void 0,void 0,void 0,void 0,void 0,void 0,tt),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:p.ignoreDepthValues===!1})}S.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await r.requestReferenceSpace(a),ee.setContext(r),ee.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return v.getDepthTexture()};function K(W){for(let tt=0;tt<W.removed.length;tt++){const mt=W.removed[tt],st=E.indexOf(mt);st>=0&&(E[st]=null,M[st].disconnect(mt))}for(let tt=0;tt<W.added.length;tt++){const mt=W.added[tt];let st=E.indexOf(mt);if(st===-1){for(let At=0;At<M.length;At++)if(At>=E.length){E.push(mt),st=At;break}else if(E[At]===null){E[At]=mt,st=At;break}if(st===-1)break}const Et=M[st];Et&&Et.connect(mt)}}const X=new P,Z=new P;function z(W,tt,mt){X.setFromMatrixPosition(tt.matrixWorld),Z.setFromMatrixPosition(mt.matrixWorld);const st=X.distanceTo(Z),Et=tt.projectionMatrix.elements,At=mt.projectionMatrix.elements,Ot=Et[14]/(Et[10]-1),le=Et[14]/(Et[10]+1),Ht=(Et[9]+1)/Et[5],pe=(Et[9]-1)/Et[5],A=(Et[8]-1)/Et[0],Ye=(At[8]+1)/At[0],Bt=Ot*A,Vt=Ot*Ye,vt=st/(-A+Ye),se=vt*-A;if(tt.matrixWorld.decompose(W.position,W.quaternion,W.scale),W.translateX(se),W.translateZ(vt),W.matrixWorld.compose(W.position,W.quaternion,W.scale),W.matrixWorldInverse.copy(W.matrixWorld).invert(),Et[10]===-1)W.projectionMatrix.copy(tt.projectionMatrix),W.projectionMatrixInverse.copy(tt.projectionMatrixInverse);else{const bt=Ot+vt,w=le+vt,g=Bt-se,F=Vt+(st-se),j=Ht*le/w*bt,$=pe*le/w*bt;W.projectionMatrix.makePerspective(g,F,j,$,bt,w),W.projectionMatrixInverse.copy(W.projectionMatrix).invert()}}function rt(W,tt){tt===null?W.matrixWorld.copy(W.matrix):W.matrixWorld.multiplyMatrices(tt.matrixWorld,W.matrix),W.matrixWorldInverse.copy(W.matrixWorld).invert()}this.updateCamera=function(W){if(r===null)return;let tt=W.near,mt=W.far;v.texture!==null&&(v.depthNear>0&&(tt=v.depthNear),v.depthFar>0&&(mt=v.depthFar)),x.near=N.near=C.near=tt,x.far=N.far=C.far=mt,(R!==x.near||G!==x.far)&&(r.updateRenderState({depthNear:x.near,depthFar:x.far}),R=x.near,G=x.far),C.layers.mask=W.layers.mask|2,N.layers.mask=W.layers.mask|4,x.layers.mask=C.layers.mask|N.layers.mask;const st=W.parent,Et=x.cameras;rt(x,st);for(let At=0;At<Et.length;At++)rt(Et[At],st);Et.length===2?z(x,C,N):x.projectionMatrix.copy(C.projectionMatrix),ht(W,x,st)};function ht(W,tt,mt){mt===null?W.matrix.copy(tt.matrixWorld):(W.matrix.copy(mt.matrixWorld),W.matrix.invert(),W.matrix.multiply(tt.matrixWorld)),W.matrix.decompose(W.position,W.quaternion,W.scale),W.updateMatrixWorld(!0),W.projectionMatrix.copy(tt.projectionMatrix),W.projectionMatrixInverse.copy(tt.projectionMatrixInverse),W.isPerspectiveCamera&&(W.fov=Br*2*Math.atan(1/W.projectionMatrix.elements[5]),W.zoom=1)}this.getCamera=function(){return x},this.getFoveation=function(){if(!(p===null&&f===null))return l},this.setFoveation=function(W){l=W,p!==null&&(p.fixedFoveation=W),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=W)},this.hasDepthSensing=function(){return v.texture!==null},this.getDepthSensingMesh=function(){return v.getMesh(x)};let gt=null;function Ft(W,tt){if(h=tt.getViewerPose(c||o),_=tt,h!==null){const mt=h.views;f!==null&&(t.setRenderTargetFramebuffer(S,f.framebuffer),t.setRenderTarget(S));let st=!1;mt.length!==x.cameras.length&&(x.cameras.length=0,st=!0);for(let At=0;At<mt.length;At++){const Ot=mt[At];let le=null;if(f!==null)le=f.getViewport(Ot);else{const pe=u.getViewSubImage(p,Ot);le=pe.viewport,At===0&&(t.setRenderTargetTextures(S,pe.colorTexture,p.ignoreDepthValues?void 0:pe.depthStencilTexture),t.setRenderTarget(S))}let Ht=y[At];Ht===void 0&&(Ht=new Ge,Ht.layers.enable(At),Ht.viewport=new te,y[At]=Ht),Ht.matrix.fromArray(Ot.transform.matrix),Ht.matrix.decompose(Ht.position,Ht.quaternion,Ht.scale),Ht.projectionMatrix.fromArray(Ot.projectionMatrix),Ht.projectionMatrixInverse.copy(Ht.projectionMatrix).invert(),Ht.viewport.set(le.x,le.y,le.width,le.height),At===0&&(x.matrix.copy(Ht.matrix),x.matrix.decompose(x.position,x.quaternion,x.scale)),st===!0&&x.cameras.push(Ht)}const Et=r.enabledFeatures;if(Et&&Et.includes("depth-sensing")){const At=u.getDepthInformation(mt[0]);At&&At.isValid&&At.texture&&v.init(t,At,r.renderState)}}for(let mt=0;mt<M.length;mt++){const st=E[mt],Et=M[mt];st!==null&&Et!==void 0&&Et.update(st,tt,c||o)}gt&&gt(W,tt),tt.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:tt}),_=null}const ee=new Du;ee.setAnimationLoop(Ft),this.setAnimationLoop=function(W){gt=W},this.dispose=function(){}}}const pi=new _n,Rb=new re;function Lb(n,t){function e(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function i(m,d){d.color.getRGB(m.fogColor.value,Mu(n)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function r(m,d,S,M,E){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(m,d):d.isMeshToonMaterial?(s(m,d),u(m,d)):d.isMeshPhongMaterial?(s(m,d),h(m,d)):d.isMeshStandardMaterial?(s(m,d),p(m,d),d.isMeshPhysicalMaterial&&f(m,d,E)):d.isMeshMatcapMaterial?(s(m,d),_(m,d)):d.isMeshDepthMaterial?s(m,d):d.isMeshDistanceMaterial?(s(m,d),v(m,d)):d.isMeshNormalMaterial?s(m,d):d.isLineBasicMaterial?(o(m,d),d.isLineDashedMaterial&&a(m,d)):d.isPointsMaterial?l(m,d,S,M):d.isSpriteMaterial?c(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,e(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,e(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===ke&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,e(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===ke&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,e(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,e(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,e(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const S=t.get(d),M=S.envMap,E=S.envMapRotation;M&&(m.envMap.value=M,pi.copy(E),pi.x*=-1,pi.y*=-1,pi.z*=-1,M.isCubeTexture&&M.isRenderTargetTexture===!1&&(pi.y*=-1,pi.z*=-1),m.envMapRotation.value.setFromMatrix4(Rb.makeRotationFromEuler(pi)),m.flipEnvMap.value=M.isCubeTexture&&M.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap&&(m.lightMap.value=d.lightMap,m.lightMapIntensity.value=d.lightMapIntensity,e(d.lightMap,m.lightMapTransform)),d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,e(d.aoMap,m.aoMapTransform))}function o(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,e(d.map,m.mapTransform))}function a(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function l(m,d,S,M){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*S,m.scale.value=M*.5,d.map&&(m.map.value=d.map,e(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function c(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,e(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,e(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function h(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function u(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function p(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,e(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,e(d.roughnessMap,m.roughnessMapTransform)),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function f(m,d,S){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,e(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,e(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,e(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,e(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,e(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===ke&&m.clearcoatNormalScale.value.negate())),d.dispersion>0&&(m.dispersion.value=d.dispersion),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,e(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,e(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=S.texture,m.transmissionSamplerSize.value.set(S.width,S.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,e(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,e(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,e(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,e(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,e(d.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,d){d.matcap&&(m.matcap.value=d.matcap)}function v(m,d){const S=t.get(d).light;m.referencePosition.value.setFromMatrixPosition(S.matrixWorld),m.nearDistance.value=S.shadow.camera.near,m.farDistance.value=S.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function Db(n,t,e,i){let r={},s={},o=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(S,M){const E=M.program;i.uniformBlockBinding(S,E)}function c(S,M){let E=r[S.id];E===void 0&&(_(S),E=h(S),r[S.id]=E,S.addEventListener("dispose",m));const U=M.program;i.updateUBOMapping(S,U);const T=t.render.frame;s[S.id]!==T&&(p(S),s[S.id]=T)}function h(S){const M=u();S.__bindingPointIndex=M;const E=n.createBuffer(),U=S.__size,T=S.usage;return n.bindBuffer(n.UNIFORM_BUFFER,E),n.bufferData(n.UNIFORM_BUFFER,U,T),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,M,E),E}function u(){for(let S=0;S<a;S++)if(o.indexOf(S)===-1)return o.push(S),S;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function p(S){const M=r[S.id],E=S.uniforms,U=S.__cache;n.bindBuffer(n.UNIFORM_BUFFER,M);for(let T=0,C=E.length;T<C;T++){const N=Array.isArray(E[T])?E[T]:[E[T]];for(let y=0,x=N.length;y<x;y++){const R=N[y];if(f(R,T,y,U)===!0){const G=R.__offset,B=Array.isArray(R.value)?R.value:[R.value];let Y=0;for(let K=0;K<B.length;K++){const X=B[K],Z=v(X);typeof X=="number"||typeof X=="boolean"?(R.__data[0]=X,n.bufferSubData(n.UNIFORM_BUFFER,G+Y,R.__data)):X.isMatrix3?(R.__data[0]=X.elements[0],R.__data[1]=X.elements[1],R.__data[2]=X.elements[2],R.__data[3]=0,R.__data[4]=X.elements[3],R.__data[5]=X.elements[4],R.__data[6]=X.elements[5],R.__data[7]=0,R.__data[8]=X.elements[6],R.__data[9]=X.elements[7],R.__data[10]=X.elements[8],R.__data[11]=0):(X.toArray(R.__data,Y),Y+=Z.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,G,R.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function f(S,M,E,U){const T=S.value,C=M+"_"+E;if(U[C]===void 0)return typeof T=="number"||typeof T=="boolean"?U[C]=T:U[C]=T.clone(),!0;{const N=U[C];if(typeof T=="number"||typeof T=="boolean"){if(N!==T)return U[C]=T,!0}else if(N.equals(T)===!1)return N.copy(T),!0}return!1}function _(S){const M=S.uniforms;let E=0;const U=16;for(let C=0,N=M.length;C<N;C++){const y=Array.isArray(M[C])?M[C]:[M[C]];for(let x=0,R=y.length;x<R;x++){const G=y[x],B=Array.isArray(G.value)?G.value:[G.value];for(let Y=0,K=B.length;Y<K;Y++){const X=B[Y],Z=v(X),z=E%U,rt=z%Z.boundary,ht=z+rt;E+=rt,ht!==0&&U-ht<Z.storage&&(E+=U-ht),G.__data=new Float32Array(Z.storage/Float32Array.BYTES_PER_ELEMENT),G.__offset=E,E+=Z.storage}}}const T=E%U;return T>0&&(E+=U-T),S.__size=E,S.__cache={},this}function v(S){const M={boundary:0,storage:0};return typeof S=="number"||typeof S=="boolean"?(M.boundary=4,M.storage=4):S.isVector2?(M.boundary=8,M.storage=8):S.isVector3||S.isColor?(M.boundary=16,M.storage=12):S.isVector4?(M.boundary=16,M.storage=16):S.isMatrix3?(M.boundary=48,M.storage=48):S.isMatrix4?(M.boundary=64,M.storage=64):S.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",S),M}function m(S){const M=S.target;M.removeEventListener("dispose",m);const E=o.indexOf(M.__bindingPointIndex);o.splice(E,1),n.deleteBuffer(r[M.id]),delete r[M.id],delete s[M.id]}function d(){for(const S in r)n.deleteBuffer(r[S]);o=[],r={},s={}}return{bind:l,update:c,dispose:d}}class Ib{constructor(t={}){const{canvas:e=ef(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1,reverseDepthBuffer:p=!1}=t;this.isWebGLRenderer=!0;let f;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");f=i.getContextAttributes().alpha}else f=o;const _=new Uint32Array(4),v=new Int32Array(4);let m=null,d=null;const S=[],M=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Se,this.toneMapping=Qn,this.toneMappingExposure=1;const E=this;let U=!1,T=0,C=0,N=null,y=-1,x=null;const R=new te,G=new te;let B=null;const Y=new It(0);let K=0,X=e.width,Z=e.height,z=1,rt=null,ht=null;const gt=new te(0,0,X,Z),Ft=new te(0,0,X,Z);let ee=!1;const W=new _l;let tt=!1,mt=!1;const st=new re,Et=new re,At=new P,Ot=new te,le={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ht=!1;function pe(){return N===null?z:1}let A=i;function Ye(b,D){return e.getContext(b,D)}try{const b={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${ol}`),e.addEventListener("webglcontextlost",q,!1),e.addEventListener("webglcontextrestored",lt,!1),e.addEventListener("webglcontextcreationerror",at,!1),A===null){const D="webgl2";if(A=Ye(D,b),A===null)throw Ye(D)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(b){throw console.error("THREE.WebGLRenderer: "+b.message),b}let Bt,Vt,vt,se,bt,w,g,F,j,$,H,_t,ot,ut,Gt,Q,dt,wt,Mt,pt,zt,Lt,ne,L;function nt(){Bt=new Hg(A),Bt.init(),Lt=new Mb(A,Bt),Vt=new Fg(A,Bt,t,Lt),vt=new wb(A,Bt),Vt.reverseDepthBuffer&&p&&vt.buffers.depth.setReversed(!0),se=new Xg(A),bt=new cb,w=new Eb(A,Bt,vt,bt,Vt,Lt,se),g=new kg(E),F=new zg(E),j=new Jf(A),ne=new Ug(A,j),$=new Gg(A,j,se,ne),H=new qg(A,$,j,se),Mt=new jg(A,Vt,w),Q=new Og(bt),_t=new lb(E,g,F,Bt,Vt,ne,Q),ot=new Lb(E,bt),ut=new ub,Gt=new gb(Bt),wt=new Ig(E,g,F,vt,H,f,l),dt=new xb(E,H,Vt),L=new Db(A,se,Vt,vt),pt=new Ng(A,Bt,se),zt=new Wg(A,Bt,se),se.programs=_t.programs,E.capabilities=Vt,E.extensions=Bt,E.properties=bt,E.renderLists=ut,E.shadowMap=dt,E.state=vt,E.info=se}nt();const V=new Pb(E,A);this.xr=V,this.getContext=function(){return A},this.getContextAttributes=function(){return A.getContextAttributes()},this.forceContextLoss=function(){const b=Bt.get("WEBGL_lose_context");b&&b.loseContext()},this.forceContextRestore=function(){const b=Bt.get("WEBGL_lose_context");b&&b.restoreContext()},this.getPixelRatio=function(){return z},this.setPixelRatio=function(b){b!==void 0&&(z=b,this.setSize(X,Z,!1))},this.getSize=function(b){return b.set(X,Z)},this.setSize=function(b,D,O=!0){if(V.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}X=b,Z=D,e.width=Math.floor(b*z),e.height=Math.floor(D*z),O===!0&&(e.style.width=b+"px",e.style.height=D+"px"),this.setViewport(0,0,b,D)},this.getDrawingBufferSize=function(b){return b.set(X*z,Z*z).floor()},this.setDrawingBufferSize=function(b,D,O){X=b,Z=D,z=O,e.width=Math.floor(b*O),e.height=Math.floor(D*O),this.setViewport(0,0,b,D)},this.getCurrentViewport=function(b){return b.copy(R)},this.getViewport=function(b){return b.copy(gt)},this.setViewport=function(b,D,O,k){b.isVector4?gt.set(b.x,b.y,b.z,b.w):gt.set(b,D,O,k),vt.viewport(R.copy(gt).multiplyScalar(z).round())},this.getScissor=function(b){return b.copy(Ft)},this.setScissor=function(b,D,O,k){b.isVector4?Ft.set(b.x,b.y,b.z,b.w):Ft.set(b,D,O,k),vt.scissor(G.copy(Ft).multiplyScalar(z).round())},this.getScissorTest=function(){return ee},this.setScissorTest=function(b){vt.setScissorTest(ee=b)},this.setOpaqueSort=function(b){rt=b},this.setTransparentSort=function(b){ht=b},this.getClearColor=function(b){return b.copy(wt.getClearColor())},this.setClearColor=function(){wt.setClearColor.apply(wt,arguments)},this.getClearAlpha=function(){return wt.getClearAlpha()},this.setClearAlpha=function(){wt.setClearAlpha.apply(wt,arguments)},this.clear=function(b=!0,D=!0,O=!0){let k=0;if(b){let I=!1;if(N!==null){const J=N.texture.format;I=J===pl||J===dl||J===ul}if(I){const J=N.texture.type,it=J===Nn||J===yi||J===kr||J===hr||J===cl||J===hl,ct=wt.getClearColor(),ft=wt.getClearAlpha(),St=ct.r,Ct=ct.g,xt=ct.b;it?(_[0]=St,_[1]=Ct,_[2]=xt,_[3]=ft,A.clearBufferuiv(A.COLOR,0,_)):(v[0]=St,v[1]=Ct,v[2]=xt,v[3]=ft,A.clearBufferiv(A.COLOR,0,v))}else k|=A.COLOR_BUFFER_BIT}D&&(k|=A.DEPTH_BUFFER_BIT),O&&(k|=A.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),A.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",q,!1),e.removeEventListener("webglcontextrestored",lt,!1),e.removeEventListener("webglcontextcreationerror",at,!1),wt.dispose(),ut.dispose(),Gt.dispose(),bt.dispose(),g.dispose(),F.dispose(),H.dispose(),ne.dispose(),L.dispose(),_t.dispose(),V.dispose(),V.removeEventListener("sessionstart",oc),V.removeEventListener("sessionend",ac),ri.stop()};function q(b){b.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),U=!0}function lt(){console.log("THREE.WebGLRenderer: Context Restored."),U=!1;const b=se.autoReset,D=dt.enabled,O=dt.autoUpdate,k=dt.needsUpdate,I=dt.type;nt(),se.autoReset=b,dt.enabled=D,dt.autoUpdate=O,dt.needsUpdate=k,dt.type=I}function at(b){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",b.statusMessage)}function Pt(b){const D=b.target;D.removeEventListener("dispose",Pt),he(D)}function he(b){Te(b),bt.remove(b)}function Te(b){const D=bt.get(b).programs;D!==void 0&&(D.forEach(function(O){_t.releaseProgram(O)}),b.isShaderMaterial&&_t.releaseShaderCache(b))}this.renderBufferDirect=function(b,D,O,k,I,J){D===null&&(D=le);const it=I.isMesh&&I.matrixWorld.determinant()<0,ct=jd(b,D,O,k,I);vt.setMaterial(k,it);let ft=O.index,St=1;if(k.wireframe===!0){if(ft=$.getWireframeAttribute(O),ft===void 0)return;St=2}const Ct=O.drawRange,xt=O.attributes.position;let Wt=Ct.start*St,Yt=(Ct.start+Ct.count)*St;J!==null&&(Wt=Math.max(Wt,J.start*St),Yt=Math.min(Yt,(J.start+J.count)*St)),ft!==null?(Wt=Math.max(Wt,0),Yt=Math.min(Yt,ft.count)):xt!=null&&(Wt=Math.max(Wt,0),Yt=Math.min(Yt,xt.count));const fe=Yt-Wt;if(fe<0||fe===1/0)return;ne.setup(I,k,ct,O,ft);let ue,jt=pt;if(ft!==null&&(ue=j.get(ft),jt=zt,jt.setIndex(ue)),I.isMesh)k.wireframe===!0?(vt.setLineWidth(k.wireframeLinewidth*pe()),jt.setMode(A.LINES)):jt.setMode(A.TRIANGLES);else if(I.isLine){let yt=k.linewidth;yt===void 0&&(yt=1),vt.setLineWidth(yt*pe()),I.isLineSegments?jt.setMode(A.LINES):I.isLineLoop?jt.setMode(A.LINE_LOOP):jt.setMode(A.LINE_STRIP)}else I.isPoints?jt.setMode(A.POINTS):I.isSprite&&jt.setMode(A.TRIANGLES);if(I.isBatchedMesh)if(I._multiDrawInstances!==null)jt.renderMultiDrawInstances(I._multiDrawStarts,I._multiDrawCounts,I._multiDrawCount,I._multiDrawInstances);else if(Bt.get("WEBGL_multi_draw"))jt.renderMultiDraw(I._multiDrawStarts,I._multiDrawCounts,I._multiDrawCount);else{const yt=I._multiDrawStarts,Me=I._multiDrawCounts,Kt=I._multiDrawCount,rn=ft?j.get(ft).bytesPerElement:1,Di=bt.get(k).currentProgram.getUniforms();for(let Ve=0;Ve<Kt;Ve++)Di.setValue(A,"_gl_DrawID",Ve),jt.render(yt[Ve]/rn,Me[Ve])}else if(I.isInstancedMesh)jt.renderInstances(Wt,fe,I.count);else if(O.isInstancedBufferGeometry){const yt=O._maxInstanceCount!==void 0?O._maxInstanceCount:1/0,Me=Math.min(O.instanceCount,yt);jt.renderInstances(Wt,fe,Me)}else jt.render(Wt,fe)};function Zt(b,D,O){b.transparent===!0&&b.side===An&&b.forceSinglePass===!1?(b.side=ke,b.needsUpdate=!0,us(b,D,O),b.side=Un,b.needsUpdate=!0,us(b,D,O),b.side=An):us(b,D,O)}this.compile=function(b,D,O=null){O===null&&(O=b),d=Gt.get(O),d.init(D),M.push(d),O.traverseVisible(function(I){I.isLight&&I.layers.test(D.layers)&&(d.pushLight(I),I.castShadow&&d.pushShadow(I))}),b!==O&&b.traverseVisible(function(I){I.isLight&&I.layers.test(D.layers)&&(d.pushLight(I),I.castShadow&&d.pushShadow(I))}),d.setupLights();const k=new Set;return b.traverse(function(I){if(!(I.isMesh||I.isPoints||I.isLine||I.isSprite))return;const J=I.material;if(J)if(Array.isArray(J))for(let it=0;it<J.length;it++){const ct=J[it];Zt(ct,O,I),k.add(ct)}else Zt(J,O,I),k.add(J)}),M.pop(),d=null,k},this.compileAsync=function(b,D,O=null){const k=this.compile(b,D,O);return new Promise(I=>{function J(){if(k.forEach(function(it){bt.get(it).currentProgram.isReady()&&k.delete(it)}),k.size===0){I(b);return}setTimeout(J,10)}Bt.get("KHR_parallel_shader_compile")!==null?J():setTimeout(J,10)})};let nn=null;function bn(b){nn&&nn(b)}function oc(){ri.stop()}function ac(){ri.start()}const ri=new Du;ri.setAnimationLoop(bn),typeof self<"u"&&ri.setContext(self),this.setAnimationLoop=function(b){nn=b,V.setAnimationLoop(b),b===null?ri.stop():ri.start()},V.addEventListener("sessionstart",oc),V.addEventListener("sessionend",ac),this.render=function(b,D){if(D!==void 0&&D.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(U===!0)return;if(b.matrixWorldAutoUpdate===!0&&b.updateMatrixWorld(),D.parent===null&&D.matrixWorldAutoUpdate===!0&&D.updateMatrixWorld(),V.enabled===!0&&V.isPresenting===!0&&(V.cameraAutoUpdate===!0&&V.updateCamera(D),D=V.getCamera()),b.isScene===!0&&b.onBeforeRender(E,b,D,N),d=Gt.get(b,M.length),d.init(D),M.push(d),Et.multiplyMatrices(D.projectionMatrix,D.matrixWorldInverse),W.setFromProjectionMatrix(Et),mt=this.localClippingEnabled,tt=Q.init(this.clippingPlanes,mt),m=ut.get(b,S.length),m.init(),S.push(m),V.enabled===!0&&V.isPresenting===!0){const J=E.xr.getDepthSensingMesh();J!==null&&xo(J,D,-1/0,E.sortObjects)}xo(b,D,0,E.sortObjects),m.finish(),E.sortObjects===!0&&m.sort(rt,ht),Ht=V.enabled===!1||V.isPresenting===!1||V.hasDepthSensing()===!1,Ht&&wt.addToRenderList(m,b),this.info.render.frame++,tt===!0&&Q.beginShadows();const O=d.state.shadowsArray;dt.render(O,b,D),tt===!0&&Q.endShadows(),this.info.autoReset===!0&&this.info.reset();const k=m.opaque,I=m.transmissive;if(d.setupLights(),D.isArrayCamera){const J=D.cameras;if(I.length>0)for(let it=0,ct=J.length;it<ct;it++){const ft=J[it];cc(k,I,b,ft)}Ht&&wt.render(b);for(let it=0,ct=J.length;it<ct;it++){const ft=J[it];lc(m,b,ft,ft.viewport)}}else I.length>0&&cc(k,I,b,D),Ht&&wt.render(b),lc(m,b,D);N!==null&&(w.updateMultisampleRenderTarget(N),w.updateRenderTargetMipmap(N)),b.isScene===!0&&b.onAfterRender(E,b,D),ne.resetDefaultState(),y=-1,x=null,M.pop(),M.length>0?(d=M[M.length-1],tt===!0&&Q.setGlobalState(E.clippingPlanes,d.state.camera)):d=null,S.pop(),S.length>0?m=S[S.length-1]:m=null};function xo(b,D,O,k){if(b.visible===!1)return;if(b.layers.test(D.layers)){if(b.isGroup)O=b.renderOrder;else if(b.isLOD)b.autoUpdate===!0&&b.update(D);else if(b.isLight)d.pushLight(b),b.castShadow&&d.pushShadow(b);else if(b.isSprite){if(!b.frustumCulled||W.intersectsSprite(b)){k&&Ot.setFromMatrixPosition(b.matrixWorld).applyMatrix4(Et);const it=H.update(b),ct=b.material;ct.visible&&m.push(b,it,ct,O,Ot.z,null)}}else if((b.isMesh||b.isLine||b.isPoints)&&(!b.frustumCulled||W.intersectsObject(b))){const it=H.update(b),ct=b.material;if(k&&(b.boundingSphere!==void 0?(b.boundingSphere===null&&b.computeBoundingSphere(),Ot.copy(b.boundingSphere.center)):(it.boundingSphere===null&&it.computeBoundingSphere(),Ot.copy(it.boundingSphere.center)),Ot.applyMatrix4(b.matrixWorld).applyMatrix4(Et)),Array.isArray(ct)){const ft=it.groups;for(let St=0,Ct=ft.length;St<Ct;St++){const xt=ft[St],Wt=ct[xt.materialIndex];Wt&&Wt.visible&&m.push(b,it,Wt,O,Ot.z,xt)}}else ct.visible&&m.push(b,it,ct,O,Ot.z,null)}}const J=b.children;for(let it=0,ct=J.length;it<ct;it++)xo(J[it],D,O,k)}function lc(b,D,O,k){const I=b.opaque,J=b.transmissive,it=b.transparent;d.setupLightsView(O),tt===!0&&Q.setGlobalState(E.clippingPlanes,O),k&&vt.viewport(R.copy(k)),I.length>0&&hs(I,D,O),J.length>0&&hs(J,D,O),it.length>0&&hs(it,D,O),vt.buffers.depth.setTest(!0),vt.buffers.depth.setMask(!0),vt.buffers.color.setMask(!0),vt.setPolygonOffset(!1)}function cc(b,D,O,k){if((O.isScene===!0?O.overrideMaterial:null)!==null)return;d.state.transmissionRenderTarget[k.id]===void 0&&(d.state.transmissionRenderTarget[k.id]=new wi(1,1,{generateMipmaps:!0,type:Bt.has("EXT_color_buffer_half_float")||Bt.has("EXT_color_buffer_float")?Yr:Nn,minFilter:bi,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:kt.workingColorSpace}));const J=d.state.transmissionRenderTarget[k.id],it=k.viewport||R;J.setSize(it.z,it.w);const ct=E.getRenderTarget();E.setRenderTarget(J),E.getClearColor(Y),K=E.getClearAlpha(),K<1&&E.setClearColor(16777215,.5),E.clear(),Ht&&wt.render(O);const ft=E.toneMapping;E.toneMapping=Qn;const St=k.viewport;if(k.viewport!==void 0&&(k.viewport=void 0),d.setupLightsView(k),tt===!0&&Q.setGlobalState(E.clippingPlanes,k),hs(b,O,k),w.updateMultisampleRenderTarget(J),w.updateRenderTargetMipmap(J),Bt.has("WEBGL_multisampled_render_to_texture")===!1){let Ct=!1;for(let xt=0,Wt=D.length;xt<Wt;xt++){const Yt=D[xt],fe=Yt.object,ue=Yt.geometry,jt=Yt.material,yt=Yt.group;if(jt.side===An&&fe.layers.test(k.layers)){const Me=jt.side;jt.side=ke,jt.needsUpdate=!0,hc(fe,O,k,ue,jt,yt),jt.side=Me,jt.needsUpdate=!0,Ct=!0}}Ct===!0&&(w.updateMultisampleRenderTarget(J),w.updateRenderTargetMipmap(J))}E.setRenderTarget(ct),E.setClearColor(Y,K),St!==void 0&&(k.viewport=St),E.toneMapping=ft}function hs(b,D,O){const k=D.isScene===!0?D.overrideMaterial:null;for(let I=0,J=b.length;I<J;I++){const it=b[I],ct=it.object,ft=it.geometry,St=k===null?it.material:k,Ct=it.group;ct.layers.test(O.layers)&&hc(ct,D,O,ft,St,Ct)}}function hc(b,D,O,k,I,J){b.onBeforeRender(E,D,O,k,I,J),b.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse,b.matrixWorld),b.normalMatrix.getNormalMatrix(b.modelViewMatrix),I.onBeforeRender(E,D,O,k,b,J),I.transparent===!0&&I.side===An&&I.forceSinglePass===!1?(I.side=ke,I.needsUpdate=!0,E.renderBufferDirect(O,D,k,I,b,J),I.side=Un,I.needsUpdate=!0,E.renderBufferDirect(O,D,k,I,b,J),I.side=An):E.renderBufferDirect(O,D,k,I,b,J),b.onAfterRender(E,D,O,k,I,J)}function us(b,D,O){D.isScene!==!0&&(D=le);const k=bt.get(b),I=d.state.lights,J=d.state.shadowsArray,it=I.state.version,ct=_t.getParameters(b,I.state,J,D,O),ft=_t.getProgramCacheKey(ct);let St=k.programs;k.environment=b.isMeshStandardMaterial?D.environment:null,k.fog=D.fog,k.envMap=(b.isMeshStandardMaterial?F:g).get(b.envMap||k.environment),k.envMapRotation=k.environment!==null&&b.envMap===null?D.environmentRotation:b.envMapRotation,St===void 0&&(b.addEventListener("dispose",Pt),St=new Map,k.programs=St);let Ct=St.get(ft);if(Ct!==void 0){if(k.currentProgram===Ct&&k.lightsStateVersion===it)return dc(b,ct),Ct}else ct.uniforms=_t.getUniforms(b),b.onBeforeCompile(ct,E),Ct=_t.acquireProgram(ct,ft),St.set(ft,Ct),k.uniforms=ct.uniforms;const xt=k.uniforms;return(!b.isShaderMaterial&&!b.isRawShaderMaterial||b.clipping===!0)&&(xt.clippingPlanes=Q.uniform),dc(b,ct),k.needsLights=Yd(b),k.lightsStateVersion=it,k.needsLights&&(xt.ambientLightColor.value=I.state.ambient,xt.lightProbe.value=I.state.probe,xt.directionalLights.value=I.state.directional,xt.directionalLightShadows.value=I.state.directionalShadow,xt.spotLights.value=I.state.spot,xt.spotLightShadows.value=I.state.spotShadow,xt.rectAreaLights.value=I.state.rectArea,xt.ltc_1.value=I.state.rectAreaLTC1,xt.ltc_2.value=I.state.rectAreaLTC2,xt.pointLights.value=I.state.point,xt.pointLightShadows.value=I.state.pointShadow,xt.hemisphereLights.value=I.state.hemi,xt.directionalShadowMap.value=I.state.directionalShadowMap,xt.directionalShadowMatrix.value=I.state.directionalShadowMatrix,xt.spotShadowMap.value=I.state.spotShadowMap,xt.spotLightMatrix.value=I.state.spotLightMatrix,xt.spotLightMap.value=I.state.spotLightMap,xt.pointShadowMap.value=I.state.pointShadowMap,xt.pointShadowMatrix.value=I.state.pointShadowMatrix),k.currentProgram=Ct,k.uniformsList=null,Ct}function uc(b){if(b.uniformsList===null){const D=b.currentProgram.getUniforms();b.uniformsList=qs.seqWithValue(D.seq,b.uniforms)}return b.uniformsList}function dc(b,D){const O=bt.get(b);O.outputColorSpace=D.outputColorSpace,O.batching=D.batching,O.batchingColor=D.batchingColor,O.instancing=D.instancing,O.instancingColor=D.instancingColor,O.instancingMorph=D.instancingMorph,O.skinning=D.skinning,O.morphTargets=D.morphTargets,O.morphNormals=D.morphNormals,O.morphColors=D.morphColors,O.morphTargetsCount=D.morphTargetsCount,O.numClippingPlanes=D.numClippingPlanes,O.numIntersection=D.numClipIntersection,O.vertexAlphas=D.vertexAlphas,O.vertexTangents=D.vertexTangents,O.toneMapping=D.toneMapping}function jd(b,D,O,k,I){D.isScene!==!0&&(D=le),w.resetTextureUnits();const J=D.fog,it=k.isMeshStandardMaterial?D.environment:null,ct=N===null?E.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:dr,ft=(k.isMeshStandardMaterial?F:g).get(k.envMap||it),St=k.vertexColors===!0&&!!O.attributes.color&&O.attributes.color.itemSize===4,Ct=!!O.attributes.tangent&&(!!k.normalMap||k.anisotropy>0),xt=!!O.morphAttributes.position,Wt=!!O.morphAttributes.normal,Yt=!!O.morphAttributes.color;let fe=Qn;k.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(fe=E.toneMapping);const ue=O.morphAttributes.position||O.morphAttributes.normal||O.morphAttributes.color,jt=ue!==void 0?ue.length:0,yt=bt.get(k),Me=d.state.lights;if(tt===!0&&(mt===!0||b!==x)){const Pe=b===x&&k.id===y;Q.setState(k,b,Pe)}let Kt=!1;k.version===yt.__version?(yt.needsLights&&yt.lightsStateVersion!==Me.state.version||yt.outputColorSpace!==ct||I.isBatchedMesh&&yt.batching===!1||!I.isBatchedMesh&&yt.batching===!0||I.isBatchedMesh&&yt.batchingColor===!0&&I.colorTexture===null||I.isBatchedMesh&&yt.batchingColor===!1&&I.colorTexture!==null||I.isInstancedMesh&&yt.instancing===!1||!I.isInstancedMesh&&yt.instancing===!0||I.isSkinnedMesh&&yt.skinning===!1||!I.isSkinnedMesh&&yt.skinning===!0||I.isInstancedMesh&&yt.instancingColor===!0&&I.instanceColor===null||I.isInstancedMesh&&yt.instancingColor===!1&&I.instanceColor!==null||I.isInstancedMesh&&yt.instancingMorph===!0&&I.morphTexture===null||I.isInstancedMesh&&yt.instancingMorph===!1&&I.morphTexture!==null||yt.envMap!==ft||k.fog===!0&&yt.fog!==J||yt.numClippingPlanes!==void 0&&(yt.numClippingPlanes!==Q.numPlanes||yt.numIntersection!==Q.numIntersection)||yt.vertexAlphas!==St||yt.vertexTangents!==Ct||yt.morphTargets!==xt||yt.morphNormals!==Wt||yt.morphColors!==Yt||yt.toneMapping!==fe||yt.morphTargetsCount!==jt)&&(Kt=!0):(Kt=!0,yt.__version=k.version);let rn=yt.currentProgram;Kt===!0&&(rn=us(k,D,I));let Di=!1,Ve=!1,yr=!1;const oe=rn.getUniforms(),Ke=yt.uniforms;if(vt.useProgram(rn.program)&&(Di=!0,Ve=!0,yr=!0),k.id!==y&&(y=k.id,Ve=!0),Di||x!==b){vt.buffers.depth.getReversed()?(st.copy(b.projectionMatrix),rf(st),sf(st),oe.setValue(A,"projectionMatrix",st)):oe.setValue(A,"projectionMatrix",b.projectionMatrix),oe.setValue(A,"viewMatrix",b.matrixWorldInverse);const Ne=oe.map.cameraPosition;Ne!==void 0&&Ne.setValue(A,At.setFromMatrixPosition(b.matrixWorld)),Vt.logarithmicDepthBuffer&&oe.setValue(A,"logDepthBufFC",2/(Math.log(b.far+1)/Math.LN2)),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&oe.setValue(A,"isOrthographic",b.isOrthographicCamera===!0),x!==b&&(x=b,Ve=!0,yr=!0)}if(I.isSkinnedMesh){oe.setOptional(A,I,"bindMatrix"),oe.setOptional(A,I,"bindMatrixInverse");const Pe=I.skeleton;Pe&&(Pe.boneTexture===null&&Pe.computeBoneTexture(),oe.setValue(A,"boneTexture",Pe.boneTexture,w))}I.isBatchedMesh&&(oe.setOptional(A,I,"batchingTexture"),oe.setValue(A,"batchingTexture",I._matricesTexture,w),oe.setOptional(A,I,"batchingIdTexture"),oe.setValue(A,"batchingIdTexture",I._indirectTexture,w),oe.setOptional(A,I,"batchingColorTexture"),I._colorsTexture!==null&&oe.setValue(A,"batchingColorTexture",I._colorsTexture,w));const $e=O.morphAttributes;if(($e.position!==void 0||$e.normal!==void 0||$e.color!==void 0)&&Mt.update(I,O,rn),(Ve||yt.receiveShadow!==I.receiveShadow)&&(yt.receiveShadow=I.receiveShadow,oe.setValue(A,"receiveShadow",I.receiveShadow)),k.isMeshGouraudMaterial&&k.envMap!==null&&(Ke.envMap.value=ft,Ke.flipEnvMap.value=ft.isCubeTexture&&ft.isRenderTargetTexture===!1?-1:1),k.isMeshStandardMaterial&&k.envMap===null&&D.environment!==null&&(Ke.envMapIntensity.value=D.environmentIntensity),Ve&&(oe.setValue(A,"toneMappingExposure",E.toneMappingExposure),yt.needsLights&&qd(Ke,yr),J&&k.fog===!0&&ot.refreshFogUniforms(Ke,J),ot.refreshMaterialUniforms(Ke,k,z,Z,d.state.transmissionRenderTarget[b.id]),qs.upload(A,uc(yt),Ke,w)),k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(qs.upload(A,uc(yt),Ke,w),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&oe.setValue(A,"center",I.center),oe.setValue(A,"modelViewMatrix",I.modelViewMatrix),oe.setValue(A,"normalMatrix",I.normalMatrix),oe.setValue(A,"modelMatrix",I.matrixWorld),k.isShaderMaterial||k.isRawShaderMaterial){const Pe=k.uniformsGroups;for(let Ne=0,yo=Pe.length;Ne<yo;Ne++){const si=Pe[Ne];L.update(si,rn),L.bind(si,rn)}}return rn}function qd(b,D){b.ambientLightColor.needsUpdate=D,b.lightProbe.needsUpdate=D,b.directionalLights.needsUpdate=D,b.directionalLightShadows.needsUpdate=D,b.pointLights.needsUpdate=D,b.pointLightShadows.needsUpdate=D,b.spotLights.needsUpdate=D,b.spotLightShadows.needsUpdate=D,b.rectAreaLights.needsUpdate=D,b.hemisphereLights.needsUpdate=D}function Yd(b){return b.isMeshLambertMaterial||b.isMeshToonMaterial||b.isMeshPhongMaterial||b.isMeshStandardMaterial||b.isShadowMaterial||b.isShaderMaterial&&b.lights===!0}this.getActiveCubeFace=function(){return T},this.getActiveMipmapLevel=function(){return C},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(b,D,O){bt.get(b.texture).__webglTexture=D,bt.get(b.depthTexture).__webglTexture=O;const k=bt.get(b);k.__hasExternalTextures=!0,k.__autoAllocateDepthBuffer=O===void 0,k.__autoAllocateDepthBuffer||Bt.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),k.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(b,D){const O=bt.get(b);O.__webglFramebuffer=D,O.__useDefaultFramebuffer=D===void 0},this.setRenderTarget=function(b,D=0,O=0){N=b,T=D,C=O;let k=!0,I=null,J=!1,it=!1;if(b){const ft=bt.get(b);if(ft.__useDefaultFramebuffer!==void 0)vt.bindFramebuffer(A.FRAMEBUFFER,null),k=!1;else if(ft.__webglFramebuffer===void 0)w.setupRenderTarget(b);else if(ft.__hasExternalTextures)w.rebindTextures(b,bt.get(b.texture).__webglTexture,bt.get(b.depthTexture).__webglTexture);else if(b.depthBuffer){const xt=b.depthTexture;if(ft.__boundDepthTexture!==xt){if(xt!==null&&bt.has(xt)&&(b.width!==xt.image.width||b.height!==xt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");w.setupDepthRenderbuffer(b)}}const St=b.texture;(St.isData3DTexture||St.isDataArrayTexture||St.isCompressedArrayTexture)&&(it=!0);const Ct=bt.get(b).__webglFramebuffer;b.isWebGLCubeRenderTarget?(Array.isArray(Ct[D])?I=Ct[D][O]:I=Ct[D],J=!0):b.samples>0&&w.useMultisampledRTT(b)===!1?I=bt.get(b).__webglMultisampledFramebuffer:Array.isArray(Ct)?I=Ct[O]:I=Ct,R.copy(b.viewport),G.copy(b.scissor),B=b.scissorTest}else R.copy(gt).multiplyScalar(z).floor(),G.copy(Ft).multiplyScalar(z).floor(),B=ee;if(vt.bindFramebuffer(A.FRAMEBUFFER,I)&&k&&vt.drawBuffers(b,I),vt.viewport(R),vt.scissor(G),vt.setScissorTest(B),J){const ft=bt.get(b.texture);A.framebufferTexture2D(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_CUBE_MAP_POSITIVE_X+D,ft.__webglTexture,O)}else if(it){const ft=bt.get(b.texture),St=D||0;A.framebufferTextureLayer(A.FRAMEBUFFER,A.COLOR_ATTACHMENT0,ft.__webglTexture,O||0,St)}y=-1},this.readRenderTargetPixels=function(b,D,O,k,I,J,it){if(!(b&&b.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ct=bt.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&it!==void 0&&(ct=ct[it]),ct){vt.bindFramebuffer(A.FRAMEBUFFER,ct);try{const ft=b.texture,St=ft.format,Ct=ft.type;if(!Vt.textureFormatReadable(St)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Vt.textureTypeReadable(Ct)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}D>=0&&D<=b.width-k&&O>=0&&O<=b.height-I&&A.readPixels(D,O,k,I,Lt.convert(St),Lt.convert(Ct),J)}finally{const ft=N!==null?bt.get(N).__webglFramebuffer:null;vt.bindFramebuffer(A.FRAMEBUFFER,ft)}}},this.readRenderTargetPixelsAsync=async function(b,D,O,k,I,J,it){if(!(b&&b.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ct=bt.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&it!==void 0&&(ct=ct[it]),ct){const ft=b.texture,St=ft.format,Ct=ft.type;if(!Vt.textureFormatReadable(St))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Vt.textureTypeReadable(Ct))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(D>=0&&D<=b.width-k&&O>=0&&O<=b.height-I){vt.bindFramebuffer(A.FRAMEBUFFER,ct);const xt=A.createBuffer();A.bindBuffer(A.PIXEL_PACK_BUFFER,xt),A.bufferData(A.PIXEL_PACK_BUFFER,J.byteLength,A.STREAM_READ),A.readPixels(D,O,k,I,Lt.convert(St),Lt.convert(Ct),0);const Wt=N!==null?bt.get(N).__webglFramebuffer:null;vt.bindFramebuffer(A.FRAMEBUFFER,Wt);const Yt=A.fenceSync(A.SYNC_GPU_COMMANDS_COMPLETE,0);return A.flush(),await nf(A,Yt,4),A.bindBuffer(A.PIXEL_PACK_BUFFER,xt),A.getBufferSubData(A.PIXEL_PACK_BUFFER,0,J),A.deleteBuffer(xt),A.deleteSync(Yt),J}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(b,D=null,O=0){b.isTexture!==!0&&($i("WebGLRenderer: copyFramebufferToTexture function signature has changed."),D=arguments[0]||null,b=arguments[1]);const k=Math.pow(2,-O),I=Math.floor(b.image.width*k),J=Math.floor(b.image.height*k),it=D!==null?D.x:0,ct=D!==null?D.y:0;w.setTexture2D(b,0),A.copyTexSubImage2D(A.TEXTURE_2D,O,0,0,it,ct,I,J),vt.unbindTexture()};const Kd=A.createFramebuffer(),$d=A.createFramebuffer();this.copyTextureToTexture=function(b,D,O=null,k=null,I=0,J=null){b.isTexture!==!0&&($i("WebGLRenderer: copyTextureToTexture function signature has changed."),k=arguments[0]||null,b=arguments[1],D=arguments[2],J=arguments[3]||0,O=null),J===null&&(I!==0?($i("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),J=I,I=0):J=0);let it,ct,ft,St,Ct,xt,Wt,Yt,fe;const ue=b.isCompressedTexture?b.mipmaps[J]:b.image;if(O!==null)it=O.max.x-O.min.x,ct=O.max.y-O.min.y,ft=O.isBox3?O.max.z-O.min.z:1,St=O.min.x,Ct=O.min.y,xt=O.isBox3?O.min.z:0;else{const $e=Math.pow(2,-I);it=Math.floor(ue.width*$e),ct=Math.floor(ue.height*$e),b.isDataArrayTexture?ft=ue.depth:b.isData3DTexture?ft=Math.floor(ue.depth*$e):ft=1,St=0,Ct=0,xt=0}k!==null?(Wt=k.x,Yt=k.y,fe=k.z):(Wt=0,Yt=0,fe=0);const jt=Lt.convert(D.format),yt=Lt.convert(D.type);let Me;D.isData3DTexture?(w.setTexture3D(D,0),Me=A.TEXTURE_3D):D.isDataArrayTexture||D.isCompressedArrayTexture?(w.setTexture2DArray(D,0),Me=A.TEXTURE_2D_ARRAY):(w.setTexture2D(D,0),Me=A.TEXTURE_2D),A.pixelStorei(A.UNPACK_FLIP_Y_WEBGL,D.flipY),A.pixelStorei(A.UNPACK_PREMULTIPLY_ALPHA_WEBGL,D.premultiplyAlpha),A.pixelStorei(A.UNPACK_ALIGNMENT,D.unpackAlignment);const Kt=A.getParameter(A.UNPACK_ROW_LENGTH),rn=A.getParameter(A.UNPACK_IMAGE_HEIGHT),Di=A.getParameter(A.UNPACK_SKIP_PIXELS),Ve=A.getParameter(A.UNPACK_SKIP_ROWS),yr=A.getParameter(A.UNPACK_SKIP_IMAGES);A.pixelStorei(A.UNPACK_ROW_LENGTH,ue.width),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,ue.height),A.pixelStorei(A.UNPACK_SKIP_PIXELS,St),A.pixelStorei(A.UNPACK_SKIP_ROWS,Ct),A.pixelStorei(A.UNPACK_SKIP_IMAGES,xt);const oe=b.isDataArrayTexture||b.isData3DTexture,Ke=D.isDataArrayTexture||D.isData3DTexture;if(b.isDepthTexture){const $e=bt.get(b),Pe=bt.get(D),Ne=bt.get($e.__renderTarget),yo=bt.get(Pe.__renderTarget);vt.bindFramebuffer(A.READ_FRAMEBUFFER,Ne.__webglFramebuffer),vt.bindFramebuffer(A.DRAW_FRAMEBUFFER,yo.__webglFramebuffer);for(let si=0;si<ft;si++)oe&&(A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,bt.get(b).__webglTexture,I,xt+si),A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,bt.get(D).__webglTexture,J,fe+si)),A.blitFramebuffer(St,Ct,it,ct,Wt,Yt,it,ct,A.DEPTH_BUFFER_BIT,A.NEAREST);vt.bindFramebuffer(A.READ_FRAMEBUFFER,null),vt.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else if(I!==0||b.isRenderTargetTexture||bt.has(b)){const $e=bt.get(b),Pe=bt.get(D);vt.bindFramebuffer(A.READ_FRAMEBUFFER,Kd),vt.bindFramebuffer(A.DRAW_FRAMEBUFFER,$d);for(let Ne=0;Ne<ft;Ne++)oe?A.framebufferTextureLayer(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,$e.__webglTexture,I,xt+Ne):A.framebufferTexture2D(A.READ_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,$e.__webglTexture,I),Ke?A.framebufferTextureLayer(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,Pe.__webglTexture,J,fe+Ne):A.framebufferTexture2D(A.DRAW_FRAMEBUFFER,A.COLOR_ATTACHMENT0,A.TEXTURE_2D,Pe.__webglTexture,J),I!==0?A.blitFramebuffer(St,Ct,it,ct,Wt,Yt,it,ct,A.COLOR_BUFFER_BIT,A.NEAREST):Ke?A.copyTexSubImage3D(Me,J,Wt,Yt,fe+Ne,St,Ct,it,ct):A.copyTexSubImage2D(Me,J,Wt,Yt,St,Ct,it,ct);vt.bindFramebuffer(A.READ_FRAMEBUFFER,null),vt.bindFramebuffer(A.DRAW_FRAMEBUFFER,null)}else Ke?b.isDataTexture||b.isData3DTexture?A.texSubImage3D(Me,J,Wt,Yt,fe,it,ct,ft,jt,yt,ue.data):D.isCompressedArrayTexture?A.compressedTexSubImage3D(Me,J,Wt,Yt,fe,it,ct,ft,jt,ue.data):A.texSubImage3D(Me,J,Wt,Yt,fe,it,ct,ft,jt,yt,ue):b.isDataTexture?A.texSubImage2D(A.TEXTURE_2D,J,Wt,Yt,it,ct,jt,yt,ue.data):b.isCompressedTexture?A.compressedTexSubImage2D(A.TEXTURE_2D,J,Wt,Yt,ue.width,ue.height,jt,ue.data):A.texSubImage2D(A.TEXTURE_2D,J,Wt,Yt,it,ct,jt,yt,ue);A.pixelStorei(A.UNPACK_ROW_LENGTH,Kt),A.pixelStorei(A.UNPACK_IMAGE_HEIGHT,rn),A.pixelStorei(A.UNPACK_SKIP_PIXELS,Di),A.pixelStorei(A.UNPACK_SKIP_ROWS,Ve),A.pixelStorei(A.UNPACK_SKIP_IMAGES,yr),J===0&&D.generateMipmaps&&A.generateMipmap(Me),vt.unbindTexture()},this.copyTextureToTexture3D=function(b,D,O=null,k=null,I=0){return b.isTexture!==!0&&($i("WebGLRenderer: copyTextureToTexture3D function signature has changed."),O=arguments[0]||null,k=arguments[1]||null,b=arguments[2],D=arguments[3],I=arguments[4]||0),$i('WebGLRenderer: copyTextureToTexture3D function has been deprecated. Use "copyTextureToTexture" instead.'),this.copyTextureToTexture(b,D,O,k,I)},this.initRenderTarget=function(b){bt.get(b).__webglFramebuffer===void 0&&w.setupRenderTarget(b)},this.initTexture=function(b){b.isCubeTexture?w.setTextureCube(b,0):b.isData3DTexture?w.setTexture3D(b,0):b.isDataArrayTexture||b.isCompressedArrayTexture?w.setTexture2DArray(b,0):w.setTexture2D(b,0),vt.unbindTexture()},this.resetState=function(){T=0,C=0,N=null,vt.reset(),ne.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Rn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorspace=kt._getDrawingBufferColorSpace(t),e.unpackColorSpace=kt._getUnpackColorSpace()}}const Mh={type:"change"},yl={type:"start"},Ou={type:"end"},ks=new Zr,Sh=new Kn,Ub=Math.cos(70*tf.DEG2RAD),ge=new P,Fe=2*Math.PI,Qt={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Qo=1e-6;class Nb extends $f{constructor(t,e=null){super(t,e),this.state=Qt.NONE,this.enabled=!0,this.target=new P,this.cursor=new P,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:tr.ROTATE,MIDDLE:tr.DOLLY,RIGHT:tr.PAN},this.touches={ONE:Zi.ROTATE,TWO:Zi.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new P,this._lastQuaternion=new ei,this._lastTargetPosition=new P,this._quat=new ei().setFromUnitVectors(t.up,new P(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new Jc,this._sphericalDelta=new Jc,this._scale=1,this._panOffset=new P,this._rotateStart=new Tt,this._rotateEnd=new Tt,this._rotateDelta=new Tt,this._panStart=new Tt,this._panEnd=new Tt,this._panDelta=new Tt,this._dollyStart=new Tt,this._dollyEnd=new Tt,this._dollyDelta=new Tt,this._dollyDirection=new P,this._mouse=new Tt,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=Ob.bind(this),this._onPointerDown=Fb.bind(this),this._onPointerUp=kb.bind(this),this._onContextMenu=Xb.bind(this),this._onMouseWheel=zb.bind(this),this._onKeyDown=Hb.bind(this),this._onTouchStart=Gb.bind(this),this._onTouchMove=Wb.bind(this),this._onMouseDown=Bb.bind(this),this._onMouseMove=Vb.bind(this),this._interceptControlDown=jb.bind(this),this._interceptControlUp=qb.bind(this),this.domElement!==null&&this.connect(),this.update()}connect(){this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(t){t.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=t}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Mh),this.update(),this.state=Qt.NONE}update(t=null){const e=this.object.position;ge.copy(e).sub(this.target),ge.applyQuaternion(this._quat),this._spherical.setFromVector3(ge),this.autoRotate&&this.state===Qt.NONE&&this._rotateLeft(this._getAutoRotationAngle(t)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let i=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(i)&&isFinite(r)&&(i<-Math.PI?i+=Fe:i>Math.PI&&(i-=Fe),r<-Math.PI?r+=Fe:r>Math.PI&&(r-=Fe),i<=r?this._spherical.theta=Math.max(i,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(i+r)/2?Math.max(i,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let s=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const o=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),s=o!=this._spherical.radius}if(ge.setFromSpherical(this._spherical),ge.applyQuaternion(this._quatInverse),e.copy(this.target).add(ge),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let o=null;if(this.object.isPerspectiveCamera){const a=ge.length();o=this._clampDistance(a*this._scale);const l=a-o;this.object.position.addScaledVector(this._dollyDirection,l),this.object.updateMatrixWorld(),s=!!l}else if(this.object.isOrthographicCamera){const a=new P(this._mouse.x,this._mouse.y,0);a.unproject(this.object);const l=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),s=l!==this.object.zoom;const c=new P(this._mouse.x,this._mouse.y,0);c.unproject(this.object),this.object.position.sub(c).add(a),this.object.updateMatrixWorld(),o=ge.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;o!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(o).add(this.object.position):(ks.origin.copy(this.object.position),ks.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(ks.direction))<Ub?this.object.lookAt(this.target):(Sh.setFromNormalAndCoplanarPoint(this.object.up,this.target),ks.intersectPlane(Sh,this.target))))}else if(this.object.isOrthographicCamera){const o=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),o!==this.object.zoom&&(this.object.updateProjectionMatrix(),s=!0)}return this._scale=1,this._performCursorZoom=!1,s||this._lastPosition.distanceToSquared(this.object.position)>Qo||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Qo||this._lastTargetPosition.distanceToSquared(this.target)>Qo?(this.dispatchEvent(Mh),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(t){return t!==null?Fe/60*this.autoRotateSpeed*t:Fe/60/60*this.autoRotateSpeed}_getZoomScale(t){const e=Math.abs(t*.01);return Math.pow(.95,this.zoomSpeed*e)}_rotateLeft(t){this._sphericalDelta.theta-=t}_rotateUp(t){this._sphericalDelta.phi-=t}_panLeft(t,e){ge.setFromMatrixColumn(e,0),ge.multiplyScalar(-t),this._panOffset.add(ge)}_panUp(t,e){this.screenSpacePanning===!0?ge.setFromMatrixColumn(e,1):(ge.setFromMatrixColumn(e,0),ge.crossVectors(this.object.up,ge)),ge.multiplyScalar(t),this._panOffset.add(ge)}_pan(t,e){const i=this.domElement;if(this.object.isPerspectiveCamera){const r=this.object.position;ge.copy(r).sub(this.target);let s=ge.length();s*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*t*s/i.clientHeight,this.object.matrix),this._panUp(2*e*s/i.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(t*(this.object.right-this.object.left)/this.object.zoom/i.clientWidth,this.object.matrix),this._panUp(e*(this.object.top-this.object.bottom)/this.object.zoom/i.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(t){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=t:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(t,e){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const i=this.domElement.getBoundingClientRect(),r=t-i.left,s=e-i.top,o=i.width,a=i.height;this._mouse.x=r/o*2-1,this._mouse.y=-(s/a)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(t){return Math.max(this.minDistance,Math.min(this.maxDistance,t))}_handleMouseDownRotate(t){this._rotateStart.set(t.clientX,t.clientY)}_handleMouseDownDolly(t){this._updateZoomParameters(t.clientX,t.clientX),this._dollyStart.set(t.clientX,t.clientY)}_handleMouseDownPan(t){this._panStart.set(t.clientX,t.clientY)}_handleMouseMoveRotate(t){this._rotateEnd.set(t.clientX,t.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(Fe*this._rotateDelta.x/e.clientHeight),this._rotateUp(Fe*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(t){this._dollyEnd.set(t.clientX,t.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(t){this._panEnd.set(t.clientX,t.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(t){this._updateZoomParameters(t.clientX,t.clientY),t.deltaY<0?this._dollyIn(this._getZoomScale(t.deltaY)):t.deltaY>0&&this._dollyOut(this._getZoomScale(t.deltaY)),this.update()}_handleKeyDown(t){let e=!1;switch(t.code){case this.keys.UP:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(Fe*this.rotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),e=!0;break;case this.keys.BOTTOM:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateUp(-Fe*this.rotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),e=!0;break;case this.keys.LEFT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(Fe*this.rotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),e=!0;break;case this.keys.RIGHT:t.ctrlKey||t.metaKey||t.shiftKey?this.enableRotate&&this._rotateLeft(-Fe*this.rotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),e=!0;break}e&&(t.preventDefault(),this.update())}_handleTouchStartRotate(t){if(this._pointers.length===1)this._rotateStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),r=.5*(t.pageY+e.y);this._rotateStart.set(i,r)}}_handleTouchStartPan(t){if(this._pointers.length===1)this._panStart.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),r=.5*(t.pageY+e.y);this._panStart.set(i,r)}}_handleTouchStartDolly(t){const e=this._getSecondPointerPosition(t),i=t.pageX-e.x,r=t.pageY-e.y,s=Math.sqrt(i*i+r*r);this._dollyStart.set(0,s)}_handleTouchStartDollyPan(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enablePan&&this._handleTouchStartPan(t)}_handleTouchStartDollyRotate(t){this.enableZoom&&this._handleTouchStartDolly(t),this.enableRotate&&this._handleTouchStartRotate(t)}_handleTouchMoveRotate(t){if(this._pointers.length==1)this._rotateEnd.set(t.pageX,t.pageY);else{const i=this._getSecondPointerPosition(t),r=.5*(t.pageX+i.x),s=.5*(t.pageY+i.y);this._rotateEnd.set(r,s)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(Fe*this._rotateDelta.x/e.clientHeight),this._rotateUp(Fe*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(t){if(this._pointers.length===1)this._panEnd.set(t.pageX,t.pageY);else{const e=this._getSecondPointerPosition(t),i=.5*(t.pageX+e.x),r=.5*(t.pageY+e.y);this._panEnd.set(i,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(t){const e=this._getSecondPointerPosition(t),i=t.pageX-e.x,r=t.pageY-e.y,s=Math.sqrt(i*i+r*r);this._dollyEnd.set(0,s),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const o=(t.pageX+e.x)*.5,a=(t.pageY+e.y)*.5;this._updateZoomParameters(o,a)}_handleTouchMoveDollyPan(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enablePan&&this._handleTouchMovePan(t)}_handleTouchMoveDollyRotate(t){this.enableZoom&&this._handleTouchMoveDolly(t),this.enableRotate&&this._handleTouchMoveRotate(t)}_addPointer(t){this._pointers.push(t.pointerId)}_removePointer(t){delete this._pointerPositions[t.pointerId];for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId){this._pointers.splice(e,1);return}}_isTrackingPointer(t){for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==t.pointerId)return!0;return!1}_trackPointer(t){let e=this._pointerPositions[t.pointerId];e===void 0&&(e=new Tt,this._pointerPositions[t.pointerId]=e),e.set(t.pageX,t.pageY)}_getSecondPointerPosition(t){const e=t.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[e]}_customWheelEvent(t){const e=t.deltaMode,i={clientX:t.clientX,clientY:t.clientY,deltaY:t.deltaY};switch(e){case 1:i.deltaY*=16;break;case 2:i.deltaY*=100;break}return t.ctrlKey&&!this._controlActive&&(i.deltaY*=10),i}}function Fb(n){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(n.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(n)&&(this._addPointer(n),n.pointerType==="touch"?this._onTouchStart(n):this._onMouseDown(n)))}function Ob(n){this.enabled!==!1&&(n.pointerType==="touch"?this._onTouchMove(n):this._onMouseMove(n))}function kb(n){switch(this._removePointer(n),this._pointers.length){case 0:this.domElement.releasePointerCapture(n.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(Ou),this.state=Qt.NONE;break;case 1:const t=this._pointers[0],e=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:e.x,pageY:e.y});break}}function Bb(n){let t;switch(n.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case tr.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(n),this.state=Qt.DOLLY;break;case tr.ROTATE:if(n.ctrlKey||n.metaKey||n.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(n),this.state=Qt.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(n),this.state=Qt.ROTATE}break;case tr.PAN:if(n.ctrlKey||n.metaKey||n.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(n),this.state=Qt.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(n),this.state=Qt.PAN}break;default:this.state=Qt.NONE}this.state!==Qt.NONE&&this.dispatchEvent(yl)}function Vb(n){switch(this.state){case Qt.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(n);break;case Qt.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(n);break;case Qt.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(n);break}}function zb(n){this.enabled===!1||this.enableZoom===!1||this.state!==Qt.NONE||(n.preventDefault(),this.dispatchEvent(yl),this._handleMouseWheel(this._customWheelEvent(n)),this.dispatchEvent(Ou))}function Hb(n){this.enabled!==!1&&this._handleKeyDown(n)}function Gb(n){switch(this._trackPointer(n),this._pointers.length){case 1:switch(this.touches.ONE){case Zi.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(n),this.state=Qt.TOUCH_ROTATE;break;case Zi.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(n),this.state=Qt.TOUCH_PAN;break;default:this.state=Qt.NONE}break;case 2:switch(this.touches.TWO){case Zi.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(n),this.state=Qt.TOUCH_DOLLY_PAN;break;case Zi.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(n),this.state=Qt.TOUCH_DOLLY_ROTATE;break;default:this.state=Qt.NONE}break;default:this.state=Qt.NONE}this.state!==Qt.NONE&&this.dispatchEvent(yl)}function Wb(n){switch(this._trackPointer(n),this.state){case Qt.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(n),this.update();break;case Qt.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(n),this.update();break;case Qt.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(n),this.update();break;case Qt.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(n),this.update();break;default:this.state=Qt.NONE}}function Xb(n){this.enabled!==!1&&n.preventDefault()}function jb(n){n.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function qb(n){n.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}class Yb extends Pi{constructor(t){super(t)}load(t,e,i,r){const s=this,o=this.path===""?Gf.extractUrlBase(t):this.path,a=new vl(this.manager);a.setPath(this.path),a.setRequestHeader(this.requestHeader),a.setWithCredentials(this.withCredentials),a.load(t,function(l){try{e(s.parse(l,o))}catch(c){r?r(c):console.error(c),s.manager.itemError(t)}},i,r)}setMaterialOptions(t){return this.materialOptions=t,this}parse(t,e){const i=t.split(`
`);let r={};const s=/\s+/,o={};for(let l=0;l<i.length;l++){let c=i[l];if(c=c.trim(),c.length===0||c.charAt(0)==="#")continue;const h=c.indexOf(" ");let u=h>=0?c.substring(0,h):c;u=u.toLowerCase();let p=h>=0?c.substring(h+1):"";if(p=p.trim(),u==="newmtl")r={name:p},o[p]=r;else if(u==="ka"||u==="kd"||u==="ks"||u==="ke"){const f=p.split(s,3);r[u]=[parseFloat(f[0]),parseFloat(f[1]),parseFloat(f[2])]}else r[u]=p}const a=new Kb(this.resourcePath||e,this.materialOptions);return a.setCrossOrigin(this.crossOrigin),a.setManager(this.manager),a.setMaterials(o),a}}class Kb{constructor(t="",e={}){this.baseUrl=t,this.options=e,this.materialsInfo={},this.materials={},this.materialsArray=[],this.nameLookup={},this.crossOrigin="anonymous",this.side=this.options.side!==void 0?this.options.side:Un,this.wrap=this.options.wrap!==void 0?this.options.wrap:Js}setCrossOrigin(t){return this.crossOrigin=t,this}setManager(t){this.manager=t}setMaterials(t){this.materialsInfo=this.convert(t),this.materials={},this.materialsArray=[],this.nameLookup={}}convert(t){if(!this.options)return t;const e={};for(const i in t){const r=t[i],s={};e[i]=s;for(const o in r){let a=!0,l=r[o];const c=o.toLowerCase();switch(c){case"kd":case"ka":case"ks":this.options&&this.options.normalizeRGB&&(l=[l[0]/255,l[1]/255,l[2]/255]),this.options&&this.options.ignoreZeroRGBs&&l[0]===0&&l[1]===0&&l[2]===0&&(a=!1);break}a&&(s[c]=l)}}return e}preload(){for(const t in this.materialsInfo)this.create(t)}getIndex(t){return this.nameLookup[t]}getAsArray(){let t=0;for(const e in this.materialsInfo)this.materialsArray[t]=this.create(e),this.nameLookup[e]=t,t++;return this.materialsArray}create(t){return this.materials[t]===void 0&&this.createMaterial_(t),this.materials[t]}createMaterial_(t){const e=this,i=this.materialsInfo[t],r={name:t,side:this.side};function s(a,l){return typeof l!="string"||l===""?"":/^https?:\/\//i.test(l)?l:a+l}function o(a,l){if(r[a])return;const c=e.getTextureParams(l,r),h=e.loadTexture(s(e.baseUrl,c.url));h.repeat.copy(c.scale),h.offset.copy(c.offset),h.wrapS=e.wrap,h.wrapT=e.wrap,(a==="map"||a==="emissiveMap")&&(h.colorSpace=Se),r[a]=h}for(const a in i){const l=i[a];let c;if(l!=="")switch(a.toLowerCase()){case"kd":r.color=kt.toWorkingColorSpace(new It().fromArray(l),Se);break;case"ks":r.specular=kt.toWorkingColorSpace(new It().fromArray(l),Se);break;case"ke":r.emissive=kt.toWorkingColorSpace(new It().fromArray(l),Se);break;case"map_kd":o("map",l);break;case"map_ks":o("specularMap",l);break;case"map_ke":o("emissiveMap",l);break;case"norm":o("normalMap",l);break;case"map_bump":case"bump":o("bumpMap",l);break;case"map_d":o("alphaMap",l),r.transparent=!0;break;case"ns":r.shininess=parseFloat(l);break;case"d":c=parseFloat(l),c<1&&(r.opacity=c,r.transparent=!0);break;case"tr":c=parseFloat(l),this.options&&this.options.invertTrProperty&&(c=1-c),c>0&&(r.opacity=1-c,r.transparent=!0);break}}return this.materials[t]=new Au(r),this.materials[t]}getTextureParams(t,e){const i={scale:new Tt(1,1),offset:new Tt(0,0)},r=t.split(/\s+/);let s;return s=r.indexOf("-bm"),s>=0&&(e.bumpScale=parseFloat(r[s+1]),r.splice(s,2)),s=r.indexOf("-s"),s>=0&&(i.scale.set(parseFloat(r[s+1]),parseFloat(r[s+2])),r.splice(s,4)),s=r.indexOf("-o"),s>=0&&(i.offset.set(parseFloat(r[s+1]),parseFloat(r[s+2])),r.splice(s,4)),i.url=r.join(" ").trim(),i}loadTexture(t,e,i,r,s){const o=this.manager!==void 0?this.manager:Pu;let a=o.getHandler(t);a===null&&(a=new Of(o)),a.setCrossOrigin&&a.setCrossOrigin(this.crossOrigin);const l=a.load(t,i,r,s);return e!==void 0&&(l.mapping=e),l}}const $b=/^[og]\s*(.+)?/,Zb=/^mtllib /,Jb=/^usemtl /,Qb=/^usemap /,Th=/\s+/,Ch=new P,ta=new P,Ah=new P,Ph=new P,Je=new P,Bs=new It;function t0(){const n={objects:[],object:{},vertices:[],normals:[],colors:[],uvs:[],materials:{},materialLibraries:[],startObject:function(t,e){if(this.object&&this.object.fromDeclaration===!1){this.object.name=t,this.object.fromDeclaration=e!==!1;return}const i=this.object&&typeof this.object.currentMaterial=="function"?this.object.currentMaterial():void 0;if(this.object&&typeof this.object._finalize=="function"&&this.object._finalize(!0),this.object={name:t||"",fromDeclaration:e!==!1,geometry:{vertices:[],normals:[],colors:[],uvs:[],hasUVIndices:!1},materials:[],smooth:!0,startMaterial:function(r,s){const o=this._finalize(!1);o&&(o.inherited||o.groupCount<=0)&&this.materials.splice(o.index,1);const a={index:this.materials.length,name:r||"",mtllib:Array.isArray(s)&&s.length>0?s[s.length-1]:"",smooth:o!==void 0?o.smooth:this.smooth,groupStart:o!==void 0?o.groupEnd:0,groupEnd:-1,groupCount:-1,inherited:!1,clone:function(l){const c={index:typeof l=="number"?l:this.index,name:this.name,mtllib:this.mtllib,smooth:this.smooth,groupStart:0,groupEnd:-1,groupCount:-1,inherited:!1};return c.clone=this.clone.bind(c),c}};return this.materials.push(a),a},currentMaterial:function(){if(this.materials.length>0)return this.materials[this.materials.length-1]},_finalize:function(r){const s=this.currentMaterial();if(s&&s.groupEnd===-1&&(s.groupEnd=this.geometry.vertices.length/3,s.groupCount=s.groupEnd-s.groupStart,s.inherited=!1),r&&this.materials.length>1)for(let o=this.materials.length-1;o>=0;o--)this.materials[o].groupCount<=0&&this.materials.splice(o,1);return r&&this.materials.length===0&&this.materials.push({name:"",smooth:this.smooth}),s}},i&&i.name&&typeof i.clone=="function"){const r=i.clone(0);r.inherited=!0,this.object.materials.push(r)}this.objects.push(this.object)},finalize:function(){this.object&&typeof this.object._finalize=="function"&&this.object._finalize(!0)},parseVertexIndex:function(t,e){const i=parseInt(t,10);return(i>=0?i-1:i+e/3)*3},parseNormalIndex:function(t,e){const i=parseInt(t,10);return(i>=0?i-1:i+e/3)*3},parseUVIndex:function(t,e){const i=parseInt(t,10);return(i>=0?i-1:i+e/2)*2},addVertex:function(t,e,i){const r=this.vertices,s=this.object.geometry.vertices;s.push(r[t+0],r[t+1],r[t+2]),s.push(r[e+0],r[e+1],r[e+2]),s.push(r[i+0],r[i+1],r[i+2])},addVertexPoint:function(t){const e=this.vertices;this.object.geometry.vertices.push(e[t+0],e[t+1],e[t+2])},addVertexLine:function(t){const e=this.vertices;this.object.geometry.vertices.push(e[t+0],e[t+1],e[t+2])},addNormal:function(t,e,i){const r=this.normals,s=this.object.geometry.normals;s.push(r[t+0],r[t+1],r[t+2]),s.push(r[e+0],r[e+1],r[e+2]),s.push(r[i+0],r[i+1],r[i+2])},addFaceNormal:function(t,e,i){const r=this.vertices,s=this.object.geometry.normals;Ch.fromArray(r,t),ta.fromArray(r,e),Ah.fromArray(r,i),Je.subVectors(Ah,ta),Ph.subVectors(Ch,ta),Je.cross(Ph),Je.normalize(),s.push(Je.x,Je.y,Je.z),s.push(Je.x,Je.y,Je.z),s.push(Je.x,Je.y,Je.z)},addColor:function(t,e,i){const r=this.colors,s=this.object.geometry.colors;r[t]!==void 0&&s.push(r[t+0],r[t+1],r[t+2]),r[e]!==void 0&&s.push(r[e+0],r[e+1],r[e+2]),r[i]!==void 0&&s.push(r[i+0],r[i+1],r[i+2])},addUV:function(t,e,i){const r=this.uvs,s=this.object.geometry.uvs;s.push(r[t+0],r[t+1]),s.push(r[e+0],r[e+1]),s.push(r[i+0],r[i+1])},addDefaultUV:function(){const t=this.object.geometry.uvs;t.push(0,0),t.push(0,0),t.push(0,0)},addUVLine:function(t){const e=this.uvs;this.object.geometry.uvs.push(e[t+0],e[t+1])},addFace:function(t,e,i,r,s,o,a,l,c){const h=this.vertices.length;let u=this.parseVertexIndex(t,h),p=this.parseVertexIndex(e,h),f=this.parseVertexIndex(i,h);if(this.addVertex(u,p,f),this.addColor(u,p,f),a!==void 0&&a!==""){const _=this.normals.length;u=this.parseNormalIndex(a,_),p=this.parseNormalIndex(l,_),f=this.parseNormalIndex(c,_),this.addNormal(u,p,f)}else this.addFaceNormal(u,p,f);if(r!==void 0&&r!==""){const _=this.uvs.length;u=this.parseUVIndex(r,_),p=this.parseUVIndex(s,_),f=this.parseUVIndex(o,_),this.addUV(u,p,f),this.object.geometry.hasUVIndices=!0}else this.addDefaultUV()},addPointGeometry:function(t){this.object.geometry.type="Points";const e=this.vertices.length;for(let i=0,r=t.length;i<r;i++){const s=this.parseVertexIndex(t[i],e);this.addVertexPoint(s),this.addColor(s)}},addLineGeometry:function(t,e){this.object.geometry.type="Line";const i=this.vertices.length,r=this.uvs.length;for(let s=0,o=t.length;s<o;s++)this.addVertexLine(this.parseVertexIndex(t[s],i));for(let s=0,o=e.length;s<o;s++)this.addUVLine(this.parseUVIndex(e[s],r))}};return n.startObject("",!1),n}class e0 extends Pi{constructor(t){super(t),this.materials=null}load(t,e,i,r){const s=this,o=new vl(this.manager);o.setPath(this.path),o.setRequestHeader(this.requestHeader),o.setWithCredentials(this.withCredentials),o.load(t,function(a){try{e(s.parse(a))}catch(l){r?r(l):console.error(l),s.manager.itemError(t)}},i,r)}setMaterials(t){return this.materials=t,this}parse(t){const e=new t0;t.indexOf(`\r
`)!==-1&&(t=t.replace(/\r\n/g,`
`)),t.indexOf(`\\
`)!==-1&&(t=t.replace(/\\\n/g,""));const i=t.split(`
`);let r=[];for(let a=0,l=i.length;a<l;a++){const c=i[a].trimStart();if(c.length===0)continue;const h=c.charAt(0);if(h!=="#")if(h==="v"){const u=c.split(Th);switch(u[0]){case"v":e.vertices.push(parseFloat(u[1]),parseFloat(u[2]),parseFloat(u[3])),u.length>=7?(Bs.setRGB(parseFloat(u[4]),parseFloat(u[5]),parseFloat(u[6]),Se),e.colors.push(Bs.r,Bs.g,Bs.b)):e.colors.push(void 0,void 0,void 0);break;case"vn":e.normals.push(parseFloat(u[1]),parseFloat(u[2]),parseFloat(u[3]));break;case"vt":e.uvs.push(parseFloat(u[1]),parseFloat(u[2]));break}}else if(h==="f"){const p=c.slice(1).trim().split(Th),f=[];for(let v=0,m=p.length;v<m;v++){const d=p[v];if(d.length>0){const S=d.split("/");f.push(S)}}const _=f[0];for(let v=1,m=f.length-1;v<m;v++){const d=f[v],S=f[v+1];e.addFace(_[0],d[0],S[0],_[1],d[1],S[1],_[2],d[2],S[2])}}else if(h==="l"){const u=c.substring(1).trim().split(" ");let p=[];const f=[];if(c.indexOf("/")===-1)p=u;else for(let _=0,v=u.length;_<v;_++){const m=u[_].split("/");m[0]!==""&&p.push(m[0]),m[1]!==""&&f.push(m[1])}e.addLineGeometry(p,f)}else if(h==="p"){const p=c.slice(1).trim().split(" ");e.addPointGeometry(p)}else if((r=$b.exec(c))!==null){const u=(" "+r[0].slice(1).trim()).slice(1);e.startObject(u)}else if(Jb.test(c))e.object.startMaterial(c.substring(7).trim(),e.materialLibraries);else if(Zb.test(c))e.materialLibraries.push(c.substring(7).trim());else if(Qb.test(c))console.warn('THREE.OBJLoader: Rendering identifier "usemap" not supported. Textures must be defined in MTL files.');else if(h==="s"){if(r=c.split(" "),r.length>1){const p=r[1].trim().toLowerCase();e.object.smooth=p!=="0"&&p!=="off"}else e.object.smooth=!0;const u=e.object.currentMaterial();u&&(u.smooth=e.object.smooth)}else{if(c==="\0")continue;console.warn('THREE.OBJLoader: Unexpected line: "'+c+'"')}}e.finalize();const s=new Dr;if(s.materialLibraries=[].concat(e.materialLibraries),!(e.objects.length===1&&e.objects[0].geometry.vertices.length===0)===!0)for(let a=0,l=e.objects.length;a<l;a++){const c=e.objects[a],h=c.geometry,u=c.materials,p=h.type==="Line",f=h.type==="Points";let _=!1;if(h.vertices.length===0)continue;const v=new We;v.setAttribute("position",new we(h.vertices,3)),h.normals.length>0&&v.setAttribute("normal",new we(h.normals,3)),h.colors.length>0&&(_=!0,v.setAttribute("color",new we(h.colors,3))),h.hasUVIndices===!0&&v.setAttribute("uv",new we(h.uvs,2));const m=[];for(let S=0,M=u.length;S<M;S++){const E=u[S],U=E.name+"_"+E.smooth+"_"+_;let T=e.materials[U];if(this.materials!==null){if(T=this.materials.create(E.name),p&&T&&!(T instanceof Fr)){const C=new Fr;Fn.prototype.copy.call(C,T),C.color.copy(T.color),T=C}else if(f&&T&&!(T instanceof Ji)){const C=new Ji({size:10,sizeAttenuation:!1});Fn.prototype.copy.call(C,T),C.color.copy(T.color),C.map=T.map,T=C}}T===void 0&&(p?T=new Fr:f?T=new Ji({size:1,sizeAttenuation:!1}):T=new Au,T.name=E.name,T.flatShading=!E.smooth,T.vertexColors=_,e.materials[U]=T),m.push(T)}let d;if(m.length>1){for(let S=0,M=u.length;S<M;S++){const E=u[S];v.addGroup(E.groupStart,E.groupCount,S)}p?d=new Hc(v,m):f?d=new js(v,m):d=new tn(v,m)}else p?d=new Hc(v,m[0]):f?d=new js(v,m[0]):d=new tn(v,m[0]);d.name=c.name,s.add(d)}else if(e.vertices.length>0){const a=new Ji({size:1,sizeAttenuation:!1}),l=new We;l.setAttribute("position",new we(e.vertices,3)),e.colors.length>0&&e.colors[0]!==void 0&&(l.setAttribute("color",new we(e.colors,3)),a.vertexColors=!0);const c=new js(l,a);s.add(c)}return s}}/*! Tweakpane 4.0.5 (c) 2016 cocopon, licensed under the MIT license. */function ie(n){return n==null}function wl(n){return n!==null&&typeof n=="object"}function Za(n){return n!==null&&typeof n=="object"}function n0(n,t){if(n.length!==t.length)return!1;for(let e=0;e<n.length;e++)if(n[e]!==t[e])return!1;return!0}function Ei(n,t){return Array.from(new Set([...Object.keys(n),...Object.keys(t)])).reduce((i,r)=>{const s=n[r],o=t[r];return Za(s)&&Za(o)?Object.assign(Object.assign({},i),{[r]:Ei(s,o)}):Object.assign(Object.assign({},i),{[r]:r in t?o:s})},{})}function El(n){return wl(n)?"target"in n:!1}const i0={alreadydisposed:()=>"View has been already disposed",invalidparams:n=>`Invalid parameters for '${n.name}'`,nomatchingcontroller:n=>`No matching controller for '${n.key}'`,nomatchingview:n=>`No matching view for '${JSON.stringify(n.params)}'`,notbindable:()=>"Value is not bindable",notcompatible:n=>`Not compatible with  plugin '${n.id}'`,propertynotfound:n=>`Property '${n.name}' not found`,shouldneverhappen:()=>"This error should never happen"};class de{static alreadyDisposed(){return new de({type:"alreadydisposed"})}static notBindable(){return new de({type:"notbindable"})}static notCompatible(t,e){return new de({type:"notcompatible",context:{id:`${t}.${e}`}})}static propertyNotFound(t){return new de({type:"propertynotfound",context:{name:t}})}static shouldNeverHappen(){return new de({type:"shouldneverhappen"})}constructor(t){var e;this.message=(e=i0[t.type](t.context))!==null&&e!==void 0?e:"Unexpected error",this.name=this.constructor.name,this.stack=new Error(this.message).stack,this.type=t.type}toString(){return this.message}}class ro{constructor(t,e){this.obj_=t,this.key=e}static isBindable(t){return!(t===null||typeof t!="object"&&typeof t!="function")}read(){return this.obj_[this.key]}write(t){this.obj_[this.key]=t}writeProperty(t,e){const i=this.read();if(!ro.isBindable(i))throw de.notBindable();if(!(t in i))throw de.propertyNotFound(t);i[t]=e}}class _e{constructor(){this.observers_={}}on(t,e,i){var r;let s=this.observers_[t];return s||(s=this.observers_[t]=[]),s.push({handler:e,key:(r=i==null?void 0:i.key)!==null&&r!==void 0?r:e}),this}off(t,e){const i=this.observers_[t];return i&&(this.observers_[t]=i.filter(r=>r.key!==e)),this}emit(t,e){const i=this.observers_[t];i&&i.forEach(r=>{r.handler(e)})}}class r0{constructor(t,e){var i;this.constraint_=e==null?void 0:e.constraint,this.equals_=(i=e==null?void 0:e.equals)!==null&&i!==void 0?i:(r,s)=>r===s,this.emitter=new _e,this.rawValue_=t}get constraint(){return this.constraint_}get rawValue(){return this.rawValue_}set rawValue(t){this.setRawValue(t,{forceEmit:!1,last:!0})}setRawValue(t,e){const i=e??{forceEmit:!1,last:!0},r=this.constraint_?this.constraint_.constrain(t):t,s=this.rawValue_;this.equals_(s,r)&&!i.forceEmit||(this.emitter.emit("beforechange",{sender:this}),this.rawValue_=r,this.emitter.emit("change",{options:i,previousRawValue:s,rawValue:r,sender:this}))}}class s0{constructor(t){this.emitter=new _e,this.value_=t}get rawValue(){return this.value_}set rawValue(t){this.setRawValue(t,{forceEmit:!1,last:!0})}setRawValue(t,e){const i=e??{forceEmit:!1,last:!0},r=this.value_;r===t&&!i.forceEmit||(this.emitter.emit("beforechange",{sender:this}),this.value_=t,this.emitter.emit("change",{options:i,previousRawValue:r,rawValue:this.value_,sender:this}))}}class o0{constructor(t){this.emitter=new _e,this.onValueBeforeChange_=this.onValueBeforeChange_.bind(this),this.onValueChange_=this.onValueChange_.bind(this),this.value_=t,this.value_.emitter.on("beforechange",this.onValueBeforeChange_),this.value_.emitter.on("change",this.onValueChange_)}get rawValue(){return this.value_.rawValue}onValueBeforeChange_(t){this.emitter.emit("beforechange",Object.assign(Object.assign({},t),{sender:this}))}onValueChange_(t){this.emitter.emit("change",Object.assign(Object.assign({},t),{sender:this}))}}function ae(n,t){const e=t==null?void 0:t.constraint,i=t==null?void 0:t.equals;return!e&&!i?new s0(n):new r0(n,t)}function a0(n){return[new o0(n),(t,e)=>{n.setRawValue(t,e)}]}class Ut{constructor(t){this.emitter=new _e,this.valMap_=t;for(const e in this.valMap_)this.valMap_[e].emitter.on("change",()=>{this.emitter.emit("change",{key:e,sender:this})})}static createCore(t){return Object.keys(t).reduce((i,r)=>Object.assign(i,{[r]:ae(t[r])}),{})}static fromObject(t){const e=this.createCore(t);return new Ut(e)}get(t){return this.valMap_[t].rawValue}set(t,e){this.valMap_[t].rawValue=e}value(t){return this.valMap_[t]}}class Qr{constructor(t){this.values=Ut.fromObject({max:t.max,min:t.min})}constrain(t){const e=this.values.get("max"),i=this.values.get("min");return Math.min(Math.max(t,i),e)}}class l0{constructor(t){this.values=Ut.fromObject({max:t.max,min:t.min})}constrain(t){const e=this.values.get("max"),i=this.values.get("min");let r=t;return ie(i)||(r=Math.max(r,i)),ie(e)||(r=Math.min(r,e)),r}}class c0{constructor(t,e=0){this.step=t,this.origin=e}constrain(t){const e=this.origin%this.step,i=Math.round((t-e)/this.step);return e+i*this.step}}class h0{constructor(t){this.text=t}evaluate(){return Number(this.text)}toString(){return this.text}}const u0={"**":(n,t)=>Math.pow(n,t),"*":(n,t)=>n*t,"/":(n,t)=>n/t,"%":(n,t)=>n%t,"+":(n,t)=>n+t,"-":(n,t)=>n-t,"<<":(n,t)=>n<<t,">>":(n,t)=>n>>t,">>>":(n,t)=>n>>>t,"&":(n,t)=>n&t,"^":(n,t)=>n^t,"|":(n,t)=>n|t};class d0{constructor(t,e,i){this.left=e,this.operator=t,this.right=i}evaluate(){const t=u0[this.operator];if(!t)throw new Error(`unexpected binary operator: '${this.operator}`);return t(this.left.evaluate(),this.right.evaluate())}toString(){return["b(",this.left.toString(),this.operator,this.right.toString(),")"].join(" ")}}const p0={"+":n=>n,"-":n=>-n,"~":n=>~n};class f0{constructor(t,e){this.operator=t,this.expression=e}evaluate(){const t=p0[this.operator];if(!t)throw new Error(`unexpected unary operator: '${this.operator}`);return t(this.expression.evaluate())}toString(){return["u(",this.operator,this.expression.toString(),")"].join(" ")}}function Ml(n){return(t,e)=>{for(let i=0;i<n.length;i++){const r=n[i](t,e);if(r!=="")return r}return""}}function zr(n,t){var e;const i=n.substr(t).match(/^\s+/);return(e=i&&i[0])!==null&&e!==void 0?e:""}function m0(n,t){const e=n.substr(t,1);return e.match(/^[1-9]$/)?e:""}function Hr(n,t){var e;const i=n.substr(t).match(/^[0-9]+/);return(e=i&&i[0])!==null&&e!==void 0?e:""}function _0(n,t){const e=Hr(n,t);if(e!=="")return e;const i=n.substr(t,1);if(t+=1,i!=="-"&&i!=="+")return"";const r=Hr(n,t);return r===""?"":i+r}function Sl(n,t){const e=n.substr(t,1);if(t+=1,e.toLowerCase()!=="e")return"";const i=_0(n,t);return i===""?"":e+i}function ku(n,t){const e=n.substr(t,1);if(e==="0")return e;const i=m0(n,t);return t+=i.length,i===""?"":i+Hr(n,t)}function g0(n,t){const e=ku(n,t);if(t+=e.length,e==="")return"";const i=n.substr(t,1);if(t+=i.length,i!==".")return"";const r=Hr(n,t);return t+=r.length,e+i+r+Sl(n,t)}function v0(n,t){const e=n.substr(t,1);if(t+=e.length,e!==".")return"";const i=Hr(n,t);return t+=i.length,i===""?"":e+i+Sl(n,t)}function b0(n,t){const e=ku(n,t);return t+=e.length,e===""?"":e+Sl(n,t)}const x0=Ml([g0,v0,b0]);function y0(n,t){var e;const i=n.substr(t).match(/^[01]+/);return(e=i&&i[0])!==null&&e!==void 0?e:""}function w0(n,t){const e=n.substr(t,2);if(t+=e.length,e.toLowerCase()!=="0b")return"";const i=y0(n,t);return i===""?"":e+i}function E0(n,t){var e;const i=n.substr(t).match(/^[0-7]+/);return(e=i&&i[0])!==null&&e!==void 0?e:""}function M0(n,t){const e=n.substr(t,2);if(t+=e.length,e.toLowerCase()!=="0o")return"";const i=E0(n,t);return i===""?"":e+i}function S0(n,t){var e;const i=n.substr(t).match(/^[0-9a-f]+/i);return(e=i&&i[0])!==null&&e!==void 0?e:""}function T0(n,t){const e=n.substr(t,2);if(t+=e.length,e.toLowerCase()!=="0x")return"";const i=S0(n,t);return i===""?"":e+i}const C0=Ml([w0,M0,T0]),A0=Ml([C0,x0]);function P0(n,t){const e=A0(n,t);return t+=e.length,e===""?null:{evaluable:new h0(e),cursor:t}}function R0(n,t){const e=n.substr(t,1);if(t+=e.length,e!=="(")return null;const i=Vu(n,t);if(!i)return null;t=i.cursor,t+=zr(n,t).length;const r=n.substr(t,1);return t+=r.length,r!==")"?null:{evaluable:i.evaluable,cursor:t}}function L0(n,t){var e;return(e=P0(n,t))!==null&&e!==void 0?e:R0(n,t)}function Bu(n,t){const e=L0(n,t);if(e)return e;const i=n.substr(t,1);if(t+=i.length,i!=="+"&&i!=="-"&&i!=="~")return null;const r=Bu(n,t);return r?(t=r.cursor,{cursor:t,evaluable:new f0(i,r.evaluable)}):null}function D0(n,t,e){e+=zr(t,e).length;const i=n.filter(r=>t.startsWith(r,e))[0];return i?(e+=i.length,e+=zr(t,e).length,{cursor:e,operator:i}):null}function I0(n,t){return(e,i)=>{const r=n(e,i);if(!r)return null;i=r.cursor;let s=r.evaluable;for(;;){const o=D0(t,e,i);if(!o)break;i=o.cursor;const a=n(e,i);if(!a)return null;i=a.cursor,s=new d0(o.operator,s,a.evaluable)}return s?{cursor:i,evaluable:s}:null}}const U0=[["**"],["*","/","%"],["+","-"],["<<",">>>",">>"],["&"],["^"],["|"]].reduce((n,t)=>I0(n,t),Bu);function Vu(n,t){return t+=zr(n,t).length,U0(n,t)}function N0(n){const t=Vu(n,0);return!t||t.cursor+zr(n,t.cursor).length!==n.length?null:t.evaluable}function On(n){var t;const e=N0(n);return(t=e==null?void 0:e.evaluate())!==null&&t!==void 0?t:null}function zu(n){if(typeof n=="number")return n;if(typeof n=="string"){const t=On(n);if(!ie(t))return t}return 0}function F0(n){return String(n)}function Be(n){return t=>t.toFixed(Math.max(Math.min(n,20),0))}function $t(n,t,e,i,r){const s=(n-t)/(e-t);return i+s*(r-i)}function Rh(n){return String(n.toFixed(10)).split(".")[1].replace(/0+$/,"").length}function ve(n,t,e){return Math.min(Math.max(n,t),e)}function Hu(n,t){return(n%t+t)%t}function O0(n,t){return ie(n.step)?Math.max(Rh(t),2):Rh(n.step)}function Gu(n){var t;return(t=n.step)!==null&&t!==void 0?t:1}function Wu(n,t){var e;const i=Math.abs((e=n.step)!==null&&e!==void 0?e:t);return i===0?.1:Math.pow(10,Math.floor(Math.log10(i))-1)}function Xu(n,t){return ie(n.step)?null:new c0(n.step,t)}function ju(n){return!ie(n.max)&&!ie(n.min)?new Qr({max:n.max,min:n.min}):!ie(n.max)||!ie(n.min)?new l0({max:n.max,min:n.min}):null}function qu(n,t){var e,i,r;return{formatter:(e=n.format)!==null&&e!==void 0?e:Be(O0(n,t)),keyScale:(i=n.keyScale)!==null&&i!==void 0?i:Gu(n),pointerScale:(r=n.pointerScale)!==null&&r!==void 0?r:Wu(n,t)}}function Yu(n){return{format:n.optional.function,keyScale:n.optional.number,max:n.optional.number,min:n.optional.number,pointerScale:n.optional.number,step:n.optional.number}}function Tl(n){return{constraint:n.constraint,textProps:Ut.fromObject(qu(n.params,n.initialValue))}}class Ri{constructor(t){this.controller=t}get element(){return this.controller.view.element}get disabled(){return this.controller.viewProps.get("disabled")}set disabled(t){this.controller.viewProps.set("disabled",t)}get hidden(){return this.controller.viewProps.get("hidden")}set hidden(t){this.controller.viewProps.set("hidden",t)}dispose(){this.controller.viewProps.set("disposed",!0)}importState(t){return this.controller.importState(t)}exportState(){return this.controller.exportState()}}class mo{constructor(t){this.target=t}}class ts extends mo{constructor(t,e,i){super(t),this.value=e,this.last=i??!0}}class k0 extends mo{constructor(t,e){super(t),this.expanded=e}}class B0 extends mo{constructor(t,e){super(t),this.index=e}}class V0 extends mo{constructor(t,e){super(t),this.native=e}}class Gr extends Ri{constructor(t){super(t),this.onValueChange_=this.onValueChange_.bind(this),this.emitter_=new _e,this.controller.value.emitter.on("change",this.onValueChange_)}get label(){return this.controller.labelController.props.get("label")}set label(t){this.controller.labelController.props.set("label",t)}get key(){return this.controller.value.binding.target.key}get tag(){return this.controller.tag}set tag(t){this.controller.tag=t}on(t,e){const i=e.bind(this);return this.emitter_.on(t,r=>{i(r)},{key:e}),this}off(t,e){return this.emitter_.off(t,e),this}refresh(){this.controller.value.fetch()}onValueChange_(t){const e=this.controller.value;this.emitter_.emit("change",new ts(this,e.binding.target.read(),t.options.last))}}class z0{constructor(t,e){this.onValueBeforeChange_=this.onValueBeforeChange_.bind(this),this.onValueChange_=this.onValueChange_.bind(this),this.binding=e,this.value_=t,this.value_.emitter.on("beforechange",this.onValueBeforeChange_),this.value_.emitter.on("change",this.onValueChange_),this.emitter=new _e}get rawValue(){return this.value_.rawValue}set rawValue(t){this.value_.rawValue=t}setRawValue(t,e){this.value_.setRawValue(t,e)}fetch(){this.value_.rawValue=this.binding.read()}push(){this.binding.write(this.value_.rawValue)}onValueBeforeChange_(t){this.emitter.emit("beforechange",Object.assign(Object.assign({},t),{sender:this}))}onValueChange_(t){this.push(),this.emitter.emit("change",Object.assign(Object.assign({},t),{sender:this}))}}function H0(n){if(!("binding"in n))return!1;const t=n.binding;return El(t)&&"read"in t&&"write"in t}function G0(n,t){const i=Object.keys(t).reduce((r,s)=>{if(r===void 0)return;const o=t[s],a=o(n[s]);return a.succeeded?Object.assign(Object.assign({},r),{[s]:a.value}):void 0},{});return i}function W0(n,t){return n.reduce((e,i)=>{if(e===void 0)return;const r=t(i);if(!(!r.succeeded||r.value===void 0))return[...e,r.value]},[])}function X0(n){return n===null?!1:typeof n=="object"}function Tn(n){return t=>e=>{if(!t&&e===void 0)return{succeeded:!1,value:void 0};if(t&&e===void 0)return{succeeded:!0,value:void 0};const i=n(e);return i!==void 0?{succeeded:!0,value:i}:{succeeded:!1,value:void 0}}}function Lh(n){return{custom:t=>Tn(t)(n),boolean:Tn(t=>typeof t=="boolean"?t:void 0)(n),number:Tn(t=>typeof t=="number"?t:void 0)(n),string:Tn(t=>typeof t=="string"?t:void 0)(n),function:Tn(t=>typeof t=="function"?t:void 0)(n),constant:t=>Tn(e=>e===t?t:void 0)(n),raw:Tn(t=>t)(n),object:t=>Tn(e=>{if(X0(e))return G0(e,t)})(n),array:t=>Tn(e=>{if(Array.isArray(e))return W0(e,t)})(n)}}const Ja={optional:Lh(!0),required:Lh(!1)};function ce(n,t){const e=t(Ja),i=Ja.required.object(e)(n);return i.succeeded?i.value:void 0}function je(n,t,e,i){if(t&&!t(n))return!1;const r=ce(n,e);return r?i(r):!1}function qe(n,t){var e;return Ei((e=n==null?void 0:n())!==null&&e!==void 0?e:{},t)}function xi(n){return"value"in n}function Ku(n){if(!wl(n)||!("binding"in n))return!1;const t=n.binding;return El(t)}const fn="http://www.w3.org/2000/svg";function so(n){n.offsetHeight}function j0(n,t){const e=n.style.transition;n.style.transition="none",t(),n.style.transition=e}function Cl(n){return n.ontouchstart!==void 0}function q0(){return globalThis}function Y0(){return q0().document}function K0(n){const t=n.ownerDocument.defaultView;return t&&"document"in t?n.getContext("2d",{willReadFrequently:!0}):null}const $0={check:'<path d="M2 8l4 4l8 -8"/>',dropdown:'<path d="M5 7h6l-3 3 z"/>',p2dpad:'<path d="M8 4v8"/><path d="M4 8h8"/><circle cx="12" cy="12" r="1.2"/>'};function _o(n,t){const e=n.createElementNS(fn,"svg");return e.innerHTML=$0[t],e}function $u(n,t,e){n.insertBefore(t,n.children[e])}function Al(n){n.parentElement&&n.parentElement.removeChild(n)}function Zu(n){for(;n.children.length>0;)n.removeChild(n.children[0])}function Z0(n){for(;n.childNodes.length>0;)n.removeChild(n.childNodes[0])}function Ju(n){return n.relatedTarget?n.relatedTarget:"explicitOriginalTarget"in n?n.explicitOriginalTarget:null}function In(n,t){n.emitter.on("change",e=>{t(e.rawValue)}),t(n.rawValue)}function gn(n,t,e){In(n.value(t),e)}const J0="tp";function Xt(n){return(e,i)=>[J0,"-",n,"v",e?`_${e}`:"",i?`-${i}`:""].join("")}const Ar=Xt("lbl");function Q0(n,t){const e=n.createDocumentFragment();return t.split(`
`).map(r=>n.createTextNode(r)).forEach((r,s)=>{s>0&&e.appendChild(n.createElement("br")),e.appendChild(r)}),e}class Qu{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(Ar()),e.viewProps.bindClassModifiers(this.element);const i=t.createElement("div");i.classList.add(Ar("l")),gn(e.props,"label",s=>{ie(s)?this.element.classList.add(Ar(void 0,"nol")):(this.element.classList.remove(Ar(void 0,"nol")),Z0(i),i.appendChild(Q0(t,s)))}),this.element.appendChild(i),this.labelElement=i;const r=t.createElement("div");r.classList.add(Ar("v")),this.element.appendChild(r),this.valueElement=r}}class td{constructor(t,e){this.props=e.props,this.valueController=e.valueController,this.viewProps=e.valueController.viewProps,this.view=new Qu(t,{props:e.props,viewProps:this.viewProps}),this.view.valueElement.appendChild(this.valueController.view.element)}importProps(t){return je(t,null,e=>({label:e.optional.string}),e=>(this.props.set("label",e.label),!0))}exportProps(){return qe(null,{label:this.props.get("label")})}}function tx(){return["veryfirst","first","last","verylast"]}const Dh=Xt(""),Ih={veryfirst:"vfst",first:"fst",last:"lst",verylast:"vlst"};class go{constructor(t){this.parent_=null,this.blade=t.blade,this.view=t.view,this.viewProps=t.viewProps;const e=this.view.element;this.blade.value("positions").emitter.on("change",()=>{tx().forEach(i=>{e.classList.remove(Dh(void 0,Ih[i]))}),this.blade.get("positions").forEach(i=>{e.classList.add(Dh(void 0,Ih[i]))})}),this.viewProps.handleDispose(()=>{Al(e)})}get parent(){return this.parent_}set parent(t){this.parent_=t,this.viewProps.set("parent",this.parent_?this.parent_.viewProps:null)}importState(t){return je(t,null,e=>({disabled:e.required.boolean,hidden:e.required.boolean}),e=>(this.viewProps.importState(e),!0))}exportState(){return qe(null,Object.assign({},this.viewProps.exportState()))}}class Mi extends go{constructor(t,e){if(e.value!==e.valueController.value)throw de.shouldNeverHappen();const i=e.valueController.viewProps,r=new td(t,{blade:e.blade,props:e.props,valueController:e.valueController});super(Object.assign(Object.assign({},e),{view:new Qu(t,{props:e.props,viewProps:i}),viewProps:i})),this.labelController=r,this.value=e.value,this.valueController=e.valueController,this.view.valueElement.appendChild(this.valueController.view.element)}importState(t){return je(t,e=>{var i,r,s;return super.importState(e)&&this.labelController.importProps(e)&&((s=(r=(i=this.valueController).importProps)===null||r===void 0?void 0:r.call(i,t))!==null&&s!==void 0?s:!0)},e=>({value:e.optional.raw}),e=>(e.value&&(this.value.rawValue=e.value),!0))}exportState(){var t,e,i;return qe(()=>super.exportState(),Object.assign(Object.assign({value:this.value.rawValue},this.labelController.exportProps()),(i=(e=(t=this.valueController).exportProps)===null||e===void 0?void 0:e.call(t))!==null&&i!==void 0?i:{}))}}function Uh(n){const t=Object.assign({},n);return delete t.value,t}class ed extends Mi{constructor(t,e){super(t,e),this.tag=e.tag}importState(t){return je(t,e=>super.importState(Uh(t)),e=>({tag:e.optional.string}),e=>(this.tag=e.tag,!0))}exportState(){return qe(()=>Uh(super.exportState()),{binding:{key:this.value.binding.target.key,value:this.value.binding.target.read()},tag:this.tag})}}function ex(n){return xi(n)&&Ku(n.value)}class nx extends ed{importState(t){return je(t,e=>super.importState(e),e=>({binding:e.required.object({value:e.required.raw})}),e=>(this.value.binding.inject(e.binding.value),this.value.fetch(),!0))}}function ix(n){return xi(n)&&H0(n.value)}function nd(n,t){for(;n.length<t;)n.push(void 0)}function rx(n){const t=[];return nd(t,n),t}function sx(n){const t=n.indexOf(void 0);return t<0?n:n.slice(0,t)}function ox(n,t){const e=[...sx(n),t];return e.length>n.length?e.splice(0,e.length-n.length):nd(e,n.length),e}class ax{constructor(t){this.emitter=new _e,this.onTick_=this.onTick_.bind(this),this.onValueBeforeChange_=this.onValueBeforeChange_.bind(this),this.onValueChange_=this.onValueChange_.bind(this),this.binding=t.binding,this.value_=ae(rx(t.bufferSize)),this.value_.emitter.on("beforechange",this.onValueBeforeChange_),this.value_.emitter.on("change",this.onValueChange_),this.ticker=t.ticker,this.ticker.emitter.on("tick",this.onTick_),this.fetch()}get rawValue(){return this.value_.rawValue}set rawValue(t){this.value_.rawValue=t}setRawValue(t,e){this.value_.setRawValue(t,e)}fetch(){this.value_.rawValue=ox(this.value_.rawValue,this.binding.read())}onTick_(){this.fetch()}onValueBeforeChange_(t){this.emitter.emit("beforechange",Object.assign(Object.assign({},t),{sender:this}))}onValueChange_(t){this.emitter.emit("change",Object.assign(Object.assign({},t),{sender:this}))}}function lx(n){if(!("binding"in n))return!1;const t=n.binding;return El(t)&&"read"in t&&!("write"in t)}class cx extends ed{exportState(){return qe(()=>super.exportState(),{binding:{readonly:!0}})}}function hx(n){return xi(n)&&lx(n.value)}class ux extends Ri{get label(){return this.controller.labelController.props.get("label")}set label(t){this.controller.labelController.props.set("label",t)}get title(){var t;return(t=this.controller.buttonController.props.get("title"))!==null&&t!==void 0?t:""}set title(t){this.controller.buttonController.props.set("title",t)}on(t,e){const i=e.bind(this);return this.controller.buttonController.emitter.on(t,s=>{i(new V0(this,s.nativeEvent))}),this}off(t,e){return this.controller.buttonController.emitter.off(t,e),this}}function dx(n,t,e){e?n.classList.add(t):n.classList.remove(t)}function gr(n,t){return e=>{dx(n,t,e)}}function Pl(n,t){In(n,e=>{t.textContent=e??""})}const ea=Xt("btn");class px{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(ea()),e.viewProps.bindClassModifiers(this.element);const i=t.createElement("button");i.classList.add(ea("b")),e.viewProps.bindDisabled(i),this.element.appendChild(i),this.buttonElement=i;const r=t.createElement("div");r.classList.add(ea("t")),Pl(e.props.value("title"),r),this.buttonElement.appendChild(r)}}class fx{constructor(t,e){this.emitter=new _e,this.onClick_=this.onClick_.bind(this),this.props=e.props,this.viewProps=e.viewProps,this.view=new px(t,{props:this.props,viewProps:this.viewProps}),this.view.buttonElement.addEventListener("click",this.onClick_)}importProps(t){return je(t,null,e=>({title:e.optional.string}),e=>(this.props.set("title",e.title),!0))}exportProps(){return qe(null,{title:this.props.get("title")})}onClick_(t){this.emitter.emit("click",{nativeEvent:t,sender:this})}}class Nh extends go{constructor(t,e){const i=new fx(t,{props:e.buttonProps,viewProps:e.viewProps}),r=new td(t,{blade:e.blade,props:e.labelProps,valueController:i});super({blade:e.blade,view:r.view,viewProps:e.viewProps}),this.buttonController=i,this.labelController=r}importState(t){return je(t,e=>super.importState(e)&&this.buttonController.importProps(e)&&this.labelController.importProps(e),()=>({}),()=>!0)}exportState(){return qe(()=>super.exportState(),Object.assign(Object.assign({},this.buttonController.exportProps()),this.labelController.exportProps()))}}class id{constructor(t){const[e,i]=t.split("-"),r=e.split(".");this.major=parseInt(r[0],10),this.minor=parseInt(r[1],10),this.patch=parseInt(r[2],10),this.prerelease=i??null}toString(){const t=[this.major,this.minor,this.patch].join(".");return this.prerelease!==null?[t,this.prerelease].join("-"):t}}const vr=new id("2.0.5");function Ue(n){return Object.assign({core:vr},n)}const mx=Ue({id:"button",type:"blade",accept(n){const t=ce(n,e=>({title:e.required.string,view:e.required.constant("button"),label:e.optional.string}));return t?{params:t}:null},controller(n){return new Nh(n.document,{blade:n.blade,buttonProps:Ut.fromObject({title:n.params.title}),labelProps:Ut.fromObject({label:n.params.label}),viewProps:n.viewProps})},api(n){return n.controller instanceof Nh?new ux(n.controller):null}});function _x(n,t){return n.addBlade(Object.assign(Object.assign({},t),{view:"button"}))}function gx(n,t){return n.addBlade(Object.assign(Object.assign({},t),{view:"folder"}))}function vx(n,t){return n.addBlade(Object.assign(Object.assign({},t),{view:"tab"}))}function bx(n){return wl(n)?"refresh"in n&&typeof n.refresh=="function":!1}function xx(n,t){if(!ro.isBindable(n))throw de.notBindable();return new ro(n,t)}class yx{constructor(t,e){this.onRackValueChange_=this.onRackValueChange_.bind(this),this.controller_=t,this.emitter_=new _e,this.pool_=e,this.controller_.rack.emitter.on("valuechange",this.onRackValueChange_)}get children(){return this.controller_.rack.children.map(t=>this.pool_.createApi(t))}addBinding(t,e,i){const r=i??{},s=this.controller_.element.ownerDocument,o=this.pool_.createBinding(s,xx(t,e),r),a=this.pool_.createBindingApi(o);return this.add(a,r.index)}addFolder(t){return gx(this,t)}addButton(t){return _x(this,t)}addTab(t){return vx(this,t)}add(t,e){const i=t.controller;return this.controller_.rack.add(i,e),t}remove(t){this.controller_.rack.remove(t.controller)}addBlade(t){const e=this.controller_.element.ownerDocument,i=this.pool_.createBlade(e,t),r=this.pool_.createApi(i);return this.add(r,t.index)}on(t,e){const i=e.bind(this);return this.emitter_.on(t,r=>{i(r)},{key:e}),this}off(t,e){return this.emitter_.off(t,e),this}refresh(){this.children.forEach(t=>{bx(t)&&t.refresh()})}onRackValueChange_(t){const e=t.bladeController,i=this.pool_.createApi(e),r=Ku(e.value)?e.value.binding:null;this.emitter_.emit("change",new ts(i,r?r.target.read():e.value.rawValue,t.options.last))}}class Rl extends Ri{constructor(t,e){super(t),this.rackApi_=new yx(t.rackController,e)}refresh(){this.rackApi_.refresh()}}class Ll extends go{constructor(t){super({blade:t.blade,view:t.view,viewProps:t.rackController.viewProps}),this.rackController=t.rackController}importState(t){return je(t,e=>super.importState(e),e=>({children:e.required.array(e.required.raw)}),e=>this.rackController.rack.children.every((i,r)=>i.importState(e.children[r])))}exportState(){return qe(()=>super.exportState(),{children:this.rackController.rack.children.map(t=>t.exportState())})}}function Qa(n){return"rackController"in n}class wx{constructor(t){this.emitter=new _e,this.items_=[],this.cache_=new Set,this.onSubListAdd_=this.onSubListAdd_.bind(this),this.onSubListRemove_=this.onSubListRemove_.bind(this),this.extract_=t}get items(){return this.items_}allItems(){return Array.from(this.cache_)}find(t){for(const e of this.allItems())if(t(e))return e;return null}includes(t){return this.cache_.has(t)}add(t,e){if(this.includes(t))throw de.shouldNeverHappen();const i=e!==void 0?e:this.items_.length;this.items_.splice(i,0,t),this.cache_.add(t);const r=this.extract_(t);r&&(r.emitter.on("add",this.onSubListAdd_),r.emitter.on("remove",this.onSubListRemove_),r.allItems().forEach(s=>{this.cache_.add(s)})),this.emitter.emit("add",{index:i,item:t,root:this,target:this})}remove(t){const e=this.items_.indexOf(t);if(e<0)return;this.items_.splice(e,1),this.cache_.delete(t);const i=this.extract_(t);i&&(i.allItems().forEach(r=>{this.cache_.delete(r)}),i.emitter.off("add",this.onSubListAdd_),i.emitter.off("remove",this.onSubListRemove_)),this.emitter.emit("remove",{index:e,item:t,root:this,target:this})}onSubListAdd_(t){this.cache_.add(t.item),this.emitter.emit("add",{index:t.index,item:t.item,root:this,target:t.target})}onSubListRemove_(t){this.cache_.delete(t.item),this.emitter.emit("remove",{index:t.index,item:t.item,root:this,target:t.target})}}function Ex(n,t){for(let e=0;e<n.length;e++){const i=n[e];if(xi(i)&&i.value===t)return i}return null}function Mx(n){return Qa(n)?n.rackController.rack.bcSet_:null}class Sx{constructor(t){var e,i;this.emitter=new _e,this.onBladePositionsChange_=this.onBladePositionsChange_.bind(this),this.onSetAdd_=this.onSetAdd_.bind(this),this.onSetRemove_=this.onSetRemove_.bind(this),this.onChildDispose_=this.onChildDispose_.bind(this),this.onChildPositionsChange_=this.onChildPositionsChange_.bind(this),this.onChildValueChange_=this.onChildValueChange_.bind(this),this.onChildViewPropsChange_=this.onChildViewPropsChange_.bind(this),this.onRackLayout_=this.onRackLayout_.bind(this),this.onRackValueChange_=this.onRackValueChange_.bind(this),this.blade_=(e=t.blade)!==null&&e!==void 0?e:null,(i=this.blade_)===null||i===void 0||i.value("positions").emitter.on("change",this.onBladePositionsChange_),this.viewProps=t.viewProps,this.bcSet_=new wx(Mx),this.bcSet_.emitter.on("add",this.onSetAdd_),this.bcSet_.emitter.on("remove",this.onSetRemove_)}get children(){return this.bcSet_.items}add(t,e){var i;(i=t.parent)===null||i===void 0||i.remove(t),t.parent=this,this.bcSet_.add(t,e)}remove(t){t.parent=null,this.bcSet_.remove(t)}find(t){return this.bcSet_.allItems().filter(t)}onSetAdd_(t){this.updatePositions_();const e=t.target===t.root;if(this.emitter.emit("add",{bladeController:t.item,index:t.index,root:e,sender:this}),!e)return;const i=t.item;if(i.viewProps.emitter.on("change",this.onChildViewPropsChange_),i.blade.value("positions").emitter.on("change",this.onChildPositionsChange_),i.viewProps.handleDispose(this.onChildDispose_),xi(i))i.value.emitter.on("change",this.onChildValueChange_);else if(Qa(i)){const r=i.rackController.rack;if(r){const s=r.emitter;s.on("layout",this.onRackLayout_),s.on("valuechange",this.onRackValueChange_)}}}onSetRemove_(t){this.updatePositions_();const e=t.target===t.root;if(this.emitter.emit("remove",{bladeController:t.item,root:e,sender:this}),!e)return;const i=t.item;if(xi(i))i.value.emitter.off("change",this.onChildValueChange_);else if(Qa(i)){const r=i.rackController.rack;if(r){const s=r.emitter;s.off("layout",this.onRackLayout_),s.off("valuechange",this.onRackValueChange_)}}}updatePositions_(){const t=this.bcSet_.items.filter(r=>!r.viewProps.get("hidden")),e=t[0],i=t[t.length-1];this.bcSet_.items.forEach(r=>{const s=[];r===e&&(s.push("first"),(!this.blade_||this.blade_.get("positions").includes("veryfirst"))&&s.push("veryfirst")),r===i&&(s.push("last"),(!this.blade_||this.blade_.get("positions").includes("verylast"))&&s.push("verylast")),r.blade.set("positions",s)})}onChildPositionsChange_(){this.updatePositions_(),this.emitter.emit("layout",{sender:this})}onChildViewPropsChange_(t){this.updatePositions_(),this.emitter.emit("layout",{sender:this})}onChildDispose_(){this.bcSet_.items.filter(e=>e.viewProps.get("disposed")).forEach(e=>{this.bcSet_.remove(e)})}onChildValueChange_(t){const e=Ex(this.find(xi),t.sender);if(!e)throw de.alreadyDisposed();this.emitter.emit("valuechange",{bladeController:e,options:t.options,sender:this})}onRackLayout_(t){this.updatePositions_(),this.emitter.emit("layout",{sender:this})}onRackValueChange_(t){this.emitter.emit("valuechange",{bladeController:t.bladeController,options:t.options,sender:this})}onBladePositionsChange_(){this.updatePositions_()}}class Dl{constructor(t){this.onRackAdd_=this.onRackAdd_.bind(this),this.onRackRemove_=this.onRackRemove_.bind(this),this.element=t.element,this.viewProps=t.viewProps;const e=new Sx({blade:t.root?void 0:t.blade,viewProps:t.viewProps});e.emitter.on("add",this.onRackAdd_),e.emitter.on("remove",this.onRackRemove_),this.rack=e,this.viewProps.handleDispose(()=>{for(let i=this.rack.children.length-1;i>=0;i--)this.rack.children[i].viewProps.set("disposed",!0)})}onRackAdd_(t){t.root&&$u(this.element,t.bladeController.view.element,t.index)}onRackRemove_(t){t.root&&Al(t.bladeController.view.element)}}function br(){return new Ut({positions:ae([],{equals:n0})})}class es extends Ut{constructor(t){super(t)}static create(t){const e={completed:!0,expanded:t,expandedHeight:null,shouldFixHeight:!1,temporaryExpanded:null},i=Ut.createCore(e);return new es(i)}get styleExpanded(){var t;return(t=this.get("temporaryExpanded"))!==null&&t!==void 0?t:this.get("expanded")}get styleHeight(){if(!this.styleExpanded)return"0";const t=this.get("expandedHeight");return this.get("shouldFixHeight")&&!ie(t)?`${t}px`:"auto"}bindExpandedClass(t,e){const i=()=>{this.styleExpanded?t.classList.add(e):t.classList.remove(e)};gn(this,"expanded",i),gn(this,"temporaryExpanded",i)}cleanUpTransition(){this.set("shouldFixHeight",!1),this.set("expandedHeight",null),this.set("completed",!0)}}function Tx(n,t){let e=0;return j0(t,()=>{n.set("expandedHeight",null),n.set("temporaryExpanded",!0),so(t),e=t.clientHeight,n.set("temporaryExpanded",null),so(t)}),e}function Fh(n,t){t.style.height=n.styleHeight}function Il(n,t){n.value("expanded").emitter.on("beforechange",()=>{if(n.set("completed",!1),ie(n.get("expandedHeight"))){const e=Tx(n,t);e>0&&n.set("expandedHeight",e)}n.set("shouldFixHeight",!0),so(t)}),n.emitter.on("change",()=>{Fh(n,t)}),Fh(n,t),t.addEventListener("transitionend",e=>{e.propertyName==="height"&&n.cleanUpTransition()})}class rd extends Rl{constructor(t,e){super(t,e),this.emitter_=new _e,this.controller.foldable.value("expanded").emitter.on("change",i=>{this.emitter_.emit("fold",new k0(this,i.sender.rawValue))}),this.rackApi_.on("change",i=>{this.emitter_.emit("change",i)})}get expanded(){return this.controller.foldable.get("expanded")}set expanded(t){this.controller.foldable.set("expanded",t)}get title(){return this.controller.props.get("title")}set title(t){this.controller.props.set("title",t)}get children(){return this.rackApi_.children}addBinding(t,e,i){return this.rackApi_.addBinding(t,e,i)}addFolder(t){return this.rackApi_.addFolder(t)}addButton(t){return this.rackApi_.addButton(t)}addTab(t){return this.rackApi_.addTab(t)}add(t,e){return this.rackApi_.add(t,e)}remove(t){this.rackApi_.remove(t)}addBlade(t){return this.rackApi_.addBlade(t)}on(t,e){const i=e.bind(this);return this.emitter_.on(t,r=>{i(r)},{key:e}),this}off(t,e){return this.emitter_.off(t,e),this}}const sd=Xt("cnt");class Cx{constructor(t,e){var i;this.className_=Xt((i=e.viewName)!==null&&i!==void 0?i:"fld"),this.element=t.createElement("div"),this.element.classList.add(this.className_(),sd()),e.viewProps.bindClassModifiers(this.element),this.foldable_=e.foldable,this.foldable_.bindExpandedClass(this.element,this.className_(void 0,"expanded")),gn(this.foldable_,"completed",gr(this.element,this.className_(void 0,"cpl")));const r=t.createElement("button");r.classList.add(this.className_("b")),gn(e.props,"title",c=>{ie(c)?this.element.classList.add(this.className_(void 0,"not")):this.element.classList.remove(this.className_(void 0,"not"))}),e.viewProps.bindDisabled(r),this.element.appendChild(r),this.buttonElement=r;const s=t.createElement("div");s.classList.add(this.className_("i")),this.element.appendChild(s);const o=t.createElement("div");o.classList.add(this.className_("t")),Pl(e.props.value("title"),o),this.buttonElement.appendChild(o),this.titleElement=o;const a=t.createElement("div");a.classList.add(this.className_("m")),this.buttonElement.appendChild(a);const l=t.createElement("div");l.classList.add(this.className_("c")),this.element.appendChild(l),this.containerElement=l}}class tl extends Ll{constructor(t,e){var i;const r=es.create((i=e.expanded)!==null&&i!==void 0?i:!0),s=new Cx(t,{foldable:r,props:e.props,viewName:e.root?"rot":void 0,viewProps:e.viewProps});super(Object.assign(Object.assign({},e),{rackController:new Dl({blade:e.blade,element:s.containerElement,root:e.root,viewProps:e.viewProps}),view:s})),this.onTitleClick_=this.onTitleClick_.bind(this),this.props=e.props,this.foldable=r,Il(this.foldable,this.view.containerElement),this.rackController.rack.emitter.on("add",()=>{this.foldable.cleanUpTransition()}),this.rackController.rack.emitter.on("remove",()=>{this.foldable.cleanUpTransition()}),this.view.buttonElement.addEventListener("click",this.onTitleClick_)}get document(){return this.view.element.ownerDocument}importState(t){return je(t,e=>super.importState(e),e=>({expanded:e.required.boolean,title:e.optional.string}),e=>(this.foldable.set("expanded",e.expanded),this.props.set("title",e.title),!0))}exportState(){return qe(()=>super.exportState(),{expanded:this.foldable.get("expanded"),title:this.props.get("title")})}onTitleClick_(){this.foldable.set("expanded",!this.foldable.get("expanded"))}}const Ax=Ue({id:"folder",type:"blade",accept(n){const t=ce(n,e=>({title:e.required.string,view:e.required.constant("folder"),expanded:e.optional.boolean}));return t?{params:t}:null},controller(n){return new tl(n.document,{blade:n.blade,expanded:n.params.expanded,props:Ut.fromObject({title:n.params.title}),viewProps:n.viewProps})},api(n){return n.controller instanceof tl?new rd(n.controller,n.pool):null}}),Px=Xt("");function Oh(n,t){return gr(n,Px(void 0,t))}class Bn extends Ut{constructor(t){var e;super(t),this.onDisabledChange_=this.onDisabledChange_.bind(this),this.onParentChange_=this.onParentChange_.bind(this),this.onParentGlobalDisabledChange_=this.onParentGlobalDisabledChange_.bind(this),[this.globalDisabled_,this.setGlobalDisabled_]=a0(ae(this.getGlobalDisabled_())),this.value("disabled").emitter.on("change",this.onDisabledChange_),this.value("parent").emitter.on("change",this.onParentChange_),(e=this.get("parent"))===null||e===void 0||e.globalDisabled.emitter.on("change",this.onParentGlobalDisabledChange_)}static create(t){var e,i,r;const s=t??{};return new Bn(Ut.createCore({disabled:(e=s.disabled)!==null&&e!==void 0?e:!1,disposed:!1,hidden:(i=s.hidden)!==null&&i!==void 0?i:!1,parent:(r=s.parent)!==null&&r!==void 0?r:null}))}get globalDisabled(){return this.globalDisabled_}bindClassModifiers(t){In(this.globalDisabled_,Oh(t,"disabled")),gn(this,"hidden",Oh(t,"hidden"))}bindDisabled(t){In(this.globalDisabled_,e=>{t.disabled=e})}bindTabIndex(t){In(this.globalDisabled_,e=>{t.tabIndex=e?-1:0})}handleDispose(t){this.value("disposed").emitter.on("change",e=>{e&&t()})}importState(t){this.set("disabled",t.disabled),this.set("hidden",t.hidden)}exportState(){return{disabled:this.get("disabled"),hidden:this.get("hidden")}}getGlobalDisabled_(){const t=this.get("parent");return(t?t.globalDisabled.rawValue:!1)||this.get("disabled")}updateGlobalDisabled_(){this.setGlobalDisabled_(this.getGlobalDisabled_())}onDisabledChange_(){this.updateGlobalDisabled_()}onParentGlobalDisabledChange_(){this.updateGlobalDisabled_()}onParentChange_(t){var e;const i=t.previousRawValue;i==null||i.globalDisabled.emitter.off("change",this.onParentGlobalDisabledChange_),(e=this.get("parent"))===null||e===void 0||e.globalDisabled.emitter.on("change",this.onParentGlobalDisabledChange_),this.updateGlobalDisabled_()}}const kh=Xt("tbp");class Rx{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(kh()),e.viewProps.bindClassModifiers(this.element);const i=t.createElement("div");i.classList.add(kh("c")),this.element.appendChild(i),this.containerElement=i}}const Pr=Xt("tbi");class Lx{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(Pr()),e.viewProps.bindClassModifiers(this.element),gn(e.props,"selected",s=>{s?this.element.classList.add(Pr(void 0,"sel")):this.element.classList.remove(Pr(void 0,"sel"))});const i=t.createElement("button");i.classList.add(Pr("b")),e.viewProps.bindDisabled(i),this.element.appendChild(i),this.buttonElement=i;const r=t.createElement("div");r.classList.add(Pr("t")),Pl(e.props.value("title"),r),this.buttonElement.appendChild(r),this.titleElement=r}}class Dx{constructor(t,e){this.emitter=new _e,this.onClick_=this.onClick_.bind(this),this.props=e.props,this.viewProps=e.viewProps,this.view=new Lx(t,{props:e.props,viewProps:e.viewProps}),this.view.buttonElement.addEventListener("click",this.onClick_)}onClick_(){this.emitter.emit("click",{sender:this})}}class el extends Ll{constructor(t,e){const i=new Rx(t,{viewProps:e.viewProps});super(Object.assign(Object.assign({},e),{rackController:new Dl({blade:e.blade,element:i.containerElement,viewProps:e.viewProps}),view:i})),this.onItemClick_=this.onItemClick_.bind(this),this.ic_=new Dx(t,{props:e.itemProps,viewProps:Bn.create()}),this.ic_.emitter.on("click",this.onItemClick_),this.props=e.props,gn(this.props,"selected",r=>{this.itemController.props.set("selected",r),this.viewProps.set("hidden",!r)})}get itemController(){return this.ic_}importState(t){return je(t,e=>super.importState(e),e=>({selected:e.required.boolean,title:e.required.string}),e=>(this.ic_.props.set("selected",e.selected),this.ic_.props.set("title",e.title),!0))}exportState(){return qe(()=>super.exportState(),{selected:this.ic_.props.get("selected"),title:this.ic_.props.get("title")})}onItemClick_(){this.props.set("selected",!0)}}class Ix extends Rl{constructor(t,e){super(t,e),this.emitter_=new _e,this.onSelect_=this.onSelect_.bind(this),this.pool_=e,this.rackApi_.on("change",i=>{this.emitter_.emit("change",i)}),this.controller.tab.selectedIndex.emitter.on("change",this.onSelect_)}get pages(){return this.rackApi_.children}addPage(t){const e=this.controller.view.element.ownerDocument,i=new el(e,{blade:br(),itemProps:Ut.fromObject({selected:!1,title:t.title}),props:Ut.fromObject({selected:!1}),viewProps:Bn.create()}),r=this.pool_.createApi(i);return this.rackApi_.add(r,t.index)}removePage(t){this.rackApi_.remove(this.rackApi_.children[t])}on(t,e){const i=e.bind(this);return this.emitter_.on(t,r=>{i(r)},{key:e}),this}off(t,e){return this.emitter_.off(t,e),this}onSelect_(t){this.emitter_.emit("select",new B0(this,t.rawValue))}}class Ux extends Rl{get title(){var t;return(t=this.controller.itemController.props.get("title"))!==null&&t!==void 0?t:""}set title(t){this.controller.itemController.props.set("title",t)}get selected(){return this.controller.props.get("selected")}set selected(t){this.controller.props.set("selected",t)}get children(){return this.rackApi_.children}addButton(t){return this.rackApi_.addButton(t)}addFolder(t){return this.rackApi_.addFolder(t)}addTab(t){return this.rackApi_.addTab(t)}add(t,e){this.rackApi_.add(t,e)}remove(t){this.rackApi_.remove(t)}addBinding(t,e,i){return this.rackApi_.addBinding(t,e,i)}addBlade(t){return this.rackApi_.addBlade(t)}}const Bh=-1;class Nx{constructor(){this.onItemSelectedChange_=this.onItemSelectedChange_.bind(this),this.empty=ae(!0),this.selectedIndex=ae(Bh),this.items_=[]}add(t,e){const i=e??this.items_.length;this.items_.splice(i,0,t),t.emitter.on("change",this.onItemSelectedChange_),this.keepSelection_()}remove(t){const e=this.items_.indexOf(t);e<0||(this.items_.splice(e,1),t.emitter.off("change",this.onItemSelectedChange_),this.keepSelection_())}keepSelection_(){if(this.items_.length===0){this.selectedIndex.rawValue=Bh,this.empty.rawValue=!0;return}const t=this.items_.findIndex(e=>e.rawValue);t<0?(this.items_.forEach((e,i)=>{e.rawValue=i===0}),this.selectedIndex.rawValue=0):(this.items_.forEach((e,i)=>{e.rawValue=i===t}),this.selectedIndex.rawValue=t),this.empty.rawValue=!1}onItemSelectedChange_(t){if(t.rawValue){const e=this.items_.findIndex(i=>i===t.sender);this.items_.forEach((i,r)=>{i.rawValue=r===e}),this.selectedIndex.rawValue=e}else this.keepSelection_()}}const Rr=Xt("tab");class Fx{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(Rr(),sd()),e.viewProps.bindClassModifiers(this.element),In(e.empty,gr(this.element,Rr(void 0,"nop")));const i=t.createElement("div");i.classList.add(Rr("t")),this.element.appendChild(i),this.itemsElement=i;const r=t.createElement("div");r.classList.add(Rr("i")),this.element.appendChild(r);const s=t.createElement("div");s.classList.add(Rr("c")),this.element.appendChild(s),this.contentsElement=s}}class Vh extends Ll{constructor(t,e){const i=new Nx,r=new Fx(t,{empty:i.empty,viewProps:e.viewProps});super({blade:e.blade,rackController:new Dl({blade:e.blade,element:r.contentsElement,viewProps:e.viewProps}),view:r}),this.onRackAdd_=this.onRackAdd_.bind(this),this.onRackRemove_=this.onRackRemove_.bind(this);const s=this.rackController.rack;s.emitter.on("add",this.onRackAdd_),s.emitter.on("remove",this.onRackRemove_),this.tab=i}add(t,e){this.rackController.rack.add(t,e)}remove(t){this.rackController.rack.remove(this.rackController.rack.children[t])}onRackAdd_(t){if(!t.root)return;const e=t.bladeController;$u(this.view.itemsElement,e.itemController.view.element,t.index),e.itemController.viewProps.set("parent",this.viewProps),this.tab.add(e.props.value("selected"))}onRackRemove_(t){if(!t.root)return;const e=t.bladeController;Al(e.itemController.view.element),e.itemController.viewProps.set("parent",null),this.tab.remove(e.props.value("selected"))}}const od=Ue({id:"tab",type:"blade",accept(n){const t=ce(n,e=>({pages:e.required.array(e.required.object({title:e.required.string})),view:e.required.constant("tab")}));return!t||t.pages.length===0?null:{params:t}},controller(n){const t=new Vh(n.document,{blade:n.blade,viewProps:n.viewProps});return n.params.pages.forEach(e=>{const i=new el(n.document,{blade:br(),itemProps:Ut.fromObject({selected:!1,title:e.title}),props:Ut.fromObject({selected:!1}),viewProps:Bn.create()});t.add(i)}),t},api(n){return n.controller instanceof Vh?new Ix(n.controller,n.pool):n.controller instanceof el?new Ux(n.controller,n.pool):null}});function Ox(n,t){const e=n.accept(t.params);if(!e)return null;const i=ce(t.params,r=>({disabled:r.optional.boolean,hidden:r.optional.boolean}));return n.controller({blade:br(),document:t.document,params:Object.assign(Object.assign({},e.params),{disabled:i==null?void 0:i.disabled,hidden:i==null?void 0:i.hidden}),viewProps:Bn.create({disabled:i==null?void 0:i.disabled,hidden:i==null?void 0:i.hidden})})}class Ul extends Gr{get options(){return this.controller.valueController.props.get("options")}set options(t){this.controller.valueController.props.set("options",t)}}class kx{constructor(){this.disabled=!1,this.emitter=new _e}dispose(){}tick(){this.disabled||this.emitter.emit("tick",{sender:this})}}class Bx{constructor(t,e){this.disabled_=!1,this.timerId_=null,this.onTick_=this.onTick_.bind(this),this.doc_=t,this.emitter=new _e,this.interval_=e,this.setTimer_()}get disabled(){return this.disabled_}set disabled(t){this.disabled_=t,this.disabled_?this.clearTimer_():this.setTimer_()}dispose(){this.clearTimer_()}clearTimer_(){if(this.timerId_===null)return;const t=this.doc_.defaultView;t&&t.clearInterval(this.timerId_),this.timerId_=null}setTimer_(){if(this.clearTimer_(),this.interval_<=0)return;const t=this.doc_.defaultView;t&&(this.timerId_=t.setInterval(this.onTick_,this.interval_))}onTick_(){this.disabled_||this.emitter.emit("tick",{sender:this})}}class ns{constructor(t){this.constraints=t}constrain(t){return this.constraints.reduce((e,i)=>i.constrain(e),t)}}function oo(n,t){if(n instanceof t)return n;if(n instanceof ns){const e=n.constraints.reduce((i,r)=>i||(r instanceof t?r:null),null);if(e)return e}return null}class is{constructor(t){this.values=Ut.fromObject({options:t})}constrain(t){const e=this.values.get("options");return e.length===0||e.filter(r=>r.value===t).length>0?t:e[0].value}}function rs(n){var t;const e=Ja;if(Array.isArray(n))return(t=ce({items:n},i=>({items:i.required.array(i.required.object({text:i.required.string,value:i.required.raw}))})))===null||t===void 0?void 0:t.items;if(typeof n=="object")return e.required.raw(n).value}function Nl(n){if(Array.isArray(n))return n;const t=[];return Object.keys(n).forEach(e=>{t.push({text:e,value:n[e]})}),t}function Fl(n){return ie(n)?null:new is(Nl(n))}const na=Xt("lst");class Vx{constructor(t,e){this.onValueChange_=this.onValueChange_.bind(this),this.props_=e.props,this.element=t.createElement("div"),this.element.classList.add(na()),e.viewProps.bindClassModifiers(this.element);const i=t.createElement("select");i.classList.add(na("s")),e.viewProps.bindDisabled(i),this.element.appendChild(i),this.selectElement=i;const r=t.createElement("div");r.classList.add(na("m")),r.appendChild(_o(t,"dropdown")),this.element.appendChild(r),e.value.emitter.on("change",this.onValueChange_),this.value_=e.value,gn(this.props_,"options",s=>{Zu(this.selectElement),s.forEach(o=>{const a=t.createElement("option");a.textContent=o.text,this.selectElement.appendChild(a)}),this.update_()})}update_(){const t=this.props_.get("options").map(e=>e.value);this.selectElement.selectedIndex=t.indexOf(this.value_.rawValue)}onValueChange_(){this.update_()}}class ii{constructor(t,e){this.onSelectChange_=this.onSelectChange_.bind(this),this.props=e.props,this.value=e.value,this.viewProps=e.viewProps,this.view=new Vx(t,{props:this.props,value:this.value,viewProps:this.viewProps}),this.view.selectElement.addEventListener("change",this.onSelectChange_)}onSelectChange_(t){const e=t.currentTarget;this.value.rawValue=this.props.get("options")[e.selectedIndex].value}importProps(t){return je(t,null,e=>({options:e.required.custom(rs)}),e=>(this.props.set("options",Nl(e.options)),!0))}exportProps(){return qe(null,{options:this.props.get("options")})}}const zh=Xt("pop");class zx{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(zh()),e.viewProps.bindClassModifiers(this.element),In(e.shows,gr(this.element,zh(void 0,"v")))}}class ad{constructor(t,e){this.shows=ae(!1),this.viewProps=e.viewProps,this.view=new zx(t,{shows:this.shows,viewProps:this.viewProps})}}const Hh=Xt("txt");class Hx{constructor(t,e){this.onChange_=this.onChange_.bind(this),this.element=t.createElement("div"),this.element.classList.add(Hh()),e.viewProps.bindClassModifiers(this.element),this.props_=e.props,this.props_.emitter.on("change",this.onChange_);const i=t.createElement("input");i.classList.add(Hh("i")),i.type="text",e.viewProps.bindDisabled(i),this.element.appendChild(i),this.inputElement=i,e.value.emitter.on("change",this.onChange_),this.value_=e.value,this.refresh()}refresh(){const t=this.props_.get("formatter");this.inputElement.value=t(this.value_.rawValue)}onChange_(){this.refresh()}}class Wr{constructor(t,e){this.onInputChange_=this.onInputChange_.bind(this),this.parser_=e.parser,this.props=e.props,this.value=e.value,this.viewProps=e.viewProps,this.view=new Hx(t,{props:e.props,value:this.value,viewProps:this.viewProps}),this.view.inputElement.addEventListener("change",this.onInputChange_)}onInputChange_(t){const i=t.currentTarget.value,r=this.parser_(i);ie(r)||(this.value.rawValue=r),this.view.refresh()}}function Gx(n){return String(n)}function ld(n){return n==="false"?!1:!!n}function Gh(n){return Gx(n)}function Wx(n){return t=>n.reduce((e,i)=>e!==null?e:i(t),null)}const Xx=Be(0);function ao(n){return Xx(n)+"%"}function cd(n){return String(n)}function nl(n){return n}function xr({primary:n,secondary:t,forward:e,backward:i}){let r=!1;function s(o){r||(r=!0,o(),r=!1)}n.emitter.on("change",o=>{s(()=>{t.setRawValue(e(n.rawValue,t.rawValue),o.options)})}),t.emitter.on("change",o=>{s(()=>{n.setRawValue(i(n.rawValue,t.rawValue),o.options)}),s(()=>{t.setRawValue(e(n.rawValue,t.rawValue),o.options)})}),s(()=>{t.setRawValue(e(n.rawValue,t.rawValue),{forceEmit:!1,last:!0})})}function Oe(n,t){const e=n*(t.altKey?.1:1)*(t.shiftKey?10:1);return t.upKey?+e:t.downKey?-e:0}function Xr(n){return{altKey:n.altKey,downKey:n.key==="ArrowDown",shiftKey:n.shiftKey,upKey:n.key==="ArrowUp"}}function kn(n){return{altKey:n.altKey,downKey:n.key==="ArrowLeft",shiftKey:n.shiftKey,upKey:n.key==="ArrowRight"}}function jx(n){return n==="ArrowUp"||n==="ArrowDown"}function hd(n){return jx(n)||n==="ArrowLeft"||n==="ArrowRight"}function ia(n,t){var e,i;const r=t.ownerDocument.defaultView,s=t.getBoundingClientRect();return{x:n.pageX-(((e=r&&r.scrollX)!==null&&e!==void 0?e:0)+s.left),y:n.pageY-(((i=r&&r.scrollY)!==null&&i!==void 0?i:0)+s.top)}}class Li{constructor(t){this.lastTouch_=null,this.onDocumentMouseMove_=this.onDocumentMouseMove_.bind(this),this.onDocumentMouseUp_=this.onDocumentMouseUp_.bind(this),this.onMouseDown_=this.onMouseDown_.bind(this),this.onTouchEnd_=this.onTouchEnd_.bind(this),this.onTouchMove_=this.onTouchMove_.bind(this),this.onTouchStart_=this.onTouchStart_.bind(this),this.elem_=t,this.emitter=new _e,t.addEventListener("touchstart",this.onTouchStart_,{passive:!1}),t.addEventListener("touchmove",this.onTouchMove_,{passive:!0}),t.addEventListener("touchend",this.onTouchEnd_),t.addEventListener("mousedown",this.onMouseDown_)}computePosition_(t){const e=this.elem_.getBoundingClientRect();return{bounds:{width:e.width,height:e.height},point:t?{x:t.x,y:t.y}:null}}onMouseDown_(t){var e;t.preventDefault(),(e=t.currentTarget)===null||e===void 0||e.focus();const i=this.elem_.ownerDocument;i.addEventListener("mousemove",this.onDocumentMouseMove_),i.addEventListener("mouseup",this.onDocumentMouseUp_),this.emitter.emit("down",{altKey:t.altKey,data:this.computePosition_(ia(t,this.elem_)),sender:this,shiftKey:t.shiftKey})}onDocumentMouseMove_(t){this.emitter.emit("move",{altKey:t.altKey,data:this.computePosition_(ia(t,this.elem_)),sender:this,shiftKey:t.shiftKey})}onDocumentMouseUp_(t){const e=this.elem_.ownerDocument;e.removeEventListener("mousemove",this.onDocumentMouseMove_),e.removeEventListener("mouseup",this.onDocumentMouseUp_),this.emitter.emit("up",{altKey:t.altKey,data:this.computePosition_(ia(t,this.elem_)),sender:this,shiftKey:t.shiftKey})}onTouchStart_(t){t.preventDefault();const e=t.targetTouches.item(0),i=this.elem_.getBoundingClientRect();this.emitter.emit("down",{altKey:t.altKey,data:this.computePosition_(e?{x:e.clientX-i.left,y:e.clientY-i.top}:void 0),sender:this,shiftKey:t.shiftKey}),this.lastTouch_=e}onTouchMove_(t){const e=t.targetTouches.item(0),i=this.elem_.getBoundingClientRect();this.emitter.emit("move",{altKey:t.altKey,data:this.computePosition_(e?{x:e.clientX-i.left,y:e.clientY-i.top}:void 0),sender:this,shiftKey:t.shiftKey}),this.lastTouch_=e}onTouchEnd_(t){var e;const i=(e=t.targetTouches.item(0))!==null&&e!==void 0?e:this.lastTouch_,r=this.elem_.getBoundingClientRect();this.emitter.emit("up",{altKey:t.altKey,data:this.computePosition_(i?{x:i.clientX-r.left,y:i.clientY-r.top}:void 0),sender:this,shiftKey:t.shiftKey})}}const Qe=Xt("txt");class qx{constructor(t,e){this.onChange_=this.onChange_.bind(this),this.props_=e.props,this.props_.emitter.on("change",this.onChange_),this.element=t.createElement("div"),this.element.classList.add(Qe(),Qe(void 0,"num")),e.arrayPosition&&this.element.classList.add(Qe(void 0,e.arrayPosition)),e.viewProps.bindClassModifiers(this.element);const i=t.createElement("input");i.classList.add(Qe("i")),i.type="text",e.viewProps.bindDisabled(i),this.element.appendChild(i),this.inputElement=i,this.onDraggingChange_=this.onDraggingChange_.bind(this),this.dragging_=e.dragging,this.dragging_.emitter.on("change",this.onDraggingChange_),this.element.classList.add(Qe()),this.inputElement.classList.add(Qe("i"));const r=t.createElement("div");r.classList.add(Qe("k")),this.element.appendChild(r),this.knobElement=r;const s=t.createElementNS(fn,"svg");s.classList.add(Qe("g")),this.knobElement.appendChild(s);const o=t.createElementNS(fn,"path");o.classList.add(Qe("gb")),s.appendChild(o),this.guideBodyElem_=o;const a=t.createElementNS(fn,"path");a.classList.add(Qe("gh")),s.appendChild(a),this.guideHeadElem_=a;const l=t.createElement("div");l.classList.add(Xt("tt")()),this.knobElement.appendChild(l),this.tooltipElem_=l,e.value.emitter.on("change",this.onChange_),this.value=e.value,this.refresh()}onDraggingChange_(t){if(t.rawValue===null){this.element.classList.remove(Qe(void 0,"drg"));return}this.element.classList.add(Qe(void 0,"drg"));const e=t.rawValue/this.props_.get("pointerScale"),i=e+(e>0?-1:e<0?1:0),r=ve(-i,-4,4);this.guideHeadElem_.setAttributeNS(null,"d",[`M ${i+r},0 L${i},4 L${i+r},8`,`M ${e},-1 L${e},9`].join(" ")),this.guideBodyElem_.setAttributeNS(null,"d",`M 0,4 L${e},4`);const s=this.props_.get("formatter");this.tooltipElem_.textContent=s(this.value.rawValue),this.tooltipElem_.style.left=`${e}px`}refresh(){const t=this.props_.get("formatter");this.inputElement.value=t(this.value.rawValue)}onChange_(){this.refresh()}}class ss{constructor(t,e){var i;this.originRawValue_=0,this.onInputChange_=this.onInputChange_.bind(this),this.onInputKeyDown_=this.onInputKeyDown_.bind(this),this.onInputKeyUp_=this.onInputKeyUp_.bind(this),this.onPointerDown_=this.onPointerDown_.bind(this),this.onPointerMove_=this.onPointerMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.parser_=e.parser,this.props=e.props,this.sliderProps_=(i=e.sliderProps)!==null&&i!==void 0?i:null,this.value=e.value,this.viewProps=e.viewProps,this.dragging_=ae(null),this.view=new qx(t,{arrayPosition:e.arrayPosition,dragging:this.dragging_,props:this.props,value:this.value,viewProps:this.viewProps}),this.view.inputElement.addEventListener("change",this.onInputChange_),this.view.inputElement.addEventListener("keydown",this.onInputKeyDown_),this.view.inputElement.addEventListener("keyup",this.onInputKeyUp_);const r=new Li(this.view.knobElement);r.emitter.on("down",this.onPointerDown_),r.emitter.on("move",this.onPointerMove_),r.emitter.on("up",this.onPointerUp_)}constrainValue_(t){var e,i;const r=(e=this.sliderProps_)===null||e===void 0?void 0:e.get("min"),s=(i=this.sliderProps_)===null||i===void 0?void 0:i.get("max");let o=t;return r!==void 0&&(o=Math.max(o,r)),s!==void 0&&(o=Math.min(o,s)),o}onInputChange_(t){const i=t.currentTarget.value,r=this.parser_(i);ie(r)||(this.value.rawValue=this.constrainValue_(r)),this.view.refresh()}onInputKeyDown_(t){const e=Oe(this.props.get("keyScale"),Xr(t));e!==0&&this.value.setRawValue(this.constrainValue_(this.value.rawValue+e),{forceEmit:!1,last:!1})}onInputKeyUp_(t){Oe(this.props.get("keyScale"),Xr(t))!==0&&this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}onPointerDown_(){this.originRawValue_=this.value.rawValue,this.dragging_.rawValue=0}computeDraggingValue_(t){if(!t.point)return null;const e=t.point.x-t.bounds.width/2;return this.constrainValue_(this.originRawValue_+e*this.props.get("pointerScale"))}onPointerMove_(t){const e=this.computeDraggingValue_(t.data);e!==null&&(this.value.setRawValue(e,{forceEmit:!1,last:!1}),this.dragging_.rawValue=this.value.rawValue-this.originRawValue_)}onPointerUp_(t){const e=this.computeDraggingValue_(t.data);e!==null&&(this.value.setRawValue(e,{forceEmit:!0,last:!0}),this.dragging_.rawValue=null)}}const ra=Xt("sld");class Yx{constructor(t,e){this.onChange_=this.onChange_.bind(this),this.props_=e.props,this.props_.emitter.on("change",this.onChange_),this.element=t.createElement("div"),this.element.classList.add(ra()),e.viewProps.bindClassModifiers(this.element);const i=t.createElement("div");i.classList.add(ra("t")),e.viewProps.bindTabIndex(i),this.element.appendChild(i),this.trackElement=i;const r=t.createElement("div");r.classList.add(ra("k")),this.trackElement.appendChild(r),this.knobElement=r,e.value.emitter.on("change",this.onChange_),this.value=e.value,this.update_()}update_(){const t=ve($t(this.value.rawValue,this.props_.get("min"),this.props_.get("max"),0,100),0,100);this.knobElement.style.width=`${t}%`}onChange_(){this.update_()}}class Kx{constructor(t,e){this.onKeyDown_=this.onKeyDown_.bind(this),this.onKeyUp_=this.onKeyUp_.bind(this),this.onPointerDownOrMove_=this.onPointerDownOrMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.value=e.value,this.viewProps=e.viewProps,this.props=e.props,this.view=new Yx(t,{props:this.props,value:this.value,viewProps:this.viewProps}),this.ptHandler_=new Li(this.view.trackElement),this.ptHandler_.emitter.on("down",this.onPointerDownOrMove_),this.ptHandler_.emitter.on("move",this.onPointerDownOrMove_),this.ptHandler_.emitter.on("up",this.onPointerUp_),this.view.trackElement.addEventListener("keydown",this.onKeyDown_),this.view.trackElement.addEventListener("keyup",this.onKeyUp_)}handlePointerEvent_(t,e){t.point&&this.value.setRawValue($t(ve(t.point.x,0,t.bounds.width),0,t.bounds.width,this.props.get("min"),this.props.get("max")),e)}onPointerDownOrMove_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerUp_(t){this.handlePointerEvent_(t.data,{forceEmit:!0,last:!0})}onKeyDown_(t){const e=Oe(this.props.get("keyScale"),kn(t));e!==0&&this.value.setRawValue(this.value.rawValue+e,{forceEmit:!1,last:!1})}onKeyUp_(t){Oe(this.props.get("keyScale"),kn(t))!==0&&this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}}const sa=Xt("sldtxt");class $x{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(sa());const i=t.createElement("div");i.classList.add(sa("s")),this.sliderView_=e.sliderView,i.appendChild(this.sliderView_.element),this.element.appendChild(i);const r=t.createElement("div");r.classList.add(sa("t")),this.textView_=e.textView,r.appendChild(this.textView_.element),this.element.appendChild(r)}}class lo{constructor(t,e){this.value=e.value,this.viewProps=e.viewProps,this.sliderC_=new Kx(t,{props:e.sliderProps,value:e.value,viewProps:this.viewProps}),this.textC_=new ss(t,{parser:e.parser,props:e.textProps,sliderProps:e.sliderProps,value:e.value,viewProps:e.viewProps}),this.view=new $x(t,{sliderView:this.sliderC_.view,textView:this.textC_.view})}get sliderController(){return this.sliderC_}get textController(){return this.textC_}importProps(t){return je(t,null,e=>({max:e.required.number,min:e.required.number}),e=>{const i=this.sliderC_.props;return i.set("max",e.max),i.set("min",e.min),!0})}exportProps(){const t=this.sliderC_.props;return qe(null,{max:t.get("max"),min:t.get("min")})}}function ud(n){return{sliderProps:new Ut({keyScale:n.keyScale,max:n.max,min:n.min}),textProps:new Ut({formatter:ae(n.formatter),keyScale:n.keyScale,pointerScale:ae(n.pointerScale)})}}const Zx={containerUnitSize:"cnt-usz"};function dd(n){return`--${Zx[n]}`}function jr(n){return Yu(n)}function Zn(n){if(Za(n))return ce(n,jr)}function Ln(n,t){if(!n)return;const e=[],i=Xu(n,t);i&&e.push(i);const r=ju(n);return r&&e.push(r),new ns(e)}function Jx(n){return n?n.major===vr.major:!1}function pd(n){if(n==="inline"||n==="popup")return n}function os(n,t){n.write(t)}const Vs=Xt("ckb");class Qx{constructor(t,e){this.onValueChange_=this.onValueChange_.bind(this),this.element=t.createElement("div"),this.element.classList.add(Vs()),e.viewProps.bindClassModifiers(this.element);const i=t.createElement("label");i.classList.add(Vs("l")),this.element.appendChild(i),this.labelElement=i;const r=t.createElement("input");r.classList.add(Vs("i")),r.type="checkbox",this.labelElement.appendChild(r),this.inputElement=r,e.viewProps.bindDisabled(this.inputElement);const s=t.createElement("div");s.classList.add(Vs("w")),this.labelElement.appendChild(s);const o=_o(t,"check");s.appendChild(o),e.value.emitter.on("change",this.onValueChange_),this.value=e.value,this.update_()}update_(){this.inputElement.checked=this.value.rawValue}onValueChange_(){this.update_()}}class ty{constructor(t,e){this.onInputChange_=this.onInputChange_.bind(this),this.onLabelMouseDown_=this.onLabelMouseDown_.bind(this),this.value=e.value,this.viewProps=e.viewProps,this.view=new Qx(t,{value:this.value,viewProps:this.viewProps}),this.view.inputElement.addEventListener("change",this.onInputChange_),this.view.labelElement.addEventListener("mousedown",this.onLabelMouseDown_)}onInputChange_(t){const e=t.currentTarget;this.value.rawValue=e.checked,t.preventDefault(),t.stopPropagation()}onLabelMouseDown_(t){t.preventDefault()}}function ey(n){const t=[],e=Fl(n.options);return e&&t.push(e),new ns(t)}const ny=Ue({id:"input-bool",type:"input",accept:(n,t)=>{if(typeof n!="boolean")return null;const e=ce(t,i=>({options:i.optional.custom(rs),readonly:i.optional.constant(!1)}));return e?{initialValue:n,params:e}:null},binding:{reader:n=>ld,constraint:n=>ey(n.params),writer:n=>os},controller:n=>{const t=n.document,e=n.value,i=n.constraint,r=i&&oo(i,is);return r?new ii(t,{props:new Ut({options:r.values.value("options")}),value:e,viewProps:n.viewProps}):new ty(t,{value:e,viewProps:n.viewProps})},api(n){return typeof n.controller.value.rawValue!="boolean"?null:n.controller.valueController instanceof ii?new Ul(n.controller):null}}),fi=Xt("col");class iy{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(fi()),e.foldable.bindExpandedClass(this.element,fi(void 0,"expanded")),gn(e.foldable,"completed",gr(this.element,fi(void 0,"cpl")));const i=t.createElement("div");i.classList.add(fi("h")),this.element.appendChild(i);const r=t.createElement("div");r.classList.add(fi("s")),i.appendChild(r),this.swatchElement=r;const s=t.createElement("div");if(s.classList.add(fi("t")),i.appendChild(s),this.textElement=s,e.pickerLayout==="inline"){const o=t.createElement("div");o.classList.add(fi("p")),this.element.appendChild(o),this.pickerElement=o}else this.pickerElement=null}}function ry(n,t,e){const i=ve(n/255,0,1),r=ve(t/255,0,1),s=ve(e/255,0,1),o=Math.max(i,r,s),a=Math.min(i,r,s),l=o-a;let c=0,h=0;const u=(a+o)/2;return l!==0&&(h=l/(1-Math.abs(o+a-1)),i===o?c=(r-s)/l:r===o?c=2+(s-i)/l:c=4+(i-r)/l,c=c/6+(c<0?1:0)),[c*360,h*100,u*100]}function sy(n,t,e){const i=(n%360+360)%360,r=ve(t/100,0,1),s=ve(e/100,0,1),o=(1-Math.abs(2*s-1))*r,a=o*(1-Math.abs(i/60%2-1)),l=s-o/2;let c,h,u;return i>=0&&i<60?[c,h,u]=[o,a,0]:i>=60&&i<120?[c,h,u]=[a,o,0]:i>=120&&i<180?[c,h,u]=[0,o,a]:i>=180&&i<240?[c,h,u]=[0,a,o]:i>=240&&i<300?[c,h,u]=[a,0,o]:[c,h,u]=[o,0,a],[(c+l)*255,(h+l)*255,(u+l)*255]}function oy(n,t,e){const i=ve(n/255,0,1),r=ve(t/255,0,1),s=ve(e/255,0,1),o=Math.max(i,r,s),a=Math.min(i,r,s),l=o-a;let c;l===0?c=0:o===i?c=60*(((r-s)/l%6+6)%6):o===r?c=60*((s-i)/l+2):c=60*((i-r)/l+4);const h=o===0?0:l/o,u=o;return[c,h*100,u*100]}function fd(n,t,e){const i=Hu(n,360),r=ve(t/100,0,1),s=ve(e/100,0,1),o=s*r,a=o*(1-Math.abs(i/60%2-1)),l=s-o;let c,h,u;return i>=0&&i<60?[c,h,u]=[o,a,0]:i>=60&&i<120?[c,h,u]=[a,o,0]:i>=120&&i<180?[c,h,u]=[0,o,a]:i>=180&&i<240?[c,h,u]=[0,a,o]:i>=240&&i<300?[c,h,u]=[a,0,o]:[c,h,u]=[o,0,a],[(c+l)*255,(h+l)*255,(u+l)*255]}function ay(n,t,e){const i=e+t*(100-Math.abs(2*e-100))/200;return[n,i!==0?t*(100-Math.abs(2*e-100))/i:0,e+t*(100-Math.abs(2*e-100))/(2*100)]}function ly(n,t,e){const i=100-Math.abs(e*(200-t)/100-100);return[n,i!==0?t*e/i:0,e*(200-t)/(2*100)]}function vn(n){return[n[0],n[1],n[2]]}function vo(n,t){return[n[0],n[1],n[2],t]}const cy={hsl:{hsl:(n,t,e)=>[n,t,e],hsv:ay,rgb:sy},hsv:{hsl:ly,hsv:(n,t,e)=>[n,t,e],rgb:fd},rgb:{hsl:ry,hsv:oy,rgb:(n,t,e)=>[n,t,e]}};function fr(n,t){return[t==="float"?1:n==="rgb"?255:360,t==="float"?1:n==="rgb"?255:100,t==="float"?1:n==="rgb"?255:100]}function hy(n,t){return n===t?t:Hu(n,t)}function md(n,t,e){var i;const r=fr(t,e);return[t==="rgb"?ve(n[0],0,r[0]):hy(n[0],r[0]),ve(n[1],0,r[1]),ve(n[2],0,r[2]),ve((i=n[3])!==null&&i!==void 0?i:1,0,1)]}function Wh(n,t,e,i){const r=fr(t,e),s=fr(t,i);return n.map((o,a)=>o/r[a]*s[a])}function _d(n,t,e){const i=Wh(n,t.mode,t.type,"int"),r=cy[t.mode][e.mode](...i);return Wh(r,e.mode,"int",e.type)}class qt{static black(){return new qt([0,0,0],"rgb")}constructor(t,e){this.type="int",this.mode=e,this.comps_=md(t,e,this.type)}getComponents(t){return vo(_d(vn(this.comps_),{mode:this.mode,type:this.type},{mode:t??this.mode,type:this.type}),this.comps_[3])}toRgbaObject(){const t=this.getComponents("rgb");return{r:t[0],g:t[1],b:t[2],a:t[3]}}}const jn=Xt("colp");class uy{constructor(t,e){this.alphaViews_=null,this.element=t.createElement("div"),this.element.classList.add(jn()),e.viewProps.bindClassModifiers(this.element);const i=t.createElement("div");i.classList.add(jn("hsv"));const r=t.createElement("div");r.classList.add(jn("sv")),this.svPaletteView_=e.svPaletteView,r.appendChild(this.svPaletteView_.element),i.appendChild(r);const s=t.createElement("div");s.classList.add(jn("h")),this.hPaletteView_=e.hPaletteView,s.appendChild(this.hPaletteView_.element),i.appendChild(s),this.element.appendChild(i);const o=t.createElement("div");if(o.classList.add(jn("rgb")),this.textsView_=e.textsView,o.appendChild(this.textsView_.element),this.element.appendChild(o),e.alphaViews){this.alphaViews_={palette:e.alphaViews.palette,text:e.alphaViews.text};const a=t.createElement("div");a.classList.add(jn("a"));const l=t.createElement("div");l.classList.add(jn("ap")),l.appendChild(this.alphaViews_.palette.element),a.appendChild(l);const c=t.createElement("div");c.classList.add(jn("at")),c.appendChild(this.alphaViews_.text.element),a.appendChild(c),this.element.appendChild(a)}}get allFocusableElements(){const t=[this.svPaletteView_.element,this.hPaletteView_.element,this.textsView_.modeSelectElement,...this.textsView_.inputViews.map(e=>e.inputElement)];return this.alphaViews_&&t.push(this.alphaViews_.palette.element,this.alphaViews_.text.inputElement),t}}function dy(n){return n==="int"?"int":n==="float"?"float":void 0}function Ol(n){return ce(n,t=>({color:t.optional.object({alpha:t.optional.boolean,type:t.optional.custom(dy)}),expanded:t.optional.boolean,picker:t.optional.custom(pd),readonly:t.optional.constant(!1)}))}function Si(n){return n?.1:1}function gd(n){var t;return(t=n.color)===null||t===void 0?void 0:t.type}class kl{constructor(t,e){this.type="float",this.mode=e,this.comps_=md(t,e,this.type)}getComponents(t){return vo(_d(vn(this.comps_),{mode:this.mode,type:this.type},{mode:t??this.mode,type:this.type}),this.comps_[3])}toRgbaObject(){const t=this.getComponents("rgb");return{r:t[0],g:t[1],b:t[2],a:t[3]}}}const py={int:(n,t)=>new qt(n,t),float:(n,t)=>new kl(n,t)};function Bl(n,t,e){return py[e](n,t)}function fy(n){return n.type==="float"}function my(n){return n.type==="int"}function _y(n){const t=n.getComponents(),e=fr(n.mode,"int");return new qt([Math.round($t(t[0],0,1,0,e[0])),Math.round($t(t[1],0,1,0,e[1])),Math.round($t(t[2],0,1,0,e[2])),t[3]],n.mode)}function gy(n){const t=n.getComponents(),e=fr(n.mode,"int");return new kl([$t(t[0],0,e[0],0,1),$t(t[1],0,e[1],0,1),$t(t[2],0,e[2],0,1),t[3]],n.mode)}function Ie(n,t){if(n.type===t)return n;if(my(n)&&t==="float")return gy(n);if(fy(n)&&t==="int")return _y(n);throw de.shouldNeverHappen()}function vy(n,t){return n.alpha===t.alpha&&n.mode===t.mode&&n.notation===t.notation&&n.type===t.type}function en(n,t){const e=n.match(/^(.+)%$/);return Math.min(e?parseFloat(e[1])*.01*t:parseFloat(n),t)}const by={deg:n=>n,grad:n=>n*360/400,rad:n=>n*360/(2*Math.PI),turn:n=>n*360};function vd(n){const t=n.match(/^([0-9.]+?)(deg|grad|rad|turn)$/);if(!t)return parseFloat(n);const e=parseFloat(t[1]),i=t[2];return by[i](e)}function bd(n){const t=n.match(/^rgb\(\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*\)$/);if(!t)return null;const e=[en(t[1],255),en(t[2],255),en(t[3],255)];return isNaN(e[0])||isNaN(e[1])||isNaN(e[2])?null:e}function xy(n){const t=bd(n);return t?new qt(t,"rgb"):null}function xd(n){const t=n.match(/^rgba\(\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*\)$/);if(!t)return null;const e=[en(t[1],255),en(t[2],255),en(t[3],255),en(t[4],1)];return isNaN(e[0])||isNaN(e[1])||isNaN(e[2])||isNaN(e[3])?null:e}function yy(n){const t=xd(n);return t?new qt(t,"rgb"):null}function yd(n){const t=n.match(/^hsl\(\s*([0-9A-Fa-f.]+(?:deg|grad|rad|turn)?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*\)$/);if(!t)return null;const e=[vd(t[1]),en(t[2],100),en(t[3],100)];return isNaN(e[0])||isNaN(e[1])||isNaN(e[2])?null:e}function wy(n){const t=yd(n);return t?new qt(t,"hsl"):null}function wd(n){const t=n.match(/^hsla\(\s*([0-9A-Fa-f.]+(?:deg|grad|rad|turn)?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*,\s*([0-9A-Fa-f.]+%?)\s*\)$/);if(!t)return null;const e=[vd(t[1]),en(t[2],100),en(t[3],100),en(t[4],1)];return isNaN(e[0])||isNaN(e[1])||isNaN(e[2])||isNaN(e[3])?null:e}function Ey(n){const t=wd(n);return t?new qt(t,"hsl"):null}function Ed(n){const t=n.match(/^#([0-9A-Fa-f])([0-9A-Fa-f])([0-9A-Fa-f])$/);if(t)return[parseInt(t[1]+t[1],16),parseInt(t[2]+t[2],16),parseInt(t[3]+t[3],16)];const e=n.match(/^(?:#|0x)([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})$/);return e?[parseInt(e[1],16),parseInt(e[2],16),parseInt(e[3],16)]:null}function My(n){const t=Ed(n);return t?new qt(t,"rgb"):null}function Md(n){const t=n.match(/^#([0-9A-Fa-f])([0-9A-Fa-f])([0-9A-Fa-f])([0-9A-Fa-f])$/);if(t)return[parseInt(t[1]+t[1],16),parseInt(t[2]+t[2],16),parseInt(t[3]+t[3],16),$t(parseInt(t[4]+t[4],16),0,255,0,1)];const e=n.match(/^(?:#|0x)?([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})([0-9A-Fa-f]{2})$/);return e?[parseInt(e[1],16),parseInt(e[2],16),parseInt(e[3],16),$t(parseInt(e[4],16),0,255,0,1)]:null}function Sy(n){const t=Md(n);return t?new qt(t,"rgb"):null}function Sd(n){const t=n.match(/^\{\s*r\s*:\s*([0-9A-Fa-f.]+%?)\s*,\s*g\s*:\s*([0-9A-Fa-f.]+%?)\s*,\s*b\s*:\s*([0-9A-Fa-f.]+%?)\s*\}$/);if(!t)return null;const e=[parseFloat(t[1]),parseFloat(t[2]),parseFloat(t[3])];return isNaN(e[0])||isNaN(e[1])||isNaN(e[2])?null:e}function Ty(n){return t=>{const e=Sd(t);return e?Bl(e,"rgb",n):null}}function Td(n){const t=n.match(/^\{\s*r\s*:\s*([0-9A-Fa-f.]+%?)\s*,\s*g\s*:\s*([0-9A-Fa-f.]+%?)\s*,\s*b\s*:\s*([0-9A-Fa-f.]+%?)\s*,\s*a\s*:\s*([0-9A-Fa-f.]+%?)\s*\}$/);if(!t)return null;const e=[parseFloat(t[1]),parseFloat(t[2]),parseFloat(t[3]),parseFloat(t[4])];return isNaN(e[0])||isNaN(e[1])||isNaN(e[2])||isNaN(e[3])?null:e}function Cy(n){return t=>{const e=Td(t);return e?Bl(e,"rgb",n):null}}const Ay=[{parser:Ed,result:{alpha:!1,mode:"rgb",notation:"hex"}},{parser:Md,result:{alpha:!0,mode:"rgb",notation:"hex"}},{parser:bd,result:{alpha:!1,mode:"rgb",notation:"func"}},{parser:xd,result:{alpha:!0,mode:"rgb",notation:"func"}},{parser:yd,result:{alpha:!1,mode:"hsl",notation:"func"}},{parser:wd,result:{alpha:!0,mode:"hsl",notation:"func"}},{parser:Sd,result:{alpha:!1,mode:"rgb",notation:"object"}},{parser:Td,result:{alpha:!0,mode:"rgb",notation:"object"}}];function Py(n){return Ay.reduce((t,{parser:e,result:i})=>t||(e(n)?i:null),null)}function Ry(n,t="int"){const e=Py(n);return e?e.notation==="hex"&&t!=="float"?Object.assign(Object.assign({},e),{type:"int"}):e.notation==="func"?Object.assign(Object.assign({},e),{type:t}):null:null}function as(n){const t=[My,Sy,xy,yy,wy,Ey];t.push(Ty("int"),Cy("int"));const e=Wx(t);return i=>{const r=e(i);return r?Ie(r,n):null}}function Ly(n){const t=as("int");if(typeof n!="string")return qt.black();const e=t(n);return e??qt.black()}function Cd(n){const t=ve(Math.floor(n),0,255).toString(16);return t.length===1?`0${t}`:t}function Vl(n,t="#"){const e=vn(n.getComponents("rgb")).map(Cd).join("");return`${t}${e}`}function zl(n,t="#"){const e=n.getComponents("rgb"),i=[e[0],e[1],e[2],e[3]*255].map(Cd).join("");return`${t}${i}`}function Ad(n){const t=Be(0),e=Ie(n,"int");return`rgb(${vn(e.getComponents("rgb")).map(r=>t(r)).join(", ")})`}function Ys(n){const t=Be(2),e=Be(0);return`rgba(${Ie(n,"int").getComponents("rgb").map((s,o)=>(o===3?t:e)(s)).join(", ")})`}function Dy(n){const t=[Be(0),ao,ao],e=Ie(n,"int");return`hsl(${vn(e.getComponents("hsl")).map((r,s)=>t[s](r)).join(", ")})`}function Iy(n){const t=[Be(0),ao,ao,Be(2)];return`hsla(${Ie(n,"int").getComponents("hsl").map((r,s)=>t[s](r)).join(", ")})`}function Pd(n,t){const e=Be(t==="float"?2:0),i=["r","g","b"],r=Ie(n,t);return`{${vn(r.getComponents("rgb")).map((o,a)=>`${i[a]}: ${e(o)}`).join(", ")}}`}function Uy(n){return t=>Pd(t,n)}function Rd(n,t){const e=Be(2),i=Be(t==="float"?2:0),r=["r","g","b","a"];return`{${Ie(n,t).getComponents("rgb").map((a,l)=>{const c=l===3?e:i;return`${r[l]}: ${c(a)}`}).join(", ")}}`}function Ny(n){return t=>Rd(t,n)}const Fy=[{format:{alpha:!1,mode:"rgb",notation:"hex",type:"int"},stringifier:Vl},{format:{alpha:!0,mode:"rgb",notation:"hex",type:"int"},stringifier:zl},{format:{alpha:!1,mode:"rgb",notation:"func",type:"int"},stringifier:Ad},{format:{alpha:!0,mode:"rgb",notation:"func",type:"int"},stringifier:Ys},{format:{alpha:!1,mode:"hsl",notation:"func",type:"int"},stringifier:Dy},{format:{alpha:!0,mode:"hsl",notation:"func",type:"int"},stringifier:Iy},...["int","float"].reduce((n,t)=>[...n,{format:{alpha:!1,mode:"rgb",notation:"object",type:t},stringifier:Uy(t)},{format:{alpha:!0,mode:"rgb",notation:"object",type:t},stringifier:Ny(t)}],[])];function Ld(n){return Fy.reduce((t,e)=>t||(vy(e.format,n)?e.stringifier:null),null)}const Lr=Xt("apl");class Oy{constructor(t,e){this.onValueChange_=this.onValueChange_.bind(this),this.value=e.value,this.value.emitter.on("change",this.onValueChange_),this.element=t.createElement("div"),this.element.classList.add(Lr()),e.viewProps.bindClassModifiers(this.element),e.viewProps.bindTabIndex(this.element);const i=t.createElement("div");i.classList.add(Lr("b")),this.element.appendChild(i);const r=t.createElement("div");r.classList.add(Lr("c")),i.appendChild(r),this.colorElem_=r;const s=t.createElement("div");s.classList.add(Lr("m")),this.element.appendChild(s),this.markerElem_=s;const o=t.createElement("div");o.classList.add(Lr("p")),this.markerElem_.appendChild(o),this.previewElem_=o,this.update_()}update_(){const t=this.value.rawValue,e=t.getComponents("rgb"),i=new qt([e[0],e[1],e[2],0],"rgb"),r=new qt([e[0],e[1],e[2],255],"rgb"),s=["to right",Ys(i),Ys(r)];this.colorElem_.style.background=`linear-gradient(${s.join(",")})`,this.previewElem_.style.backgroundColor=Ys(t);const o=$t(e[3],0,1,0,100);this.markerElem_.style.left=`${o}%`}onValueChange_(){this.update_()}}class ky{constructor(t,e){this.onKeyDown_=this.onKeyDown_.bind(this),this.onKeyUp_=this.onKeyUp_.bind(this),this.onPointerDown_=this.onPointerDown_.bind(this),this.onPointerMove_=this.onPointerMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.value=e.value,this.viewProps=e.viewProps,this.view=new Oy(t,{value:this.value,viewProps:this.viewProps}),this.ptHandler_=new Li(this.view.element),this.ptHandler_.emitter.on("down",this.onPointerDown_),this.ptHandler_.emitter.on("move",this.onPointerMove_),this.ptHandler_.emitter.on("up",this.onPointerUp_),this.view.element.addEventListener("keydown",this.onKeyDown_),this.view.element.addEventListener("keyup",this.onKeyUp_)}handlePointerEvent_(t,e){if(!t.point)return;const i=t.point.x/t.bounds.width,r=this.value.rawValue,[s,o,a]=r.getComponents("hsv");this.value.setRawValue(new qt([s,o,a,i],"hsv"),e)}onPointerDown_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerMove_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerUp_(t){this.handlePointerEvent_(t.data,{forceEmit:!0,last:!0})}onKeyDown_(t){const e=Oe(Si(!0),kn(t));if(e===0)return;const i=this.value.rawValue,[r,s,o,a]=i.getComponents("hsv");this.value.setRawValue(new qt([r,s,o,a+e],"hsv"),{forceEmit:!1,last:!1})}onKeyUp_(t){Oe(Si(!0),kn(t))!==0&&this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}}const qi=Xt("coltxt");function By(n){const t=n.createElement("select"),e=[{text:"RGB",value:"rgb"},{text:"HSL",value:"hsl"},{text:"HSV",value:"hsv"},{text:"HEX",value:"hex"}];return t.appendChild(e.reduce((i,r)=>{const s=n.createElement("option");return s.textContent=r.text,s.value=r.value,i.appendChild(s),i},n.createDocumentFragment())),t}class Vy{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(qi()),e.viewProps.bindClassModifiers(this.element);const i=t.createElement("div");i.classList.add(qi("m")),this.modeElem_=By(t),this.modeElem_.classList.add(qi("ms")),i.appendChild(this.modeSelectElement),e.viewProps.bindDisabled(this.modeElem_);const r=t.createElement("div");r.classList.add(qi("mm")),r.appendChild(_o(t,"dropdown")),i.appendChild(r),this.element.appendChild(i);const s=t.createElement("div");s.classList.add(qi("w")),this.element.appendChild(s),this.inputsElem_=s,this.inputViews_=e.inputViews,this.applyInputViews_(),In(e.mode,o=>{this.modeElem_.value=o})}get modeSelectElement(){return this.modeElem_}get inputViews(){return this.inputViews_}set inputViews(t){this.inputViews_=t,this.applyInputViews_()}applyInputViews_(){Zu(this.inputsElem_);const t=this.element.ownerDocument;this.inputViews_.forEach(e=>{const i=t.createElement("div");i.classList.add(qi("c")),i.appendChild(e.element),this.inputsElem_.appendChild(i)})}}function zy(n){return Be(n==="float"?2:0)}function Hy(n,t,e){const i=fr(n,t)[e];return new Qr({min:0,max:i})}function Gy(n,t,e){return new ss(n,{arrayPosition:e===0?"fst":e===2?"lst":"mid",parser:t.parser,props:Ut.fromObject({formatter:zy(t.colorType),keyScale:Si(!1),pointerScale:t.colorType==="float"?.01:1}),value:ae(0,{constraint:Hy(t.colorMode,t.colorType,e)}),viewProps:t.viewProps})}function Wy(n,t){const e={colorMode:t.colorMode,colorType:t.colorType,parser:On,viewProps:t.viewProps};return[0,1,2].map(i=>{const r=Gy(n,e,i);return xr({primary:t.value,secondary:r.value,forward(s){return Ie(s,t.colorType).getComponents(t.colorMode)[i]},backward(s,o){const a=t.colorMode,c=Ie(s,t.colorType).getComponents(a);c[i]=o;const h=Bl(vo(vn(c),c[3]),a,t.colorType);return Ie(h,"int")}}),r})}function Xy(n,t){const e=new Wr(n,{parser:as("int"),props:Ut.fromObject({formatter:Vl}),value:ae(qt.black()),viewProps:t.viewProps});return xr({primary:t.value,secondary:e.value,forward:i=>new qt(vn(i.getComponents()),i.mode),backward:(i,r)=>new qt(vo(vn(r.getComponents(i.mode)),i.getComponents()[3]),i.mode)}),[e]}function jy(n){return n!=="hex"}class qy{constructor(t,e){this.onModeSelectChange_=this.onModeSelectChange_.bind(this),this.colorType_=e.colorType,this.value=e.value,this.viewProps=e.viewProps,this.colorMode=ae(this.value.rawValue.mode),this.ccs_=this.createComponentControllers_(t),this.view=new Vy(t,{mode:this.colorMode,inputViews:[this.ccs_[0].view,this.ccs_[1].view,this.ccs_[2].view],viewProps:this.viewProps}),this.view.modeSelectElement.addEventListener("change",this.onModeSelectChange_)}createComponentControllers_(t){const e=this.colorMode.rawValue;return jy(e)?Wy(t,{colorMode:e,colorType:this.colorType_,value:this.value,viewProps:this.viewProps}):Xy(t,{value:this.value,viewProps:this.viewProps})}onModeSelectChange_(t){const e=t.currentTarget;this.colorMode.rawValue=e.value,this.ccs_=this.createComponentControllers_(this.view.element.ownerDocument),this.view.inputViews=this.ccs_.map(i=>i.view)}}const oa=Xt("hpl");class Yy{constructor(t,e){this.onValueChange_=this.onValueChange_.bind(this),this.value=e.value,this.value.emitter.on("change",this.onValueChange_),this.element=t.createElement("div"),this.element.classList.add(oa()),e.viewProps.bindClassModifiers(this.element),e.viewProps.bindTabIndex(this.element);const i=t.createElement("div");i.classList.add(oa("c")),this.element.appendChild(i);const r=t.createElement("div");r.classList.add(oa("m")),this.element.appendChild(r),this.markerElem_=r,this.update_()}update_(){const t=this.value.rawValue,[e]=t.getComponents("hsv");this.markerElem_.style.backgroundColor=Ad(new qt([e,100,100],"hsv"));const i=$t(e,0,360,0,100);this.markerElem_.style.left=`${i}%`}onValueChange_(){this.update_()}}class Ky{constructor(t,e){this.onKeyDown_=this.onKeyDown_.bind(this),this.onKeyUp_=this.onKeyUp_.bind(this),this.onPointerDown_=this.onPointerDown_.bind(this),this.onPointerMove_=this.onPointerMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.value=e.value,this.viewProps=e.viewProps,this.view=new Yy(t,{value:this.value,viewProps:this.viewProps}),this.ptHandler_=new Li(this.view.element),this.ptHandler_.emitter.on("down",this.onPointerDown_),this.ptHandler_.emitter.on("move",this.onPointerMove_),this.ptHandler_.emitter.on("up",this.onPointerUp_),this.view.element.addEventListener("keydown",this.onKeyDown_),this.view.element.addEventListener("keyup",this.onKeyUp_)}handlePointerEvent_(t,e){if(!t.point)return;const i=$t(ve(t.point.x,0,t.bounds.width),0,t.bounds.width,0,360),r=this.value.rawValue,[,s,o,a]=r.getComponents("hsv");this.value.setRawValue(new qt([i,s,o,a],"hsv"),e)}onPointerDown_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerMove_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerUp_(t){this.handlePointerEvent_(t.data,{forceEmit:!0,last:!0})}onKeyDown_(t){const e=Oe(Si(!1),kn(t));if(e===0)return;const i=this.value.rawValue,[r,s,o,a]=i.getComponents("hsv");this.value.setRawValue(new qt([r+e,s,o,a],"hsv"),{forceEmit:!1,last:!1})}onKeyUp_(t){Oe(Si(!1),kn(t))!==0&&this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}}const aa=Xt("svp"),Xh=64;class $y{constructor(t,e){this.onValueChange_=this.onValueChange_.bind(this),this.value=e.value,this.value.emitter.on("change",this.onValueChange_),this.element=t.createElement("div"),this.element.classList.add(aa()),e.viewProps.bindClassModifiers(this.element),e.viewProps.bindTabIndex(this.element);const i=t.createElement("canvas");i.height=Xh,i.width=Xh,i.classList.add(aa("c")),this.element.appendChild(i),this.canvasElement=i;const r=t.createElement("div");r.classList.add(aa("m")),this.element.appendChild(r),this.markerElem_=r,this.update_()}update_(){const t=K0(this.canvasElement);if(!t)return;const i=this.value.rawValue.getComponents("hsv"),r=this.canvasElement.width,s=this.canvasElement.height,o=t.getImageData(0,0,r,s),a=o.data;for(let h=0;h<s;h++)for(let u=0;u<r;u++){const p=$t(u,0,r,0,100),f=$t(h,0,s,100,0),_=fd(i[0],p,f),v=(h*r+u)*4;a[v]=_[0],a[v+1]=_[1],a[v+2]=_[2],a[v+3]=255}t.putImageData(o,0,0);const l=$t(i[1],0,100,0,100);this.markerElem_.style.left=`${l}%`;const c=$t(i[2],0,100,100,0);this.markerElem_.style.top=`${c}%`}onValueChange_(){this.update_()}}class Zy{constructor(t,e){this.onKeyDown_=this.onKeyDown_.bind(this),this.onKeyUp_=this.onKeyUp_.bind(this),this.onPointerDown_=this.onPointerDown_.bind(this),this.onPointerMove_=this.onPointerMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.value=e.value,this.viewProps=e.viewProps,this.view=new $y(t,{value:this.value,viewProps:this.viewProps}),this.ptHandler_=new Li(this.view.element),this.ptHandler_.emitter.on("down",this.onPointerDown_),this.ptHandler_.emitter.on("move",this.onPointerMove_),this.ptHandler_.emitter.on("up",this.onPointerUp_),this.view.element.addEventListener("keydown",this.onKeyDown_),this.view.element.addEventListener("keyup",this.onKeyUp_)}handlePointerEvent_(t,e){if(!t.point)return;const i=$t(t.point.x,0,t.bounds.width,0,100),r=$t(t.point.y,0,t.bounds.height,100,0),[s,,,o]=this.value.rawValue.getComponents("hsv");this.value.setRawValue(new qt([s,i,r,o],"hsv"),e)}onPointerDown_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerMove_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerUp_(t){this.handlePointerEvent_(t.data,{forceEmit:!0,last:!0})}onKeyDown_(t){hd(t.key)&&t.preventDefault();const[e,i,r,s]=this.value.rawValue.getComponents("hsv"),o=Si(!1),a=Oe(o,kn(t)),l=Oe(o,Xr(t));a===0&&l===0||this.value.setRawValue(new qt([e,i+a,r+l,s],"hsv"),{forceEmit:!1,last:!1})}onKeyUp_(t){const e=Si(!1),i=Oe(e,kn(t)),r=Oe(e,Xr(t));i===0&&r===0||this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}}class Jy{constructor(t,e){this.value=e.value,this.viewProps=e.viewProps,this.hPaletteC_=new Ky(t,{value:this.value,viewProps:this.viewProps}),this.svPaletteC_=new Zy(t,{value:this.value,viewProps:this.viewProps}),this.alphaIcs_=e.supportsAlpha?{palette:new ky(t,{value:this.value,viewProps:this.viewProps}),text:new ss(t,{parser:On,props:Ut.fromObject({pointerScale:.01,keyScale:.1,formatter:Be(2)}),value:ae(0,{constraint:new Qr({min:0,max:1})}),viewProps:this.viewProps})}:null,this.alphaIcs_&&xr({primary:this.value,secondary:this.alphaIcs_.text.value,forward:i=>i.getComponents()[3],backward:(i,r)=>{const s=i.getComponents();return s[3]=r,new qt(s,i.mode)}}),this.textsC_=new qy(t,{colorType:e.colorType,value:this.value,viewProps:this.viewProps}),this.view=new uy(t,{alphaViews:this.alphaIcs_?{palette:this.alphaIcs_.palette.view,text:this.alphaIcs_.text.view}:null,hPaletteView:this.hPaletteC_.view,supportsAlpha:e.supportsAlpha,svPaletteView:this.svPaletteC_.view,textsView:this.textsC_.view,viewProps:this.viewProps})}get textsController(){return this.textsC_}}const la=Xt("colsw");class Qy{constructor(t,e){this.onValueChange_=this.onValueChange_.bind(this),e.value.emitter.on("change",this.onValueChange_),this.value=e.value,this.element=t.createElement("div"),this.element.classList.add(la()),e.viewProps.bindClassModifiers(this.element);const i=t.createElement("div");i.classList.add(la("sw")),this.element.appendChild(i),this.swatchElem_=i;const r=t.createElement("button");r.classList.add(la("b")),e.viewProps.bindDisabled(r),this.element.appendChild(r),this.buttonElement=r,this.update_()}update_(){const t=this.value.rawValue;this.swatchElem_.style.backgroundColor=zl(t)}onValueChange_(){this.update_()}}class tw{constructor(t,e){this.value=e.value,this.viewProps=e.viewProps,this.view=new Qy(t,{value:this.value,viewProps:this.viewProps})}}class Hl{constructor(t,e){this.onButtonBlur_=this.onButtonBlur_.bind(this),this.onButtonClick_=this.onButtonClick_.bind(this),this.onPopupChildBlur_=this.onPopupChildBlur_.bind(this),this.onPopupChildKeydown_=this.onPopupChildKeydown_.bind(this),this.value=e.value,this.viewProps=e.viewProps,this.foldable_=es.create(e.expanded),this.swatchC_=new tw(t,{value:this.value,viewProps:this.viewProps});const i=this.swatchC_.view.buttonElement;i.addEventListener("blur",this.onButtonBlur_),i.addEventListener("click",this.onButtonClick_),this.textC_=new Wr(t,{parser:e.parser,props:Ut.fromObject({formatter:e.formatter}),value:this.value,viewProps:this.viewProps}),this.view=new iy(t,{foldable:this.foldable_,pickerLayout:e.pickerLayout}),this.view.swatchElement.appendChild(this.swatchC_.view.element),this.view.textElement.appendChild(this.textC_.view.element),this.popC_=e.pickerLayout==="popup"?new ad(t,{viewProps:this.viewProps}):null;const r=new Jy(t,{colorType:e.colorType,supportsAlpha:e.supportsAlpha,value:this.value,viewProps:this.viewProps});r.view.allFocusableElements.forEach(s=>{s.addEventListener("blur",this.onPopupChildBlur_),s.addEventListener("keydown",this.onPopupChildKeydown_)}),this.pickerC_=r,this.popC_?(this.view.element.appendChild(this.popC_.view.element),this.popC_.view.element.appendChild(r.view.element),xr({primary:this.foldable_.value("expanded"),secondary:this.popC_.shows,forward:s=>s,backward:(s,o)=>o})):this.view.pickerElement&&(this.view.pickerElement.appendChild(this.pickerC_.view.element),Il(this.foldable_,this.view.pickerElement))}get textController(){return this.textC_}onButtonBlur_(t){if(!this.popC_)return;const e=this.view.element,i=t.relatedTarget;(!i||!e.contains(i))&&(this.popC_.shows.rawValue=!1)}onButtonClick_(){this.foldable_.set("expanded",!this.foldable_.get("expanded")),this.foldable_.get("expanded")&&this.pickerC_.view.allFocusableElements[0].focus()}onPopupChildBlur_(t){if(!this.popC_)return;const e=this.popC_.view.element,i=Ju(t);i&&e.contains(i)||i&&i===this.swatchC_.view.buttonElement&&!Cl(e.ownerDocument)||(this.popC_.shows.rawValue=!1)}onPopupChildKeydown_(t){this.popC_?t.key==="Escape"&&(this.popC_.shows.rawValue=!1):this.view.pickerElement&&t.key==="Escape"&&this.swatchC_.view.buttonElement.focus()}}function ew(n){return vn(n.getComponents("rgb")).reduce((t,e)=>t<<8|Math.floor(e)&255,0)}function nw(n){return n.getComponents("rgb").reduce((t,e,i)=>{const r=Math.floor(i===3?e*255:e)&255;return t<<8|r},0)>>>0}function iw(n){return new qt([n>>16&255,n>>8&255,n&255],"rgb")}function rw(n){return new qt([n>>24&255,n>>16&255,n>>8&255,$t(n&255,0,255,0,1)],"rgb")}function sw(n){return typeof n!="number"?qt.black():iw(n)}function ow(n){return typeof n!="number"?qt.black():rw(n)}function Ks(n,t){return typeof n!="object"||ie(n)?!1:t in n&&typeof n[t]=="number"}function Dd(n){return Ks(n,"r")&&Ks(n,"g")&&Ks(n,"b")}function Id(n){return Dd(n)&&Ks(n,"a")}function Ud(n){return Dd(n)}function Gl(n,t){if(n.mode!==t.mode||n.type!==t.type)return!1;const e=n.getComponents(),i=t.getComponents();for(let r=0;r<e.length;r++)if(e[r]!==i[r])return!1;return!0}function jh(n){return"a"in n?[n.r,n.g,n.b,n.a]:[n.r,n.g,n.b]}function aw(n){const t=Ld(n);return t?(e,i)=>{os(e,t(i))}:null}function lw(n){const t=n?nw:ew;return(e,i)=>{os(e,t(i))}}function cw(n,t,e){const r=Ie(t,e).toRgbaObject();n.writeProperty("r",r.r),n.writeProperty("g",r.g),n.writeProperty("b",r.b),n.writeProperty("a",r.a)}function hw(n,t,e){const r=Ie(t,e).toRgbaObject();n.writeProperty("r",r.r),n.writeProperty("g",r.g),n.writeProperty("b",r.b)}function uw(n,t){return(e,i)=>{n?cw(e,i,t):hw(e,i,t)}}function dw(n){var t;return!!(!((t=n==null?void 0:n.color)===null||t===void 0)&&t.alpha)}function pw(n){return n?t=>zl(t,"0x"):t=>Vl(t,"0x")}function fw(n){return"color"in n||n.view==="color"}const mw=Ue({id:"input-color-number",type:"input",accept:(n,t)=>{if(typeof n!="number"||!fw(t))return null;const e=Ol(t);return e?{initialValue:n,params:Object.assign(Object.assign({},e),{supportsAlpha:dw(t)})}:null},binding:{reader:n=>n.params.supportsAlpha?ow:sw,equals:Gl,writer:n=>lw(n.params.supportsAlpha)},controller:n=>{var t,e;return new Hl(n.document,{colorType:"int",expanded:(t=n.params.expanded)!==null&&t!==void 0?t:!1,formatter:pw(n.params.supportsAlpha),parser:as("int"),pickerLayout:(e=n.params.picker)!==null&&e!==void 0?e:"popup",supportsAlpha:n.params.supportsAlpha,value:n.value,viewProps:n.viewProps})}});function _w(n,t){if(!Ud(n))return Ie(qt.black(),t);if(t==="int"){const e=jh(n);return new qt(e,"rgb")}if(t==="float"){const e=jh(n);return new kl(e,"rgb")}return Ie(qt.black(),"int")}function gw(n){return Id(n)}function vw(n){return t=>{const e=_w(t,n);return Ie(e,"int")}}function bw(n,t){return e=>n?Rd(e,t):Pd(e,t)}const xw=Ue({id:"input-color-object",type:"input",accept:(n,t)=>{var e;if(!Ud(n))return null;const i=Ol(t);return i?{initialValue:n,params:Object.assign(Object.assign({},i),{colorType:(e=gd(t))!==null&&e!==void 0?e:"int"})}:null},binding:{reader:n=>vw(n.params.colorType),equals:Gl,writer:n=>uw(gw(n.initialValue),n.params.colorType)},controller:n=>{var t,e;const i=Id(n.initialValue);return new Hl(n.document,{colorType:n.params.colorType,expanded:(t=n.params.expanded)!==null&&t!==void 0?t:!1,formatter:bw(i,n.params.colorType),parser:as("int"),pickerLayout:(e=n.params.picker)!==null&&e!==void 0?e:"popup",supportsAlpha:i,value:n.value,viewProps:n.viewProps})}}),yw=Ue({id:"input-color-string",type:"input",accept:(n,t)=>{if(typeof n!="string"||t.view==="text")return null;const e=Ry(n,gd(t));if(!e)return null;const i=Ld(e);if(!i)return null;const r=Ol(t);return r?{initialValue:n,params:Object.assign(Object.assign({},r),{format:e,stringifier:i})}:null},binding:{reader:()=>Ly,equals:Gl,writer:n=>{const t=aw(n.params.format);if(!t)throw de.notBindable();return t}},controller:n=>{var t,e;return new Hl(n.document,{colorType:n.params.format.type,expanded:(t=n.params.expanded)!==null&&t!==void 0?t:!1,formatter:n.params.stringifier,parser:as("int"),pickerLayout:(e=n.params.picker)!==null&&e!==void 0?e:"popup",supportsAlpha:n.params.format.alpha,value:n.value,viewProps:n.viewProps})}});class Wl{constructor(t){this.components=t.components,this.asm_=t.assembly}constrain(t){const e=this.asm_.toComponents(t).map((i,r)=>{var s,o;return(o=(s=this.components[r])===null||s===void 0?void 0:s.constrain(i))!==null&&o!==void 0?o:i});return this.asm_.fromComponents(e)}}const qh=Xt("pndtxt");class ww{constructor(t,e){this.textViews=e.textViews,this.element=t.createElement("div"),this.element.classList.add(qh()),this.textViews.forEach(i=>{const r=t.createElement("div");r.classList.add(qh("a")),r.appendChild(i.element),this.element.appendChild(r)})}}function Ew(n,t,e){return new ss(n,{arrayPosition:e===0?"fst":e===t.axes.length-1?"lst":"mid",parser:t.parser,props:t.axes[e].textProps,value:ae(0,{constraint:t.axes[e].constraint}),viewProps:t.viewProps})}class Xl{constructor(t,e){this.value=e.value,this.viewProps=e.viewProps,this.acs_=e.axes.map((i,r)=>Ew(t,e,r)),this.acs_.forEach((i,r)=>{xr({primary:this.value,secondary:i.value,forward:s=>e.assembly.toComponents(s)[r],backward:(s,o)=>{const a=e.assembly.toComponents(s);return a[r]=o,e.assembly.fromComponents(a)}})}),this.view=new ww(t,{textViews:this.acs_.map(i=>i.view)})}get textControllers(){return this.acs_}}class Mw extends Gr{get max(){return this.controller.valueController.sliderController.props.get("max")}set max(t){this.controller.valueController.sliderController.props.set("max",t)}get min(){return this.controller.valueController.sliderController.props.get("min")}set min(t){this.controller.valueController.sliderController.props.set("min",t)}}function Sw(n,t){const e=[],i=Xu(n,t);i&&e.push(i);const r=ju(n);r&&e.push(r);const s=Fl(n.options);return s&&e.push(s),new ns(e)}const Tw=Ue({id:"input-number",type:"input",accept:(n,t)=>{if(typeof n!="number")return null;const e=ce(t,i=>Object.assign(Object.assign({},Yu(i)),{options:i.optional.custom(rs),readonly:i.optional.constant(!1)}));return e?{initialValue:n,params:e}:null},binding:{reader:n=>zu,constraint:n=>Sw(n.params,n.initialValue),writer:n=>os},controller:n=>{const t=n.value,e=n.constraint,i=e&&oo(e,is);if(i)return new ii(n.document,{props:new Ut({options:i.values.value("options")}),value:t,viewProps:n.viewProps});const r=qu(n.params,t.rawValue),s=e&&oo(e,Qr);return s?new lo(n.document,Object.assign(Object.assign({},ud(Object.assign(Object.assign({},r),{keyScale:ae(r.keyScale),max:s.values.value("max"),min:s.values.value("min")}))),{parser:On,value:t,viewProps:n.viewProps})):new ss(n.document,{parser:On,props:Ut.fromObject(r),value:t,viewProps:n.viewProps})},api(n){return typeof n.controller.value.rawValue!="number"?null:n.controller.valueController instanceof lo?new Mw(n.controller):n.controller.valueController instanceof ii?new Ul(n.controller):null}});class ti{constructor(t=0,e=0){this.x=t,this.y=e}getComponents(){return[this.x,this.y]}static isObject(t){if(ie(t))return!1;const e=t.x,i=t.y;return!(typeof e!="number"||typeof i!="number")}static equals(t,e){return t.x===e.x&&t.y===e.y}toObject(){return{x:this.x,y:this.y}}}const Nd={toComponents:n=>n.getComponents(),fromComponents:n=>new ti(...n)},Yi=Xt("p2d");class Cw{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(Yi()),e.viewProps.bindClassModifiers(this.element),In(e.expanded,gr(this.element,Yi(void 0,"expanded")));const i=t.createElement("div");i.classList.add(Yi("h")),this.element.appendChild(i);const r=t.createElement("button");r.classList.add(Yi("b")),r.appendChild(_o(t,"p2dpad")),e.viewProps.bindDisabled(r),i.appendChild(r),this.buttonElement=r;const s=t.createElement("div");if(s.classList.add(Yi("t")),i.appendChild(s),this.textElement=s,e.pickerLayout==="inline"){const o=t.createElement("div");o.classList.add(Yi("p")),this.element.appendChild(o),this.pickerElement=o}else this.pickerElement=null}}const qn=Xt("p2dp");class Aw{constructor(t,e){this.onFoldableChange_=this.onFoldableChange_.bind(this),this.onPropsChange_=this.onPropsChange_.bind(this),this.onValueChange_=this.onValueChange_.bind(this),this.props_=e.props,this.props_.emitter.on("change",this.onPropsChange_),this.element=t.createElement("div"),this.element.classList.add(qn()),e.layout==="popup"&&this.element.classList.add(qn(void 0,"p")),e.viewProps.bindClassModifiers(this.element);const i=t.createElement("div");i.classList.add(qn("p")),e.viewProps.bindTabIndex(i),this.element.appendChild(i),this.padElement=i;const r=t.createElementNS(fn,"svg");r.classList.add(qn("g")),this.padElement.appendChild(r),this.svgElem_=r;const s=t.createElementNS(fn,"line");s.classList.add(qn("ax")),s.setAttributeNS(null,"x1","0"),s.setAttributeNS(null,"y1","50%"),s.setAttributeNS(null,"x2","100%"),s.setAttributeNS(null,"y2","50%"),this.svgElem_.appendChild(s);const o=t.createElementNS(fn,"line");o.classList.add(qn("ax")),o.setAttributeNS(null,"x1","50%"),o.setAttributeNS(null,"y1","0"),o.setAttributeNS(null,"x2","50%"),o.setAttributeNS(null,"y2","100%"),this.svgElem_.appendChild(o);const a=t.createElementNS(fn,"line");a.classList.add(qn("l")),a.setAttributeNS(null,"x1","50%"),a.setAttributeNS(null,"y1","50%"),this.svgElem_.appendChild(a),this.lineElem_=a;const l=t.createElement("div");l.classList.add(qn("m")),this.padElement.appendChild(l),this.markerElem_=l,e.value.emitter.on("change",this.onValueChange_),this.value=e.value,this.update_()}get allFocusableElements(){return[this.padElement]}update_(){const[t,e]=this.value.rawValue.getComponents(),i=this.props_.get("max"),r=$t(t,-i,+i,0,100),s=$t(e,-i,+i,0,100),o=this.props_.get("invertsY")?100-s:s;this.lineElem_.setAttributeNS(null,"x2",`${r}%`),this.lineElem_.setAttributeNS(null,"y2",`${o}%`),this.markerElem_.style.left=`${r}%`,this.markerElem_.style.top=`${o}%`}onValueChange_(){this.update_()}onPropsChange_(){this.update_()}onFoldableChange_(){this.update_()}}function Yh(n,t,e){return[Oe(t[0],kn(n)),Oe(t[1],Xr(n))*(e?1:-1)]}class Pw{constructor(t,e){this.onPadKeyDown_=this.onPadKeyDown_.bind(this),this.onPadKeyUp_=this.onPadKeyUp_.bind(this),this.onPointerDown_=this.onPointerDown_.bind(this),this.onPointerMove_=this.onPointerMove_.bind(this),this.onPointerUp_=this.onPointerUp_.bind(this),this.props=e.props,this.value=e.value,this.viewProps=e.viewProps,this.view=new Aw(t,{layout:e.layout,props:this.props,value:this.value,viewProps:this.viewProps}),this.ptHandler_=new Li(this.view.padElement),this.ptHandler_.emitter.on("down",this.onPointerDown_),this.ptHandler_.emitter.on("move",this.onPointerMove_),this.ptHandler_.emitter.on("up",this.onPointerUp_),this.view.padElement.addEventListener("keydown",this.onPadKeyDown_),this.view.padElement.addEventListener("keyup",this.onPadKeyUp_)}handlePointerEvent_(t,e){if(!t.point)return;const i=this.props.get("max"),r=$t(t.point.x,0,t.bounds.width,-i,+i),s=$t(this.props.get("invertsY")?t.bounds.height-t.point.y:t.point.y,0,t.bounds.height,-i,+i);this.value.setRawValue(new ti(r,s),e)}onPointerDown_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerMove_(t){this.handlePointerEvent_(t.data,{forceEmit:!1,last:!1})}onPointerUp_(t){this.handlePointerEvent_(t.data,{forceEmit:!0,last:!0})}onPadKeyDown_(t){hd(t.key)&&t.preventDefault();const[e,i]=Yh(t,[this.props.get("xKeyScale"),this.props.get("yKeyScale")],this.props.get("invertsY"));e===0&&i===0||this.value.setRawValue(new ti(this.value.rawValue.x+e,this.value.rawValue.y+i),{forceEmit:!1,last:!1})}onPadKeyUp_(t){const[e,i]=Yh(t,[this.props.get("xKeyScale"),this.props.get("yKeyScale")],this.props.get("invertsY"));e===0&&i===0||this.value.setRawValue(this.value.rawValue,{forceEmit:!0,last:!0})}}class Rw{constructor(t,e){var i,r;this.onPopupChildBlur_=this.onPopupChildBlur_.bind(this),this.onPopupChildKeydown_=this.onPopupChildKeydown_.bind(this),this.onPadButtonBlur_=this.onPadButtonBlur_.bind(this),this.onPadButtonClick_=this.onPadButtonClick_.bind(this),this.value=e.value,this.viewProps=e.viewProps,this.foldable_=es.create(e.expanded),this.popC_=e.pickerLayout==="popup"?new ad(t,{viewProps:this.viewProps}):null;const s=new Pw(t,{layout:e.pickerLayout,props:new Ut({invertsY:ae(e.invertsY),max:ae(e.max),xKeyScale:e.axes[0].textProps.value("keyScale"),yKeyScale:e.axes[1].textProps.value("keyScale")}),value:this.value,viewProps:this.viewProps});s.view.allFocusableElements.forEach(o=>{o.addEventListener("blur",this.onPopupChildBlur_),o.addEventListener("keydown",this.onPopupChildKeydown_)}),this.pickerC_=s,this.textC_=new Xl(t,{assembly:Nd,axes:e.axes,parser:e.parser,value:this.value,viewProps:this.viewProps}),this.view=new Cw(t,{expanded:this.foldable_.value("expanded"),pickerLayout:e.pickerLayout,viewProps:this.viewProps}),this.view.textElement.appendChild(this.textC_.view.element),(i=this.view.buttonElement)===null||i===void 0||i.addEventListener("blur",this.onPadButtonBlur_),(r=this.view.buttonElement)===null||r===void 0||r.addEventListener("click",this.onPadButtonClick_),this.popC_?(this.view.element.appendChild(this.popC_.view.element),this.popC_.view.element.appendChild(this.pickerC_.view.element),xr({primary:this.foldable_.value("expanded"),secondary:this.popC_.shows,forward:o=>o,backward:(o,a)=>a})):this.view.pickerElement&&(this.view.pickerElement.appendChild(this.pickerC_.view.element),Il(this.foldable_,this.view.pickerElement))}get textController(){return this.textC_}onPadButtonBlur_(t){if(!this.popC_)return;const e=this.view.element,i=t.relatedTarget;(!i||!e.contains(i))&&(this.popC_.shows.rawValue=!1)}onPadButtonClick_(){this.foldable_.set("expanded",!this.foldable_.get("expanded")),this.foldable_.get("expanded")&&this.pickerC_.view.allFocusableElements[0].focus()}onPopupChildBlur_(t){if(!this.popC_)return;const e=this.popC_.view.element,i=Ju(t);i&&e.contains(i)||i&&i===this.view.buttonElement&&!Cl(e.ownerDocument)||(this.popC_.shows.rawValue=!1)}onPopupChildKeydown_(t){this.popC_?t.key==="Escape"&&(this.popC_.shows.rawValue=!1):this.view.pickerElement&&t.key==="Escape"&&this.view.buttonElement.focus()}}function Lw(n){return ti.isObject(n)?new ti(n.x,n.y):new ti}function Dw(n,t){n.writeProperty("x",t.x),n.writeProperty("y",t.y)}function Iw(n,t){return new Wl({assembly:Nd,components:[Ln(Object.assign(Object.assign({},n),n.x),t.x),Ln(Object.assign(Object.assign({},n),n.y),t.y)]})}function Kh(n,t){var e,i;if(!ie(n.min)||!ie(n.max))return Math.max(Math.abs((e=n.min)!==null&&e!==void 0?e:0),Math.abs((i=n.max)!==null&&i!==void 0?i:0));const r=Gu(n);return Math.max(Math.abs(r)*10,Math.abs(t)*10)}function Uw(n,t){var e,i;const r=Kh(Ei(n,(e=n.x)!==null&&e!==void 0?e:{}),t.x),s=Kh(Ei(n,(i=n.y)!==null&&i!==void 0?i:{}),t.y);return Math.max(r,s)}function Nw(n){if(!("y"in n))return!1;const t=n.y;return t&&"inverted"in t?!!t.inverted:!1}const Fw=Ue({id:"input-point2d",type:"input",accept:(n,t)=>{if(!ti.isObject(n))return null;const e=ce(t,i=>Object.assign(Object.assign({},jr(i)),{expanded:i.optional.boolean,picker:i.optional.custom(pd),readonly:i.optional.constant(!1),x:i.optional.custom(Zn),y:i.optional.object(Object.assign(Object.assign({},jr(i)),{inverted:i.optional.boolean}))}));return e?{initialValue:n,params:e}:null},binding:{reader:()=>Lw,constraint:n=>Iw(n.params,n.initialValue),equals:ti.equals,writer:()=>Dw},controller:n=>{var t,e;const i=n.document,r=n.value,s=n.constraint,o=[n.params.x,n.params.y];return new Rw(i,{axes:r.rawValue.getComponents().map((a,l)=>{var c;return Tl({constraint:s.components[l],initialValue:a,params:Ei(n.params,(c=o[l])!==null&&c!==void 0?c:{})})}),expanded:(t=n.params.expanded)!==null&&t!==void 0?t:!1,invertsY:Nw(n.params),max:Uw(n.params,r.rawValue),parser:On,pickerLayout:(e=n.params.picker)!==null&&e!==void 0?e:"popup",value:r,viewProps:n.viewProps})}});class rr{constructor(t=0,e=0,i=0){this.x=t,this.y=e,this.z=i}getComponents(){return[this.x,this.y,this.z]}static isObject(t){if(ie(t))return!1;const e=t.x,i=t.y,r=t.z;return!(typeof e!="number"||typeof i!="number"||typeof r!="number")}static equals(t,e){return t.x===e.x&&t.y===e.y&&t.z===e.z}toObject(){return{x:this.x,y:this.y,z:this.z}}}const Fd={toComponents:n=>n.getComponents(),fromComponents:n=>new rr(...n)};function Ow(n){return rr.isObject(n)?new rr(n.x,n.y,n.z):new rr}function kw(n,t){n.writeProperty("x",t.x),n.writeProperty("y",t.y),n.writeProperty("z",t.z)}function Bw(n,t){return new Wl({assembly:Fd,components:[Ln(Object.assign(Object.assign({},n),n.x),t.x),Ln(Object.assign(Object.assign({},n),n.y),t.y),Ln(Object.assign(Object.assign({},n),n.z),t.z)]})}const Vw=Ue({id:"input-point3d",type:"input",accept:(n,t)=>{if(!rr.isObject(n))return null;const e=ce(t,i=>Object.assign(Object.assign({},jr(i)),{readonly:i.optional.constant(!1),x:i.optional.custom(Zn),y:i.optional.custom(Zn),z:i.optional.custom(Zn)}));return e?{initialValue:n,params:e}:null},binding:{reader:n=>Ow,constraint:n=>Bw(n.params,n.initialValue),equals:rr.equals,writer:n=>kw},controller:n=>{const t=n.value,e=n.constraint,i=[n.params.x,n.params.y,n.params.z];return new Xl(n.document,{assembly:Fd,axes:t.rawValue.getComponents().map((r,s)=>{var o;return Tl({constraint:e.components[s],initialValue:r,params:Ei(n.params,(o=i[s])!==null&&o!==void 0?o:{})})}),parser:On,value:t,viewProps:n.viewProps})}});class sr{constructor(t=0,e=0,i=0,r=0){this.x=t,this.y=e,this.z=i,this.w=r}getComponents(){return[this.x,this.y,this.z,this.w]}static isObject(t){if(ie(t))return!1;const e=t.x,i=t.y,r=t.z,s=t.w;return!(typeof e!="number"||typeof i!="number"||typeof r!="number"||typeof s!="number")}static equals(t,e){return t.x===e.x&&t.y===e.y&&t.z===e.z&&t.w===e.w}toObject(){return{x:this.x,y:this.y,z:this.z,w:this.w}}}const Od={toComponents:n=>n.getComponents(),fromComponents:n=>new sr(...n)};function zw(n){return sr.isObject(n)?new sr(n.x,n.y,n.z,n.w):new sr}function Hw(n,t){n.writeProperty("x",t.x),n.writeProperty("y",t.y),n.writeProperty("z",t.z),n.writeProperty("w",t.w)}function Gw(n,t){return new Wl({assembly:Od,components:[Ln(Object.assign(Object.assign({},n),n.x),t.x),Ln(Object.assign(Object.assign({},n),n.y),t.y),Ln(Object.assign(Object.assign({},n),n.z),t.z),Ln(Object.assign(Object.assign({},n),n.w),t.w)]})}const Ww=Ue({id:"input-point4d",type:"input",accept:(n,t)=>{if(!sr.isObject(n))return null;const e=ce(t,i=>Object.assign(Object.assign({},jr(i)),{readonly:i.optional.constant(!1),w:i.optional.custom(Zn),x:i.optional.custom(Zn),y:i.optional.custom(Zn),z:i.optional.custom(Zn)}));return e?{initialValue:n,params:e}:null},binding:{reader:n=>zw,constraint:n=>Gw(n.params,n.initialValue),equals:sr.equals,writer:n=>Hw},controller:n=>{const t=n.value,e=n.constraint,i=[n.params.x,n.params.y,n.params.z,n.params.w];return new Xl(n.document,{assembly:Od,axes:t.rawValue.getComponents().map((r,s)=>{var o;return Tl({constraint:e.components[s],initialValue:r,params:Ei(n.params,(o=i[s])!==null&&o!==void 0?o:{})})}),parser:On,value:t,viewProps:n.viewProps})}});function Xw(n){const t=[],e=Fl(n.options);return e&&t.push(e),new ns(t)}const jw=Ue({id:"input-string",type:"input",accept:(n,t)=>{if(typeof n!="string")return null;const e=ce(t,i=>({readonly:i.optional.constant(!1),options:i.optional.custom(rs)}));return e?{initialValue:n,params:e}:null},binding:{reader:n=>cd,constraint:n=>Xw(n.params),writer:n=>os},controller:n=>{const t=n.document,e=n.value,i=n.constraint,r=i&&oo(i,is);return r?new ii(t,{props:new Ut({options:r.values.value("options")}),value:e,viewProps:n.viewProps}):new Wr(t,{parser:s=>s,props:Ut.fromObject({formatter:nl}),value:e,viewProps:n.viewProps})},api(n){return typeof n.controller.value.rawValue!="string"?null:n.controller.valueController instanceof ii?new Ul(n.controller):null}}),ls={monitor:{defaultInterval:200,defaultRows:3}},$h=Xt("mll");class qw{constructor(t,e){this.onValueUpdate_=this.onValueUpdate_.bind(this),this.formatter_=e.formatter,this.element=t.createElement("div"),this.element.classList.add($h()),e.viewProps.bindClassModifiers(this.element);const i=t.createElement("textarea");i.classList.add($h("i")),i.style.height=`calc(var(${dd("containerUnitSize")}) * ${e.rows})`,i.readOnly=!0,e.viewProps.bindDisabled(i),this.element.appendChild(i),this.textareaElem_=i,e.value.emitter.on("change",this.onValueUpdate_),this.value=e.value,this.update_()}update_(){const t=this.textareaElem_,e=t.scrollTop===t.scrollHeight-t.clientHeight,i=[];this.value.rawValue.forEach(r=>{r!==void 0&&i.push(this.formatter_(r))}),t.textContent=i.join(`
`),e&&(t.scrollTop=t.scrollHeight)}onValueUpdate_(){this.update_()}}class jl{constructor(t,e){this.value=e.value,this.viewProps=e.viewProps,this.view=new qw(t,{formatter:e.formatter,rows:e.rows,value:this.value,viewProps:this.viewProps})}}const Zh=Xt("sgl");class Yw{constructor(t,e){this.onValueUpdate_=this.onValueUpdate_.bind(this),this.formatter_=e.formatter,this.element=t.createElement("div"),this.element.classList.add(Zh()),e.viewProps.bindClassModifiers(this.element);const i=t.createElement("input");i.classList.add(Zh("i")),i.readOnly=!0,i.type="text",e.viewProps.bindDisabled(i),this.element.appendChild(i),this.inputElement=i,e.value.emitter.on("change",this.onValueUpdate_),this.value=e.value,this.update_()}update_(){const t=this.value.rawValue,e=t[t.length-1];this.inputElement.value=e!==void 0?this.formatter_(e):""}onValueUpdate_(){this.update_()}}class ql{constructor(t,e){this.value=e.value,this.viewProps=e.viewProps,this.view=new Yw(t,{formatter:e.formatter,value:this.value,viewProps:this.viewProps})}}const Kw=Ue({id:"monitor-bool",type:"monitor",accept:(n,t)=>{if(typeof n!="boolean")return null;const e=ce(t,i=>({readonly:i.required.constant(!0),rows:i.optional.number}));return e?{initialValue:n,params:e}:null},binding:{reader:n=>ld},controller:n=>{var t;return n.value.rawValue.length===1?new ql(n.document,{formatter:Gh,value:n.value,viewProps:n.viewProps}):new jl(n.document,{formatter:Gh,rows:(t=n.params.rows)!==null&&t!==void 0?t:ls.monitor.defaultRows,value:n.value,viewProps:n.viewProps})}});class $w extends Gr{get max(){return this.controller.valueController.props.get("max")}set max(t){this.controller.valueController.props.set("max",t)}get min(){return this.controller.valueController.props.get("min")}set min(t){this.controller.valueController.props.set("min",t)}}const Yn=Xt("grl");class Zw{constructor(t,e){this.onCursorChange_=this.onCursorChange_.bind(this),this.onValueUpdate_=this.onValueUpdate_.bind(this),this.element=t.createElement("div"),this.element.classList.add(Yn()),e.viewProps.bindClassModifiers(this.element),this.formatter_=e.formatter,this.props_=e.props,this.cursor_=e.cursor,this.cursor_.emitter.on("change",this.onCursorChange_);const i=t.createElementNS(fn,"svg");i.classList.add(Yn("g")),i.style.height=`calc(var(${dd("containerUnitSize")}) * ${e.rows})`,this.element.appendChild(i),this.svgElem_=i;const r=t.createElementNS(fn,"polyline");this.svgElem_.appendChild(r),this.lineElem_=r;const s=t.createElement("div");s.classList.add(Yn("t"),Xt("tt")()),this.element.appendChild(s),this.tooltipElem_=s,e.value.emitter.on("change",this.onValueUpdate_),this.value=e.value,this.update_()}get graphElement(){return this.svgElem_}update_(){const{clientWidth:t,clientHeight:e}=this.element,i=this.value.rawValue.length-1,r=this.props_.get("min"),s=this.props_.get("max"),o=[];this.value.rawValue.forEach((u,p)=>{if(u===void 0)return;const f=$t(p,0,i,0,t),_=$t(u,r,s,e,0);o.push([f,_].join(","))}),this.lineElem_.setAttributeNS(null,"points",o.join(" "));const a=this.tooltipElem_,l=this.value.rawValue[this.cursor_.rawValue];if(l===void 0){a.classList.remove(Yn("t","a"));return}const c=$t(this.cursor_.rawValue,0,i,0,t),h=$t(l,r,s,e,0);a.style.left=`${c}px`,a.style.top=`${h}px`,a.textContent=`${this.formatter_(l)}`,a.classList.contains(Yn("t","a"))||(a.classList.add(Yn("t","a"),Yn("t","in")),so(a),a.classList.remove(Yn("t","in")))}onValueUpdate_(){this.update_()}onCursorChange_(){this.update_()}}class kd{constructor(t,e){if(this.onGraphMouseMove_=this.onGraphMouseMove_.bind(this),this.onGraphMouseLeave_=this.onGraphMouseLeave_.bind(this),this.onGraphPointerDown_=this.onGraphPointerDown_.bind(this),this.onGraphPointerMove_=this.onGraphPointerMove_.bind(this),this.onGraphPointerUp_=this.onGraphPointerUp_.bind(this),this.props=e.props,this.value=e.value,this.viewProps=e.viewProps,this.cursor_=ae(-1),this.view=new Zw(t,{cursor:this.cursor_,formatter:e.formatter,rows:e.rows,props:this.props,value:this.value,viewProps:this.viewProps}),!Cl(t))this.view.element.addEventListener("mousemove",this.onGraphMouseMove_),this.view.element.addEventListener("mouseleave",this.onGraphMouseLeave_);else{const i=new Li(this.view.element);i.emitter.on("down",this.onGraphPointerDown_),i.emitter.on("move",this.onGraphPointerMove_),i.emitter.on("up",this.onGraphPointerUp_)}}importProps(t){return je(t,null,e=>({max:e.required.number,min:e.required.number}),e=>(this.props.set("max",e.max),this.props.set("min",e.min),!0))}exportProps(){return qe(null,{max:this.props.get("max"),min:this.props.get("min")})}onGraphMouseLeave_(){this.cursor_.rawValue=-1}onGraphMouseMove_(t){const{clientWidth:e}=this.view.element;this.cursor_.rawValue=Math.floor($t(t.offsetX,0,e,0,this.value.rawValue.length))}onGraphPointerDown_(t){this.onGraphPointerMove_(t)}onGraphPointerMove_(t){if(!t.data.point){this.cursor_.rawValue=-1;return}this.cursor_.rawValue=Math.floor($t(t.data.point.x,0,t.data.bounds.width,0,this.value.rawValue.length))}onGraphPointerUp_(){this.cursor_.rawValue=-1}}function il(n){return ie(n.format)?Be(2):n.format}function Jw(n){var t;return n.value.rawValue.length===1?new ql(n.document,{formatter:il(n.params),value:n.value,viewProps:n.viewProps}):new jl(n.document,{formatter:il(n.params),rows:(t=n.params.rows)!==null&&t!==void 0?t:ls.monitor.defaultRows,value:n.value,viewProps:n.viewProps})}function Qw(n){var t,e,i;return new kd(n.document,{formatter:il(n.params),rows:(t=n.params.rows)!==null&&t!==void 0?t:ls.monitor.defaultRows,props:Ut.fromObject({max:(e=n.params.max)!==null&&e!==void 0?e:100,min:(i=n.params.min)!==null&&i!==void 0?i:0}),value:n.value,viewProps:n.viewProps})}function Jh(n){return n.view==="graph"}const tE=Ue({id:"monitor-number",type:"monitor",accept:(n,t)=>{if(typeof n!="number")return null;const e=ce(t,i=>({format:i.optional.function,max:i.optional.number,min:i.optional.number,readonly:i.required.constant(!0),rows:i.optional.number,view:i.optional.string}));return e?{initialValue:n,params:e}:null},binding:{defaultBufferSize:n=>Jh(n)?64:1,reader:n=>zu},controller:n=>Jh(n.params)?Qw(n):Jw(n),api:n=>n.controller.valueController instanceof kd?new $w(n.controller):null}),eE=Ue({id:"monitor-string",type:"monitor",accept:(n,t)=>{if(typeof n!="string")return null;const e=ce(t,i=>({multiline:i.optional.boolean,readonly:i.required.constant(!0),rows:i.optional.number}));return e?{initialValue:n,params:e}:null},binding:{reader:n=>cd},controller:n=>{var t;const e=n.value;return e.rawValue.length>1||n.params.multiline?new jl(n.document,{formatter:nl,rows:(t=n.params.rows)!==null&&t!==void 0?t:ls.monitor.defaultRows,value:e,viewProps:n.viewProps}):new ql(n.document,{formatter:nl,value:e,viewProps:n.viewProps})}});class nE{constructor(){this.map_=new Map}get(t){var e;return(e=this.map_.get(t))!==null&&e!==void 0?e:null}has(t){return this.map_.has(t)}add(t,e){return this.map_.set(t,e),t.viewProps.handleDispose(()=>{this.map_.delete(t)}),e}}class iE{constructor(t){this.target=t.target,this.reader_=t.reader,this.writer_=t.writer}read(){return this.reader_(this.target.read())}write(t){this.writer_(this.target,t)}inject(t){this.write(this.reader_(t))}}function rE(n,t){var e;const i=n.accept(t.target.read(),t.params);if(ie(i))return null;const r={target:t.target,initialValue:i.initialValue,params:i.params},s=ce(t.params,u=>({disabled:u.optional.boolean,hidden:u.optional.boolean,label:u.optional.string,tag:u.optional.string})),o=n.binding.reader(r),a=n.binding.constraint?n.binding.constraint(r):void 0,l=new iE({reader:o,target:t.target,writer:n.binding.writer(r)}),c=new z0(ae(o(i.initialValue),{constraint:a,equals:n.binding.equals}),l),h=n.controller({constraint:a,document:t.document,initialValue:i.initialValue,params:i.params,value:c,viewProps:Bn.create({disabled:s==null?void 0:s.disabled,hidden:s==null?void 0:s.hidden})});return new nx(t.document,{blade:br(),props:Ut.fromObject({label:"label"in t.params?(e=s==null?void 0:s.label)!==null&&e!==void 0?e:null:t.target.key}),tag:s==null?void 0:s.tag,value:c,valueController:h})}class sE{constructor(t){this.target=t.target,this.reader_=t.reader}read(){return this.reader_(this.target.read())}}function oE(n,t){return t===0?new kx:new Bx(n,t??ls.monitor.defaultInterval)}function aE(n,t){var e,i,r;const s=n.accept(t.target.read(),t.params);if(ie(s))return null;const o={target:t.target,initialValue:s.initialValue,params:s.params},a=ce(t.params,p=>({bufferSize:p.optional.number,disabled:p.optional.boolean,hidden:p.optional.boolean,interval:p.optional.number,label:p.optional.string})),l=n.binding.reader(o),c=(i=(e=a==null?void 0:a.bufferSize)!==null&&e!==void 0?e:n.binding.defaultBufferSize&&n.binding.defaultBufferSize(s.params))!==null&&i!==void 0?i:1,h=new ax({binding:new sE({reader:l,target:t.target}),bufferSize:c,ticker:oE(t.document,a==null?void 0:a.interval)}),u=n.controller({document:t.document,params:s.params,value:h,viewProps:Bn.create({disabled:a==null?void 0:a.disabled,hidden:a==null?void 0:a.hidden})});return u.viewProps.bindDisabled(h.ticker),u.viewProps.handleDispose(()=>{h.ticker.dispose()}),new cx(t.document,{blade:br(),props:Ut.fromObject({label:"label"in t.params?(r=a==null?void 0:a.label)!==null&&r!==void 0?r:null:t.target.key}),value:h,valueController:u})}class lE{constructor(t){this.pluginsMap_={blades:[],inputs:[],monitors:[]},this.apiCache_=t}getAll(){return[...this.pluginsMap_.blades,...this.pluginsMap_.inputs,...this.pluginsMap_.monitors]}register(t,e){if(!Jx(e.core))throw de.notCompatible(t,e.id);e.type==="blade"?this.pluginsMap_.blades.unshift(e):e.type==="input"?this.pluginsMap_.inputs.unshift(e):e.type==="monitor"&&this.pluginsMap_.monitors.unshift(e)}createInput_(t,e,i){return this.pluginsMap_.inputs.reduce((r,s)=>r??rE(s,{document:t,target:e,params:i}),null)}createMonitor_(t,e,i){return this.pluginsMap_.monitors.reduce((r,s)=>r??aE(s,{document:t,params:i,target:e}),null)}createBinding(t,e,i){const r=e.read();if(ie(r))throw new de({context:{key:e.key},type:"nomatchingcontroller"});const s=this.createInput_(t,e,i);if(s)return s;const o=this.createMonitor_(t,e,i);if(o)return o;throw new de({context:{key:e.key},type:"nomatchingcontroller"})}createBlade(t,e){const i=this.pluginsMap_.blades.reduce((r,s)=>r??Ox(s,{document:t,params:e}),null);if(!i)throw new de({type:"nomatchingview",context:{params:e}});return i}createInputBindingApi_(t){const e=this.pluginsMap_.inputs.reduce((i,r)=>{var s,o;return i||((o=(s=r.api)===null||s===void 0?void 0:s.call(r,{controller:t}))!==null&&o!==void 0?o:null)},null);return this.apiCache_.add(t,e??new Gr(t))}createMonitorBindingApi_(t){const e=this.pluginsMap_.monitors.reduce((i,r)=>{var s,o;return i||((o=(s=r.api)===null||s===void 0?void 0:s.call(r,{controller:t}))!==null&&o!==void 0?o:null)},null);return this.apiCache_.add(t,e??new Gr(t))}createBindingApi(t){if(this.apiCache_.has(t))return this.apiCache_.get(t);if(ix(t))return this.createInputBindingApi_(t);if(hx(t))return this.createMonitorBindingApi_(t);throw de.shouldNeverHappen()}createApi(t){if(this.apiCache_.has(t))return this.apiCache_.get(t);if(ex(t))return this.createBindingApi(t);const e=this.pluginsMap_.blades.reduce((i,r)=>i??r.api({controller:t,pool:this}),null);if(!e)throw de.shouldNeverHappen();return this.apiCache_.add(t,e)}}const cE=new nE;function hE(){const n=new lE(cE);return[Fw,Vw,Ww,jw,Tw,yw,xw,mw,ny,Kw,eE,tE,mx,Ax,od].forEach(t=>{n.register("core",t)}),n}class uE extends Ri{constructor(t){super(t),this.emitter_=new _e,this.controller.value.emitter.on("change",e=>{this.emitter_.emit("change",new ts(this,e.rawValue))})}get label(){return this.controller.labelController.props.get("label")}set label(t){this.controller.labelController.props.set("label",t)}get options(){return this.controller.valueController.props.get("options")}set options(t){this.controller.valueController.props.set("options",t)}get value(){return this.controller.value.rawValue}set value(t){this.controller.value.rawValue=t}on(t,e){const i=e.bind(this);return this.emitter_.on(t,r=>{i(r)},{key:e}),this}off(t,e){return this.emitter_.off(t,e),this}}class dE extends Ri{}class pE extends Ri{constructor(t){super(t),this.emitter_=new _e,this.controller.value.emitter.on("change",e=>{this.emitter_.emit("change",new ts(this,e.rawValue))})}get label(){return this.controller.labelController.props.get("label")}set label(t){this.controller.labelController.props.set("label",t)}get max(){return this.controller.valueController.sliderController.props.get("max")}set max(t){this.controller.valueController.sliderController.props.set("max",t)}get min(){return this.controller.valueController.sliderController.props.get("min")}set min(t){this.controller.valueController.sliderController.props.set("min",t)}get value(){return this.controller.value.rawValue}set value(t){this.controller.value.rawValue=t}on(t,e){const i=e.bind(this);return this.emitter_.on(t,r=>{i(r)},{key:e}),this}off(t,e){return this.emitter_.off(t,e),this}}class fE extends Ri{constructor(t){super(t),this.emitter_=new _e,this.controller.value.emitter.on("change",e=>{this.emitter_.emit("change",new ts(this,e.rawValue))})}get label(){return this.controller.labelController.props.get("label")}set label(t){this.controller.labelController.props.set("label",t)}get formatter(){return this.controller.valueController.props.get("formatter")}set formatter(t){this.controller.valueController.props.set("formatter",t)}get value(){return this.controller.value.rawValue}set value(t){this.controller.value.rawValue=t}on(t,e){const i=e.bind(this);return this.emitter_.on(t,r=>{i(r)},{key:e}),this}off(t,e){return this.emitter_.off(t,e),this}}const mE=function(){return{id:"list",type:"blade",core:vr,accept(n){const t=ce(n,e=>({options:e.required.custom(rs),value:e.required.raw,view:e.required.constant("list"),label:e.optional.string}));return t?{params:t}:null},controller(n){const t=new is(Nl(n.params.options)),e=ae(n.params.value,{constraint:t}),i=new ii(n.document,{props:new Ut({options:t.values.value("options")}),value:e,viewProps:n.viewProps});return new Mi(n.document,{blade:n.blade,props:Ut.fromObject({label:n.params.label}),value:e,valueController:i})},api(n){return!(n.controller instanceof Mi)||!(n.controller.valueController instanceof ii)?null:new uE(n.controller)}}}();class _E extends rd{constructor(t,e){super(t,e)}get element(){return this.controller.view.element}}class gE extends tl{constructor(t,e){super(t,{expanded:e.expanded,blade:e.blade,props:e.props,root:!0,viewProps:e.viewProps})}}const Qh=Xt("spr");class vE{constructor(t,e){this.element=t.createElement("div"),this.element.classList.add(Qh()),e.viewProps.bindClassModifiers(this.element);const i=t.createElement("hr");i.classList.add(Qh("r")),this.element.appendChild(i)}}class tu extends go{constructor(t,e){super(Object.assign(Object.assign({},e),{view:new vE(t,{viewProps:e.viewProps})}))}}const bE={id:"separator",type:"blade",core:vr,accept(n){const t=ce(n,e=>({view:e.required.constant("separator")}));return t?{params:t}:null},controller(n){return new tu(n.document,{blade:n.blade,viewProps:n.viewProps})},api(n){return n.controller instanceof tu?new dE(n.controller):null}},xE={id:"slider",type:"blade",core:vr,accept(n){const t=ce(n,e=>({max:e.required.number,min:e.required.number,view:e.required.constant("slider"),format:e.optional.function,label:e.optional.string,value:e.optional.number}));return t?{params:t}:null},controller(n){var t,e;const i=(t=n.params.value)!==null&&t!==void 0?t:0,r=new Qr({max:n.params.max,min:n.params.min}),s=ae(i,{constraint:r}),o=new lo(n.document,Object.assign(Object.assign({},ud({formatter:(e=n.params.format)!==null&&e!==void 0?e:F0,keyScale:ae(1),max:r.values.value("max"),min:r.values.value("min"),pointerScale:Wu(n.params,i)})),{parser:On,value:s,viewProps:n.viewProps}));return new Mi(n.document,{blade:n.blade,props:Ut.fromObject({label:n.params.label}),value:s,valueController:o})},api(n){return!(n.controller instanceof Mi)||!(n.controller.valueController instanceof lo)?null:new pE(n.controller)}},yE=function(){return{id:"text",type:"blade",core:vr,accept(n){const t=ce(n,e=>({parse:e.required.function,value:e.required.raw,view:e.required.constant("text"),format:e.optional.function,label:e.optional.string}));return t?{params:t}:null},controller(n){var t;const e=ae(n.params.value),i=new Wr(n.document,{parser:n.params.parse,props:Ut.fromObject({formatter:(t=n.params.format)!==null&&t!==void 0?t:r=>String(r)}),value:e,viewProps:n.viewProps});return new Mi(n.document,{blade:n.blade,props:Ut.fromObject({label:n.params.label}),value:e,valueController:i})},api(n){return!(n.controller instanceof Mi)||!(n.controller.valueController instanceof Wr)?null:new fE(n.controller)}}}();function wE(n){const t=n.createElement("div");return t.classList.add(Xt("dfw")()),n.body&&n.body.appendChild(t),t}function EE(n,t,e){if(n.querySelector(`style[data-tp-style=${t}]`))return;const i=n.createElement("style");i.dataset.tpStyle=t,i.textContent=e,n.head.appendChild(i)}class ME extends _E{constructor(t){var e,i;const r=t??{},s=(e=r.document)!==null&&e!==void 0?e:Y0(),o=hE(),a=new gE(s,{expanded:r.expanded,blade:br(),props:Ut.fromObject({title:r.title}),viewProps:Bn.create()});super(a,o),this.pool_=o,this.containerElem_=(i=r.container)!==null&&i!==void 0?i:wE(s),this.containerElem_.appendChild(this.element),this.doc_=s,this.usesDefaultWrapper_=!r.container,this.setUpDefaultPlugins_()}get document(){if(!this.doc_)throw de.alreadyDisposed();return this.doc_}dispose(){const t=this.containerElem_;if(!t)throw de.alreadyDisposed();if(this.usesDefaultWrapper_){const e=t.parentElement;e&&e.removeChild(t)}this.containerElem_=null,this.doc_=null,super.dispose()}registerPlugin(t){t.css&&EE(this.document,`plugin-${t.id}`,t.css),("plugin"in t?[t.plugin]:"plugins"in t?t.plugins:[]).forEach(i=>{this.pool_.register(t.id,i)})}setUpDefaultPlugins_(){this.registerPlugin({id:"default",css:'.tp-tbiv_b,.tp-coltxtv_ms,.tp-colswv_b,.tp-ckbv_i,.tp-sglv_i,.tp-mllv_i,.tp-grlv_g,.tp-txtv_i,.tp-p2dpv_p,.tp-colswv_sw,.tp-rotv_b,.tp-fldv_b,.tp-p2dv_b,.tp-btnv_b,.tp-lstv_s{-webkit-appearance:none;-moz-appearance:none;appearance:none;background-color:rgba(0,0,0,0);border-width:0;font-family:inherit;font-size:inherit;font-weight:inherit;margin:0;outline:none;padding:0}.tp-p2dv_b,.tp-btnv_b,.tp-lstv_s{background-color:var(--btn-bg);border-radius:var(--bld-br);color:var(--btn-fg);cursor:pointer;display:block;font-weight:bold;height:var(--cnt-usz);line-height:var(--cnt-usz);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.tp-p2dv_b:hover,.tp-btnv_b:hover,.tp-lstv_s:hover{background-color:var(--btn-bg-h)}.tp-p2dv_b:focus,.tp-btnv_b:focus,.tp-lstv_s:focus{background-color:var(--btn-bg-f)}.tp-p2dv_b:active,.tp-btnv_b:active,.tp-lstv_s:active{background-color:var(--btn-bg-a)}.tp-p2dv_b:disabled,.tp-btnv_b:disabled,.tp-lstv_s:disabled{opacity:.5}.tp-rotv_c>.tp-cntv.tp-v-lst,.tp-tbpv_c>.tp-cntv.tp-v-lst,.tp-fldv_c>.tp-cntv.tp-v-lst{margin-bottom:calc(-1*var(--cnt-vp))}.tp-rotv_c>.tp-fldv.tp-v-lst .tp-fldv_c,.tp-tbpv_c>.tp-fldv.tp-v-lst .tp-fldv_c,.tp-fldv_c>.tp-fldv.tp-v-lst .tp-fldv_c{border-bottom-left-radius:0}.tp-rotv_c>.tp-fldv.tp-v-lst .tp-fldv_b,.tp-tbpv_c>.tp-fldv.tp-v-lst .tp-fldv_b,.tp-fldv_c>.tp-fldv.tp-v-lst .tp-fldv_b{border-bottom-left-radius:0}.tp-rotv_c>*:not(.tp-v-fst),.tp-tbpv_c>*:not(.tp-v-fst),.tp-fldv_c>*:not(.tp-v-fst){margin-top:var(--cnt-usp)}.tp-rotv_c>.tp-sprv:not(.tp-v-fst),.tp-tbpv_c>.tp-sprv:not(.tp-v-fst),.tp-fldv_c>.tp-sprv:not(.tp-v-fst),.tp-rotv_c>.tp-cntv:not(.tp-v-fst),.tp-tbpv_c>.tp-cntv:not(.tp-v-fst),.tp-fldv_c>.tp-cntv:not(.tp-v-fst){margin-top:var(--cnt-vp)}.tp-rotv_c>.tp-sprv+*:not(.tp-v-hidden),.tp-tbpv_c>.tp-sprv+*:not(.tp-v-hidden),.tp-fldv_c>.tp-sprv+*:not(.tp-v-hidden),.tp-rotv_c>.tp-cntv+*:not(.tp-v-hidden),.tp-tbpv_c>.tp-cntv+*:not(.tp-v-hidden),.tp-fldv_c>.tp-cntv+*:not(.tp-v-hidden){margin-top:var(--cnt-vp)}.tp-rotv_c>.tp-sprv:not(.tp-v-hidden)+.tp-sprv,.tp-tbpv_c>.tp-sprv:not(.tp-v-hidden)+.tp-sprv,.tp-fldv_c>.tp-sprv:not(.tp-v-hidden)+.tp-sprv,.tp-rotv_c>.tp-cntv:not(.tp-v-hidden)+.tp-cntv,.tp-tbpv_c>.tp-cntv:not(.tp-v-hidden)+.tp-cntv,.tp-fldv_c>.tp-cntv:not(.tp-v-hidden)+.tp-cntv{margin-top:0}.tp-tbpv_c>.tp-cntv,.tp-fldv_c>.tp-cntv{margin-left:4px}.tp-tbpv_c>.tp-fldv>.tp-fldv_b,.tp-fldv_c>.tp-fldv>.tp-fldv_b{border-top-left-radius:var(--bld-br);border-bottom-left-radius:var(--bld-br)}.tp-tbpv_c>.tp-fldv.tp-fldv-expanded>.tp-fldv_b,.tp-fldv_c>.tp-fldv.tp-fldv-expanded>.tp-fldv_b{border-bottom-left-radius:0}.tp-tbpv_c .tp-fldv>.tp-fldv_c,.tp-fldv_c .tp-fldv>.tp-fldv_c{border-bottom-left-radius:var(--bld-br)}.tp-tbpv_c>.tp-cntv+.tp-fldv>.tp-fldv_b,.tp-fldv_c>.tp-cntv+.tp-fldv>.tp-fldv_b{border-top-left-radius:0}.tp-tbpv_c>.tp-cntv+.tp-tabv>.tp-tabv_t,.tp-fldv_c>.tp-cntv+.tp-tabv>.tp-tabv_t{border-top-left-radius:0}.tp-tbpv_c>.tp-tabv>.tp-tabv_t,.tp-fldv_c>.tp-tabv>.tp-tabv_t{border-top-left-radius:var(--bld-br)}.tp-tbpv_c .tp-tabv>.tp-tabv_c,.tp-fldv_c .tp-tabv>.tp-tabv_c{border-bottom-left-radius:var(--bld-br)}.tp-rotv_b,.tp-fldv_b{background-color:var(--cnt-bg);color:var(--cnt-fg);cursor:pointer;display:block;height:calc(var(--cnt-usz) + 4px);line-height:calc(var(--cnt-usz) + 4px);overflow:hidden;padding-left:var(--cnt-hp);padding-right:calc(4px + var(--cnt-usz) + var(--cnt-hp));position:relative;text-align:left;text-overflow:ellipsis;white-space:nowrap;width:100%;transition:border-radius .2s ease-in-out .2s}.tp-rotv_b:hover,.tp-fldv_b:hover{background-color:var(--cnt-bg-h)}.tp-rotv_b:focus,.tp-fldv_b:focus{background-color:var(--cnt-bg-f)}.tp-rotv_b:active,.tp-fldv_b:active{background-color:var(--cnt-bg-a)}.tp-rotv_b:disabled,.tp-fldv_b:disabled{opacity:.5}.tp-rotv_m,.tp-fldv_m{background:linear-gradient(to left, var(--cnt-fg), var(--cnt-fg) 2px, transparent 2px, transparent 4px, var(--cnt-fg) 4px);border-radius:2px;bottom:0;content:"";display:block;height:6px;right:calc(var(--cnt-hp) + (var(--cnt-usz) + 4px - 6px)/2 - 2px);margin:auto;opacity:.5;position:absolute;top:0;transform:rotate(90deg);transition:transform .2s ease-in-out;width:6px}.tp-rotv.tp-rotv-expanded .tp-rotv_m,.tp-fldv.tp-fldv-expanded>.tp-fldv_b>.tp-fldv_m{transform:none}.tp-rotv_c,.tp-fldv_c{box-sizing:border-box;height:0;opacity:0;overflow:hidden;padding-bottom:0;padding-top:0;position:relative;transition:height .2s ease-in-out,opacity .2s linear,padding .2s ease-in-out}.tp-rotv.tp-rotv-cpl:not(.tp-rotv-expanded) .tp-rotv_c,.tp-fldv.tp-fldv-cpl:not(.tp-fldv-expanded)>.tp-fldv_c{display:none}.tp-rotv.tp-rotv-expanded .tp-rotv_c,.tp-fldv.tp-fldv-expanded>.tp-fldv_c{opacity:1;padding-bottom:var(--cnt-vp);padding-top:var(--cnt-vp);transform:none;overflow:visible;transition:height .2s ease-in-out,opacity .2s linear .2s,padding .2s ease-in-out}.tp-txtv_i,.tp-p2dpv_p,.tp-colswv_sw{background-color:var(--in-bg);border-radius:var(--bld-br);box-sizing:border-box;color:var(--in-fg);font-family:inherit;height:var(--cnt-usz);line-height:var(--cnt-usz);min-width:0;width:100%}.tp-txtv_i:hover,.tp-p2dpv_p:hover,.tp-colswv_sw:hover{background-color:var(--in-bg-h)}.tp-txtv_i:focus,.tp-p2dpv_p:focus,.tp-colswv_sw:focus{background-color:var(--in-bg-f)}.tp-txtv_i:active,.tp-p2dpv_p:active,.tp-colswv_sw:active{background-color:var(--in-bg-a)}.tp-txtv_i:disabled,.tp-p2dpv_p:disabled,.tp-colswv_sw:disabled{opacity:.5}.tp-lstv,.tp-coltxtv_m{position:relative}.tp-lstv_s{padding:0 20px 0 4px;width:100%}.tp-lstv_m,.tp-coltxtv_mm{bottom:0;margin:auto;pointer-events:none;position:absolute;right:2px;top:0}.tp-lstv_m svg,.tp-coltxtv_mm svg{bottom:0;height:16px;margin:auto;position:absolute;right:0;top:0;width:16px}.tp-lstv_m svg path,.tp-coltxtv_mm svg path{fill:currentColor}.tp-sglv_i,.tp-mllv_i,.tp-grlv_g{background-color:var(--mo-bg);border-radius:var(--bld-br);box-sizing:border-box;color:var(--mo-fg);height:var(--cnt-usz);scrollbar-color:currentColor rgba(0,0,0,0);scrollbar-width:thin;width:100%}.tp-sglv_i::-webkit-scrollbar,.tp-mllv_i::-webkit-scrollbar,.tp-grlv_g::-webkit-scrollbar{height:8px;width:8px}.tp-sglv_i::-webkit-scrollbar-corner,.tp-mllv_i::-webkit-scrollbar-corner,.tp-grlv_g::-webkit-scrollbar-corner{background-color:rgba(0,0,0,0)}.tp-sglv_i::-webkit-scrollbar-thumb,.tp-mllv_i::-webkit-scrollbar-thumb,.tp-grlv_g::-webkit-scrollbar-thumb{background-clip:padding-box;background-color:currentColor;border:rgba(0,0,0,0) solid 2px;border-radius:4px}.tp-pndtxtv,.tp-coltxtv_w{display:flex}.tp-pndtxtv_a,.tp-coltxtv_c{width:100%}.tp-pndtxtv_a+.tp-pndtxtv_a,.tp-coltxtv_c+.tp-pndtxtv_a,.tp-pndtxtv_a+.tp-coltxtv_c,.tp-coltxtv_c+.tp-coltxtv_c{margin-left:2px}.tp-rotv{--bs-bg: var(--tp-base-background-color, hsl(230, 7%, 17%));--bs-br: var(--tp-base-border-radius, 6px);--bs-ff: var(--tp-base-font-family, Roboto Mono, Source Code Pro, Menlo, Courier, monospace);--bs-sh: var(--tp-base-shadow-color, rgba(0, 0, 0, 0.2));--bld-br: var(--tp-blade-border-radius, 2px);--bld-hp: var(--tp-blade-horizontal-padding, 4px);--bld-vw: var(--tp-blade-value-width, 160px);--btn-bg: var(--tp-button-background-color, hsl(230, 7%, 70%));--btn-bg-a: var(--tp-button-background-color-active, #d6d7db);--btn-bg-f: var(--tp-button-background-color-focus, #c8cad0);--btn-bg-h: var(--tp-button-background-color-hover, #bbbcc4);--btn-fg: var(--tp-button-foreground-color, hsl(230, 7%, 17%));--cnt-bg: var(--tp-container-background-color, rgba(187, 188, 196, 0.1));--cnt-bg-a: var(--tp-container-background-color-active, rgba(187, 188, 196, 0.25));--cnt-bg-f: var(--tp-container-background-color-focus, rgba(187, 188, 196, 0.2));--cnt-bg-h: var(--tp-container-background-color-hover, rgba(187, 188, 196, 0.15));--cnt-fg: var(--tp-container-foreground-color, hsl(230, 7%, 75%));--cnt-hp: var(--tp-container-horizontal-padding, 4px);--cnt-vp: var(--tp-container-vertical-padding, 4px);--cnt-usp: var(--tp-container-unit-spacing, 4px);--cnt-usz: var(--tp-container-unit-size, 20px);--in-bg: var(--tp-input-background-color, rgba(187, 188, 196, 0.1));--in-bg-a: var(--tp-input-background-color-active, rgba(187, 188, 196, 0.25));--in-bg-f: var(--tp-input-background-color-focus, rgba(187, 188, 196, 0.2));--in-bg-h: var(--tp-input-background-color-hover, rgba(187, 188, 196, 0.15));--in-fg: var(--tp-input-foreground-color, hsl(230, 7%, 75%));--lbl-fg: var(--tp-label-foreground-color, rgba(187, 188, 196, 0.7));--mo-bg: var(--tp-monitor-background-color, rgba(0, 0, 0, 0.2));--mo-fg: var(--tp-monitor-foreground-color, rgba(187, 188, 196, 0.7));--grv-fg: var(--tp-groove-foreground-color, rgba(187, 188, 196, 0.1))}.tp-btnv_b{width:100%}.tp-btnv_t{text-align:center}.tp-ckbv_l{display:block;position:relative}.tp-ckbv_i{left:0;opacity:0;position:absolute;top:0}.tp-ckbv_w{background-color:var(--in-bg);border-radius:var(--bld-br);cursor:pointer;display:block;height:var(--cnt-usz);position:relative;width:var(--cnt-usz)}.tp-ckbv_w svg{display:block;height:16px;inset:0;margin:auto;opacity:0;position:absolute;width:16px}.tp-ckbv_w svg path{fill:none;stroke:var(--in-fg);stroke-width:2}.tp-ckbv_i:hover+.tp-ckbv_w{background-color:var(--in-bg-h)}.tp-ckbv_i:focus+.tp-ckbv_w{background-color:var(--in-bg-f)}.tp-ckbv_i:active+.tp-ckbv_w{background-color:var(--in-bg-a)}.tp-ckbv_i:checked+.tp-ckbv_w svg{opacity:1}.tp-ckbv.tp-v-disabled .tp-ckbv_w{opacity:.5}.tp-colv{position:relative}.tp-colv_h{display:flex}.tp-colv_s{flex-grow:0;flex-shrink:0;width:var(--cnt-usz)}.tp-colv_t{flex:1;margin-left:4px}.tp-colv_p{height:0;margin-top:0;opacity:0;overflow:hidden;transition:height .2s ease-in-out,opacity .2s linear,margin .2s ease-in-out}.tp-colv.tp-colv-expanded.tp-colv-cpl .tp-colv_p{overflow:visible}.tp-colv.tp-colv-expanded .tp-colv_p{margin-top:var(--cnt-usp);opacity:1}.tp-colv .tp-popv{left:calc(-1*var(--cnt-hp));right:calc(-1*var(--cnt-hp));top:var(--cnt-usz)}.tp-colpv_h,.tp-colpv_ap{margin-left:6px;margin-right:6px}.tp-colpv_h{margin-top:var(--cnt-usp)}.tp-colpv_rgb{display:flex;margin-top:var(--cnt-usp);width:100%}.tp-colpv_a{display:flex;margin-top:var(--cnt-vp);padding-top:calc(var(--cnt-vp) + 2px);position:relative}.tp-colpv_a::before{background-color:var(--grv-fg);content:"";height:2px;left:calc(-1*var(--cnt-hp));position:absolute;right:calc(-1*var(--cnt-hp));top:0}.tp-colpv.tp-v-disabled .tp-colpv_a::before{opacity:.5}.tp-colpv_ap{align-items:center;display:flex;flex:3}.tp-colpv_at{flex:1;margin-left:4px}.tp-svpv{border-radius:var(--bld-br);outline:none;overflow:hidden;position:relative}.tp-svpv.tp-v-disabled{opacity:.5}.tp-svpv_c{cursor:crosshair;display:block;height:calc(var(--cnt-usz)*4);width:100%}.tp-svpv_m{border-radius:100%;border:rgba(255,255,255,.75) solid 2px;box-sizing:border-box;filter:drop-shadow(0 0 1px rgba(0, 0, 0, 0.3));height:12px;margin-left:-6px;margin-top:-6px;pointer-events:none;position:absolute;width:12px}.tp-svpv:focus .tp-svpv_m{border-color:#fff}.tp-hplv{cursor:pointer;height:var(--cnt-usz);outline:none;position:relative}.tp-hplv.tp-v-disabled{opacity:.5}.tp-hplv_c{background-image:url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAEAAAAABCAYAAABubagXAAAAQ0lEQVQoU2P8z8Dwn0GCgQEDi2OK/RBgYHjBgIpfovFh8j8YBIgzFGQxuqEgPhaDOT5gOhPkdCxOZeBg+IDFZZiGAgCaSSMYtcRHLgAAAABJRU5ErkJggg==);background-position:left top;background-repeat:no-repeat;background-size:100% 100%;border-radius:2px;display:block;height:4px;left:0;margin-top:-2px;position:absolute;top:50%;width:100%}.tp-hplv_m{border-radius:var(--bld-br);border:rgba(255,255,255,.75) solid 2px;box-shadow:0 0 2px rgba(0,0,0,.1);box-sizing:border-box;height:12px;left:50%;margin-left:-6px;margin-top:-6px;position:absolute;top:50%;width:12px}.tp-hplv:focus .tp-hplv_m{border-color:#fff}.tp-aplv{cursor:pointer;height:var(--cnt-usz);outline:none;position:relative;width:100%}.tp-aplv.tp-v-disabled{opacity:.5}.tp-aplv_b{background-color:#fff;background-image:linear-gradient(to top right, #ddd 25%, transparent 25%, transparent 75%, #ddd 75%),linear-gradient(to top right, #ddd 25%, transparent 25%, transparent 75%, #ddd 75%);background-size:4px 4px;background-position:0 0,2px 2px;border-radius:2px;display:block;height:4px;left:0;margin-top:-2px;overflow:hidden;position:absolute;top:50%;width:100%}.tp-aplv_c{inset:0;position:absolute}.tp-aplv_m{background-color:#fff;background-image:linear-gradient(to top right, #ddd 25%, transparent 25%, transparent 75%, #ddd 75%),linear-gradient(to top right, #ddd 25%, transparent 25%, transparent 75%, #ddd 75%);background-size:12px 12px;background-position:0 0,6px 6px;border-radius:var(--bld-br);box-shadow:0 0 2px rgba(0,0,0,.1);height:12px;left:50%;margin-left:-6px;margin-top:-6px;overflow:hidden;position:absolute;top:50%;width:12px}.tp-aplv_p{border-radius:var(--bld-br);border:rgba(255,255,255,.75) solid 2px;box-sizing:border-box;inset:0;position:absolute}.tp-aplv:focus .tp-aplv_p{border-color:#fff}.tp-colswv{background-color:#fff;background-image:linear-gradient(to top right, #ddd 25%, transparent 25%, transparent 75%, #ddd 75%),linear-gradient(to top right, #ddd 25%, transparent 25%, transparent 75%, #ddd 75%);background-size:10px 10px;background-position:0 0,5px 5px;border-radius:var(--bld-br);overflow:hidden}.tp-colswv.tp-v-disabled{opacity:.5}.tp-colswv_sw{border-radius:0}.tp-colswv_b{cursor:pointer;display:block;height:var(--cnt-usz);left:0;position:absolute;top:0;width:var(--cnt-usz)}.tp-colswv_b:focus::after{border:rgba(255,255,255,.75) solid 2px;border-radius:var(--bld-br);content:"";display:block;inset:0;position:absolute}.tp-coltxtv{display:flex;width:100%}.tp-coltxtv_m{margin-right:4px}.tp-coltxtv_ms{border-radius:var(--bld-br);color:var(--lbl-fg);cursor:pointer;height:var(--cnt-usz);line-height:var(--cnt-usz);padding:0 18px 0 4px}.tp-coltxtv_ms:hover{background-color:var(--in-bg-h)}.tp-coltxtv_ms:focus{background-color:var(--in-bg-f)}.tp-coltxtv_ms:active{background-color:var(--in-bg-a)}.tp-coltxtv_mm{color:var(--lbl-fg)}.tp-coltxtv.tp-v-disabled .tp-coltxtv_mm{opacity:.5}.tp-coltxtv_w{flex:1}.tp-dfwv{position:absolute;top:8px;right:8px;width:256px}.tp-fldv{position:relative}.tp-fldv_t{padding-left:4px}.tp-fldv_b:disabled .tp-fldv_m{display:none}.tp-fldv_c{padding-left:4px}.tp-fldv_i{bottom:0;color:var(--cnt-bg);left:0;overflow:hidden;position:absolute;top:calc(var(--cnt-usz) + 4px);width:max(var(--bs-br),4px)}.tp-fldv_i::before{background-color:currentColor;bottom:0;content:"";left:0;position:absolute;top:0;width:4px}.tp-fldv_b:hover+.tp-fldv_i{color:var(--cnt-bg-h)}.tp-fldv_b:focus+.tp-fldv_i{color:var(--cnt-bg-f)}.tp-fldv_b:active+.tp-fldv_i{color:var(--cnt-bg-a)}.tp-fldv.tp-v-disabled>.tp-fldv_i{opacity:.5}.tp-grlv{position:relative}.tp-grlv_g{display:block;height:calc(var(--cnt-usz)*3)}.tp-grlv_g polyline{fill:none;stroke:var(--mo-fg);stroke-linejoin:round}.tp-grlv_t{margin-top:-4px;transition:left .05s,top .05s;visibility:hidden}.tp-grlv_t.tp-grlv_t-a{visibility:visible}.tp-grlv_t.tp-grlv_t-in{transition:none}.tp-grlv.tp-v-disabled .tp-grlv_g{opacity:.5}.tp-grlv .tp-ttv{background-color:var(--mo-fg)}.tp-grlv .tp-ttv::before{border-top-color:var(--mo-fg)}.tp-lblv{align-items:center;display:flex;line-height:1.3;padding-left:var(--cnt-hp);padding-right:var(--cnt-hp)}.tp-lblv.tp-lblv-nol{display:block}.tp-lblv_l{color:var(--lbl-fg);flex:1;-webkit-hyphens:auto;hyphens:auto;overflow:hidden;padding-left:4px;padding-right:16px}.tp-lblv.tp-v-disabled .tp-lblv_l{opacity:.5}.tp-lblv.tp-lblv-nol .tp-lblv_l{display:none}.tp-lblv_v{align-self:flex-start;flex-grow:0;flex-shrink:0;width:var(--bld-vw)}.tp-lblv.tp-lblv-nol .tp-lblv_v{width:100%}.tp-lstv_s{padding:0 20px 0 var(--bld-hp);width:100%}.tp-lstv_m{color:var(--btn-fg)}.tp-sglv_i{padding-left:var(--bld-hp);padding-right:var(--bld-hp)}.tp-sglv.tp-v-disabled .tp-sglv_i{opacity:.5}.tp-mllv_i{display:block;height:calc(var(--cnt-usz)*3);line-height:var(--cnt-usz);padding-left:var(--bld-hp);padding-right:var(--bld-hp);resize:none;white-space:pre}.tp-mllv.tp-v-disabled .tp-mllv_i{opacity:.5}.tp-p2dv{position:relative}.tp-p2dv_h{display:flex}.tp-p2dv_b{height:var(--cnt-usz);margin-right:4px;position:relative;width:var(--cnt-usz)}.tp-p2dv_b svg{display:block;height:16px;left:50%;margin-left:-8px;margin-top:-8px;position:absolute;top:50%;width:16px}.tp-p2dv_b svg path{stroke:currentColor;stroke-width:2}.tp-p2dv_b svg circle{fill:currentColor}.tp-p2dv_t{flex:1}.tp-p2dv_p{height:0;margin-top:0;opacity:0;overflow:hidden;transition:height .2s ease-in-out,opacity .2s linear,margin .2s ease-in-out}.tp-p2dv.tp-p2dv-expanded .tp-p2dv_p{margin-top:var(--cnt-usp);opacity:1}.tp-p2dv .tp-popv{left:calc(-1*var(--cnt-hp));right:calc(-1*var(--cnt-hp));top:var(--cnt-usz)}.tp-p2dpv{padding-left:calc(var(--cnt-usz) + 4px)}.tp-p2dpv_p{cursor:crosshair;height:0;overflow:hidden;padding-bottom:100%;position:relative}.tp-p2dpv.tp-v-disabled .tp-p2dpv_p{opacity:.5}.tp-p2dpv_g{display:block;height:100%;left:0;pointer-events:none;position:absolute;top:0;width:100%}.tp-p2dpv_ax{opacity:.1;stroke:var(--in-fg);stroke-dasharray:1}.tp-p2dpv_l{opacity:.5;stroke:var(--in-fg);stroke-dasharray:1}.tp-p2dpv_m{border:var(--in-fg) solid 1px;border-radius:50%;box-sizing:border-box;height:4px;margin-left:-2px;margin-top:-2px;position:absolute;width:4px}.tp-p2dpv_p:focus .tp-p2dpv_m{background-color:var(--in-fg);border-width:0}.tp-popv{background-color:var(--bs-bg);border-radius:var(--bs-br);box-shadow:0 2px 4px var(--bs-sh);display:none;max-width:var(--bld-vw);padding:var(--cnt-vp) var(--cnt-hp);position:absolute;visibility:hidden;z-index:1000}.tp-popv.tp-popv-v{display:block;visibility:visible}.tp-sldv.tp-v-disabled{opacity:.5}.tp-sldv_t{box-sizing:border-box;cursor:pointer;height:var(--cnt-usz);margin:0 6px;outline:none;position:relative}.tp-sldv_t::before{background-color:var(--in-bg);border-radius:1px;content:"";display:block;height:2px;inset:0;margin:auto;position:absolute}.tp-sldv_k{height:100%;left:0;position:absolute;top:0}.tp-sldv_k::before{background-color:var(--in-fg);border-radius:1px;content:"";display:block;height:2px;inset:0;margin-bottom:auto;margin-top:auto;position:absolute}.tp-sldv_k::after{background-color:var(--btn-bg);border-radius:var(--bld-br);bottom:0;content:"";display:block;height:12px;margin-bottom:auto;margin-top:auto;position:absolute;right:-6px;top:0;width:12px}.tp-sldv_t:hover .tp-sldv_k::after{background-color:var(--btn-bg-h)}.tp-sldv_t:focus .tp-sldv_k::after{background-color:var(--btn-bg-f)}.tp-sldv_t:active .tp-sldv_k::after{background-color:var(--btn-bg-a)}.tp-sldtxtv{display:flex}.tp-sldtxtv_s{flex:2}.tp-sldtxtv_t{flex:1;margin-left:4px}.tp-tabv{position:relative}.tp-tabv_t{align-items:flex-end;color:var(--cnt-bg);display:flex;overflow:hidden;position:relative}.tp-tabv_t:hover{color:var(--cnt-bg-h)}.tp-tabv_t:has(*:focus){color:var(--cnt-bg-f)}.tp-tabv_t:has(*:active){color:var(--cnt-bg-a)}.tp-tabv_t::before{background-color:currentColor;bottom:0;content:"";height:2px;left:0;pointer-events:none;position:absolute;right:0}.tp-tabv.tp-v-disabled .tp-tabv_t::before{opacity:.5}.tp-tabv.tp-tabv-nop .tp-tabv_t{height:calc(var(--cnt-usz) + 4px);position:relative}.tp-tabv.tp-tabv-nop .tp-tabv_t::before{background-color:var(--cnt-bg);bottom:0;content:"";height:2px;left:0;position:absolute;right:0}.tp-tabv_i{bottom:0;color:var(--cnt-bg);left:0;overflow:hidden;position:absolute;top:calc(var(--cnt-usz) + 4px);width:max(var(--bs-br),4px)}.tp-tabv_i::before{background-color:currentColor;bottom:0;content:"";left:0;position:absolute;top:0;width:4px}.tp-tabv_t:hover+.tp-tabv_i{color:var(--cnt-bg-h)}.tp-tabv_t:has(*:focus)+.tp-tabv_i{color:var(--cnt-bg-f)}.tp-tabv_t:has(*:active)+.tp-tabv_i{color:var(--cnt-bg-a)}.tp-tabv.tp-v-disabled>.tp-tabv_i{opacity:.5}.tp-tbiv{flex:1;min-width:0;position:relative}.tp-tbiv+.tp-tbiv{margin-left:2px}.tp-tbiv+.tp-tbiv.tp-v-disabled::before{opacity:.5}.tp-tbiv_b{display:block;padding-left:calc(var(--cnt-hp) + 4px);padding-right:calc(var(--cnt-hp) + 4px);position:relative;width:100%}.tp-tbiv_b:disabled{opacity:.5}.tp-tbiv_b::before{background-color:var(--cnt-bg);content:"";inset:0 0 2px;pointer-events:none;position:absolute}.tp-tbiv_b:hover::before{background-color:var(--cnt-bg-h)}.tp-tbiv_b:focus::before{background-color:var(--cnt-bg-f)}.tp-tbiv_b:active::before{background-color:var(--cnt-bg-a)}.tp-tbiv_t{color:var(--cnt-fg);height:calc(var(--cnt-usz) + 4px);line-height:calc(var(--cnt-usz) + 4px);opacity:.5;overflow:hidden;position:relative;text-overflow:ellipsis}.tp-tbiv.tp-tbiv-sel .tp-tbiv_t{opacity:1}.tp-tbpv_c{padding-bottom:var(--cnt-vp);padding-left:4px;padding-top:var(--cnt-vp)}.tp-txtv{position:relative}.tp-txtv_i{padding-left:var(--bld-hp);padding-right:var(--bld-hp)}.tp-txtv.tp-txtv-fst .tp-txtv_i{border-bottom-right-radius:0;border-top-right-radius:0}.tp-txtv.tp-txtv-mid .tp-txtv_i{border-radius:0}.tp-txtv.tp-txtv-lst .tp-txtv_i{border-bottom-left-radius:0;border-top-left-radius:0}.tp-txtv.tp-txtv-num .tp-txtv_i{text-align:right}.tp-txtv.tp-txtv-drg .tp-txtv_i{opacity:.3}.tp-txtv_k{cursor:pointer;height:100%;left:calc(var(--bld-hp) - 5px);position:absolute;top:0;width:12px}.tp-txtv_k::before{background-color:var(--in-fg);border-radius:1px;bottom:0;content:"";height:calc(var(--cnt-usz) - 4px);left:50%;margin-bottom:auto;margin-left:-1px;margin-top:auto;opacity:.1;position:absolute;top:0;transition:border-radius .1s,height .1s,transform .1s,width .1s;width:2px}.tp-txtv_k:hover::before,.tp-txtv.tp-txtv-drg .tp-txtv_k::before{opacity:1}.tp-txtv.tp-txtv-drg .tp-txtv_k::before{border-radius:50%;height:4px;transform:translateX(-1px);width:4px}.tp-txtv_g{bottom:0;display:block;height:8px;left:50%;margin:auto;overflow:visible;pointer-events:none;position:absolute;top:0;visibility:hidden;width:100%}.tp-txtv.tp-txtv-drg .tp-txtv_g{visibility:visible}.tp-txtv_gb{fill:none;stroke:var(--in-fg);stroke-dasharray:1}.tp-txtv_gh{fill:none;stroke:var(--in-fg)}.tp-txtv .tp-ttv{margin-left:6px;visibility:hidden}.tp-txtv.tp-txtv-drg .tp-ttv{visibility:visible}.tp-ttv{background-color:var(--in-fg);border-radius:var(--bld-br);color:var(--bs-bg);padding:2px 4px;pointer-events:none;position:absolute;transform:translate(-50%, -100%)}.tp-ttv::before{border-color:var(--in-fg) rgba(0,0,0,0) rgba(0,0,0,0) rgba(0,0,0,0);border-style:solid;border-width:2px;box-sizing:border-box;content:"";font-size:.9em;height:4px;left:50%;margin-left:-2px;position:absolute;top:100%;width:4px}.tp-rotv{background-color:var(--bs-bg);border-radius:var(--bs-br);box-shadow:0 2px 4px var(--bs-sh);font-family:var(--bs-ff);font-size:11px;font-weight:500;line-height:1;text-align:left}.tp-rotv_b{border-bottom-left-radius:var(--bs-br);border-bottom-right-radius:var(--bs-br);border-top-left-radius:var(--bs-br);border-top-right-radius:var(--bs-br);padding-left:calc(4px + var(--cnt-usz) + var(--cnt-hp));text-align:center}.tp-rotv.tp-rotv-expanded .tp-rotv_b{border-bottom-left-radius:0;border-bottom-right-radius:0;transition-delay:0s;transition-duration:0s}.tp-rotv.tp-rotv-not>.tp-rotv_b{display:none}.tp-rotv_b:disabled .tp-rotv_m{display:none}.tp-rotv_c>.tp-fldv.tp-v-lst>.tp-fldv_c{border-bottom-left-radius:var(--bs-br);border-bottom-right-radius:var(--bs-br)}.tp-rotv_c>.tp-fldv.tp-v-lst>.tp-fldv_i{border-bottom-left-radius:var(--bs-br)}.tp-rotv_c>.tp-fldv.tp-v-lst:not(.tp-fldv-expanded)>.tp-fldv_b{border-bottom-left-radius:var(--bs-br);border-bottom-right-radius:var(--bs-br)}.tp-rotv_c>.tp-fldv.tp-v-lst.tp-fldv-expanded>.tp-fldv_b{transition-delay:0s;transition-duration:0s}.tp-rotv_c .tp-fldv.tp-v-vlst:not(.tp-fldv-expanded)>.tp-fldv_b{border-bottom-right-radius:var(--bs-br)}.tp-rotv.tp-rotv-not .tp-rotv_c>.tp-fldv.tp-v-fst{margin-top:calc(-1*var(--cnt-vp))}.tp-rotv.tp-rotv-not .tp-rotv_c>.tp-fldv.tp-v-fst>.tp-fldv_b{border-top-left-radius:var(--bs-br);border-top-right-radius:var(--bs-br)}.tp-rotv_c>.tp-tabv.tp-v-lst>.tp-tabv_c{border-bottom-left-radius:var(--bs-br);border-bottom-right-radius:var(--bs-br)}.tp-rotv_c>.tp-tabv.tp-v-lst>.tp-tabv_i{border-bottom-left-radius:var(--bs-br)}.tp-rotv.tp-rotv-not .tp-rotv_c>.tp-tabv.tp-v-fst{margin-top:calc(-1*var(--cnt-vp))}.tp-rotv.tp-rotv-not .tp-rotv_c>.tp-tabv.tp-v-fst>.tp-tabv_t{border-top-left-radius:var(--bs-br);border-top-right-radius:var(--bs-br)}.tp-rotv.tp-v-disabled,.tp-rotv .tp-v-disabled{pointer-events:none}.tp-rotv.tp-v-hidden,.tp-rotv .tp-v-hidden{display:none}.tp-sprv_r{background-color:var(--grv-fg);border-width:0;display:block;height:2px;margin:0;width:100%}.tp-sprv.tp-v-disabled .tp-sprv_r{opacity:.5}',plugins:[mE,bE,xE,od,yE]})}}new id("4.0.5");const Or=[{name:"Sun",distance:0,scale:2,speed:.001,zVector:5,information:{description:"The center of the solar system. It is a star that provides light and energy to all the planets",facts:[["Equator Circumference","4,379,000km"],["Radius","695,700km"],["Temperature","5,973°C to 15,000,000°C"],["Average orbital speed around the Milky Way","720,000km/h (200km/s)"],["Star type","Yellow dwarf"],["Average time taken to rotate on axis","27 Earth days"],["Number of planets","8"]]}},{name:"Mercury",distance:6,scale:1,speed:.0015,zVector:3,information:{description:"The closest planet to the Sun. It has a very thin atmosphere and extreme temperatures",facts:[["Equator Circumference","15,329km"],["Radius","2,440km"],["Average distance from Sun","58 million km"],["Surface temperature"," -180°C to 430°C"],["Day length","59 Earth days"],["Year length"," 88 Earth days"],["Average orbital speed","170,500km/h (47km/s)"],["Moons","0"],["Planet type","Terrestrial"]]}},{name:"Venus",distance:12,scale:1,speed:.002,zVector:3,information:{description:"Known as Earth's twin. It has a thick atmosphere and surface temperatures high enough to melt lead",facts:[["Equator Circumference","38,025km"],["Radius","6,052km"],["Average distance from Sun","108 million km"],["Surface temperature","462°C"],["Day length","126,074km/h (35km/s)"],["Solar day length: ","117 Earth days"],["Year length","225 Earth days"],["Average orbital speed","107,218 km/h (29.78 km/s)"],["Moons","0"],["Planet type","Terrestrial"]]}},{name:"Earth",distance:18,scale:1,speed:.0025,zVector:3,information:{description:"The only planet known to support life. It has a breathable atmosphere and abundant water",facts:[["Equator Circumference","40,075 km"],["Radius","6,371 km"],["Average distance from Sun","49.6 million km"],["Surface temperature","-88°C to 58°C"],["Day length","24 hours (1 Earth day)"],["Year length"," 365.25 Earth days"],["Average orbital speed","107,218 km/h (29.78 km/s)"],["Moons","1"],["Planet type","Terrestrial"]]}},{name:"Mars",distance:24,scale:1,speed:.003,zVector:3,information:{description:"Known as the Red Planet due to its reddish appearance. It has a thin atmosphere and ice caps",facts:[["Equator Circumference"," 21,344 km"],["Radius"," 3,390 km"],["Average distance from Sun","228 million km"],["Surface temperature","-125°C to 20°C"],["Day length","24.6 hours (1.03 Earth days)"],["Year length","687 Earth days"],["Average orbital speed","86,871 km/h (24.08 km/s)"],["Moons"," 2 (Phobos, Deimos)"],["Planet type","Terrestrial"]]}},{name:"Jupiter",distance:30,scale:1,speed:.0035,zVector:3,information:{description:"The largest planet in the solar system. It has a stormy atmosphere, including the Great Red Spot",facts:[["Equator Circumference"," 439,264 km"],["Radius","69,911 km"],["Average distance from Sun","778 million km"],["Surface temperature","-145°C"],["Day length","9.9 hours"],["Year length","4,333 Earth days (11.86 Earth years)"],["Average orbital speed","47,051 km/h (13.07 km/s)"],["Moons","92"],["Planet type"," Gas giant"]]}},{name:"Saturn",distance:36,scale:1,speed:.004,zVector:4,information:{description:"Known for its beautiful ring system, Saturn is a gas giant with dozens of moons",facts:[["Equator Circumference","378,675 km"],["Radius","58,232 km"],["Average distance from Sun","1.43 billion km"],["Surface temperature"," -178°C"],["Day length","10.7 hours"],["Year length","10,759 Earth days (29.5 Earth years)"],["Average orbital speed"," 34,821 km/h (9.69 km/s)"],["Moons","146"],["Planet type"," Gas giant"]]}},{name:"Uranus",distance:42,scale:1,speed:.0045,zVector:4,information:{description:"A gas giant with a tilted rotation axis, giving it unique seasons and weather patterns",facts:[["Equator Circumference","159,354 km"],["Radius","25,362 km"],["Average distance from Sun","2.87 billion km"],["Surface temperature","-224°C"],["Day length","17.2 hours"],["Year length","30,687 Earth days (84 Earth years)"],["Average orbital speed","24,477 km/h (6.8 km/s)"],["Moons","27"],["Planet type","Ice giant"]]}},{name:"Neptune",distance:48,scale:1,speed:.005,zVector:3,information:{description:"The farthest planet from the Sun. It has strong winds and a deep blue color",facts:[["Equator Circumference","155,600 km"],["Radius","24,622 km"],["Average distance from Sun","4.5 billion km"],["Surface temperature"," -214°C"],["Day length","16.1 hours"],["Year length","60,190 Earth days (164.8 Earth years)"],["Average orbital speed","19,566 km/h (5.43 km/s)"],["Moons","14"],["Planet type"," Ice giant"]]}}],SE=(n,t)=>{document.getElementById("planet-card-left-header").innerText=n.name,document.getElementById("planet-card-left-desc").innerText=n.information.description,document.getElementById("planet-card-right-image").src=`./image/${n.name}.webp`;const e=document.getElementById("planet-card-right-video");e.firstChild.src=`./video/${n.name}.mp4`,document.getElementById("planet-card-right-video").load(),e.addEventListener("play",()=>{t.pause()}),e.addEventListener("pause",()=>{t.play()}),document.getElementById("planet-card-left-fact").innerHTML="";for(const i of n.information.facts){const r=document.createElement("p");r.innerText=`${i[0]}: ${i[1]}`,document.getElementById("planet-card-left-fact").append(r)}},TE=()=>{const n=document.createElement("div");n.id="planet-card-left",n.classList.add("planet-card","card-left");const t=document.createElement("div");t.id="planet-card-right",t.classList.add("planet-card","card-right");const e=document.createElement("img");e.id="planet-card-right-image",e.src="/Sun-image.webp",t.append(e);const i=document.createElement("video");i.id="planet-card-right-video",i.controls=!0;const r=document.createElement("source");r.src="/Sun-video.mp4",r.type="video/mp4",i.append(r),t.append(i);const s=document.createElement("button");s.type="button";const o=document.createElement("img");o.src="./icons8-left-arrow-50.png",o.height=20,o.width=20,s.append(o),s.id="close-planet-card",s.addEventListener("click",u=>{const p=document.getElementsByClassName("planet-card");for(const f of p)f.hidden=!0;document.getElementById("planet-card-right-video").pause(),s.style.display="none"});const a=document.createElement("h1");a.id="planet-card-left-header",a.innerText="Sun";const l=document.createElement("p");l.id="planet-card-left-desc",l.innerText="The center of the solar system. It is a star that provides light and energy to all the planets";const c=document.createElement("div");c.id="planet-card-left-fact",n.append(a),n.append(document.createElement("hr")),n.append(l),n.append(c);const h=document.createElement("button");h.type="button",h.id="tutorial-button",h.innerText="Show Tutorial",t.hidden=!0,n.hidden=!0,s.style.display="none",document.body.prepend(h),document.body.prepend(t),document.body.prepend(n),document.body.prepend(s),document.body.addEventListener("keydown",u=>{u.key==="Escape"&&(document.getElementById("close-planet-card").style.display="none",document.getElementById("planet-card-left").hidden=!0,document.getElementById("planet-card-right").hidden=!0)}),h.addEventListener("click",()=>{s.style.display="none",t.hidden=!0,a.innerText="Tutorial",l.innerText="How to use Solar System Website";const u=document.getElementById("planet-card-left-fact");u.innerHTML="",["Orbitting: Click + Drag Mouse@orbit","Panning: Shift + Click + Drag Mouse@panning","Zoom: Use Scroll or Pinch & Spread@zoom","Show Info: Click Object@showinfo","Hide Info: Press Escape or Click Back Button on top left@hideinfo","Show Tweaks: Shift + T@showtweaks"].forEach(f=>{const _=f.split("@"),v=document.createElement("p");v.innerText=_[0],u.append(v);const m=document.createElement("img");m.className="tutorial-gif",m.src=`./tutorial-${_[1]}.gif`,u.append(m)}),n.toggleAttribute("hidden"),h.innerText=n.hidden?"Show Tutorial":"Hide Tutorial"}),document.body.addEventListener("keydown",u=>{u.key==="t"&&h.click()})},cs=new ME,$s=cs.element;$s.style.display="none";const Ti=new Af;Ti.background=new It(0);const Xe=new Ge(75,window.innerWidth/window.innerHeight,.1,1e3);Xe.position.z=7;const CE=cs.addFolder({title:"Ambient Light",expanded:!0}),Bd=new Hf(16777215,5);CE.addBinding(Bd,"intensity",{min:1,max:10,step:.01});Ti.add(Bd);const AE=cs.addFolder({title:"Point Light",expanded:!0}),qr={visible:!1,orbitting:!1},Yl=new Vf(16776960,0);Yl.position.set(0,0,0);AE.addBinding(Yl,"intensity",{min:.1,max:100,step:.01});Xe.add(Yl);Ti.add(Xe);const eu=new Kf,ca=new Tt,Kl=new Lu;let co=!1,$l=0;const PE=1.5;let Zl=new P,Jl=new P,Ql=new P,tc=new P;const ho=bl.getContext(),Vd=new qf;Xe.add(Vd);const or=new Yf(Vd),RE=new Wf;RE.load("./planet_sound_asset.ogg",function(n){or.setBuffer(n),or.setLoop(!0),or.setVolume(1)});const mn=document.createElement("div");mn.id="splash-screen";const ec=document.createElement("h1");ec.innerText="The Solar System";ec.id="intro-text";mn.append(ec);const nc=document.createElement("p");nc.innerText="Click to continue";nc.id="intro-text2";mn.append(nc);Xe.position.set(0,0,100);let zd=!0;mn.style.pointerEvents="none";setTimeout(()=>{mn.style.pointerEvents="auto"},1500);mn.addEventListener("click",()=>{ho.state==="suspended"&&ho.resume().then(()=>{console.log("AudioContext resumed")}),co=!0,$l=Kl.getElapsedTime(),Zl.copy(Xe.position),Jl.set(0,0,7),Ql.copy(Ci.target),tc.set(0,0,0),or.play(),mn.style.animation="fadeOut 1.5s ease-out",setTimeout(()=>{mn.style.display="none",zd=!1},1500)});document.body.prepend(mn);const ic=new Fr({color:16777215,transparent:!0,opacity:.5}),rl=[],rc=[];function LE(){console.log("All planets loaded!"),mn.style.pointerEvents="auto",Xd()}let nu=0;for(const n of Or)new Yb().load(`./${n.name}/materials.mtl`,t=>{t.preload(),new e0().setMaterials(t).load(`./${n.name}/model.obj`,e=>{e.position.x=n.distance,e.scale.setScalar(n.scale),e.name=n.name,Ti.add(e),rl.push(e);const i=new gl(n.distance,.03,128,128),r=new tn(i,ic);r.rotateX(Math.PI/2),r.visible=!1,Ti.add(r),rc.push(r),window.addEventListener("click",s=>{if(zd)return;ca.x=s.clientX/window.innerWidth*2-1,ca.y=-(s.clientY/window.innerHeight)*2+1,eu.setFromCamera(ca,Xe),eu.intersectObject(e,!0).length>0&&(co=!0,$l=Kl.getElapsedTime(),Zl.copy(Xe.position),Jl.copy(e.position).add(new P(0,0,n.zVector)),Ql.copy(Ci.target),tc.copy(e.position),qr.orbitting=!1,cs.refresh(),SE(n,or),document.getElementById("close-planet-card").style.display="flex",document.getElementById("planet-card-left").hidden=!1,document.getElementById("planet-card-right").hidden=!1)}),nu++,nu===Or.length&&LE()})});const sc=cs.addFolder({title:"Orbit Rings",expanded:!0});sc.addBinding(qr,"visible").on("change",n=>{rc.forEach(t=>{t.visible=n.value})});sc.addBinding(ic,"opacity",{min:.1,max:1,step:.1}).on("change",n=>{rc.forEach(t=>{t.material.opacity=n.value})});sc.addBinding(qr,"orbitting").on("change",n=>{ic.visible!=qr.orbitting});ho.state==="suspended"&&ho.resume().then(()=>{or.play()});const Hd=new We,Gd=5e3,Zs=new Float32Array(Gd*3);for(let n=0;n<Gd;n++){const t=Math.random()*1e3-500,e=Math.random()*1e3-500,i=Math.random()*1e3-500;Zs[n*3]=t,Zs[n*3+1]=e,Zs[n*3+2]=i}Hd.setAttribute("position",new un(Zs,3));const DE=new Ji({color:8947848,size:.5}),IE=new js(Hd,DE);Ti.add(IE);TE();const Wd=document.getElementById("threejs"),bo=new Ib({canvas:Wd,antialias:!0});bo.setPixelRatio(window.devicePixelRatio,2);bo.setSize(window.innerWidth,window.innerHeight);const Ci=new Nb(Xe,Wd);Ci.enableDamping=!0;Ci.minDistance=2;Ci.maxDistance=30;window.addEventListener("resize",()=>{Xe.aspect=window.innerWidth/window.innerHeight,Xe.updateProjectionMatrix(),bo.setSize(window.innerWidth,window.innerHeight)});let sl=!1;document.addEventListener("keydown",n=>{n.key==="T"&&n.shiftKey&&!sl&&($s.style.display==="none"?$s.style.display="block":$s.style.display="none",sl=!0)});document.addEventListener("keyup",()=>{sl=!1});const Xd=()=>{if(requestAnimationFrame(Xd),co){const n=Kl.getElapsedTime()-$l,t=Math.min(n/PE,1),e=t*t*(3-2*t);Xe.position.lerpVectors(Zl,Jl,e),Ci.target.lerpVectors(Ql,tc,e),t>=1&&(co=!1)}rl.forEach((n,t)=>{if(!n)return;const e=rl.find(i=>i.name==="Sun").position;if(e){if(n.rotation.y+=Or[t].speed,e.x!==0&&e.y!==0&&e.z!==0)return location.reload(),!1;qr.orbitting&&(n.position.x=Math.sin(n.rotation.y)*Or[t].distance,n.position.z=Math.cos(n.rotation.y)*Or[t].distance)}}),Ci.update(),bo.render(Ti,Xe)};
